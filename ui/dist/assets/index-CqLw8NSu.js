...
Esta tasa afectará todos los nuevos cobros y tickets a partir de este momento.`)){const u=await z("fijar_tasa_manual",{tasa:s.toFixed(2)});u&&this.pintar(u),r()}})}async actualizar(){const e=await this.obtenerTasa("obtener_tasa_bcv");e&&this.pintar(e)}async forzar(){const e=document.getElementById("bcv-refresh");e&&e.classList.add("animate-spin");const o=await this.obtenerTasa("forzar_actualizacion_tasa");e&&e.classList.remove("animate-spin"),o&&this.pintar(o)}async obtenerTasa(e){try{return await z(e)}catch{return null}}pintar(e){const o=document.getElementById("bcv-valor"),a=document.getElementById("bcv-fluctuacion");if(!o||!a)return;const r=Number(e.valor);o.textContent=Number.isFinite(r)&&r>0?r.toLocaleString("es-VE",{minimumFractionDigits:2,maximumFractionDigits:2}):"--",Number.isFinite(r)&&r>0&&window.dispatchEvent(new CustomEvent("tasa_actualizada",{detail:r}));const i=Number(e.fluctuacionPct);if(e.direccion&&Number.isFinite(i)){const d=e.direccion==="subio"?rt:e.direccion==="bajo"?nt:st,p=i>0?"+":"";a.textContent=`${p}${i.toFixed(2)}%`,a.style.color=d}else a.textContent=""}}class ct{constructor(){T(this,"config",null);T(this,"rol","caja");T(this,"tasa",0);T(this,"oyentes",[])}suscribir(e){this.oyentes.push(e)}notificar(){this.oyentes.forEach(e=>e())}async cargarConfig(){return this.config=await D.config(),this.config}getConfig(){return this.config}async inicializar(e,o,a,r,i){await D.inicializar(e,o,a,r,i),await this.cargarConfig(),this.notificar()}get rubroAbasto(){return!0}tieneRubro(e){return!0}tieneCapacidad(e){var o;return(o=this.config)!=null&&o.capacidades?(this.config.capacidades&e)!==0:!0}setRol(e){this.rol=e,this.notificar()}get rolActual(){return this.rol}setTasa(e){this.tasa=e,this.notificar()}get tasaActual(){return this.tasa}bs(e){return(Number(e)*this.tasa).toLocaleString("es-VE",{minimumFractionDigits:2,maximumFractionDigits:2})}hasPinSet(){var e;return!!((e=this.config)!=null&&e.tienePin)}async verificarPin(e){return D.validarPin(e)}}class lt{constructor(e,o,a){T(this,"contenedor");T(this,"modelo");T(this,"alTerminar");T(this,"modo","nuevo");T(this,"bloquearPanel",!0);this.contenedor=e,this.modelo=o,this.alTerminar=a}render(){this.contenedor.innerHTML=`
        ...
        </div>`,this.conectarEventos()}conectarEventos(){var u,m;const e=document.getElementById("wz-tab-nuevo"),o=document.getElementById("wz-tab-restaurar");e==null||e.addEventListener("click",()=>{this.modo="nuevo",this.render()}),o==null||o.addEventListener("click",()=>{this.modo="restaurar",this.render()});const a=document.getElementById("seg-bloqueado"),r=document.getElementById("seg-abierto"),i=document.getElementById("wz-box-pin");a==null||a.addEventListener("change",()=>{this.bloquearPanel=!0,i==null||i.classList.remove("hidden")}),r==null||r.addEventListener("change",()=>{this.bloquearPanel=!1,i==null||i.classList.add("hidden")});const d=document.getElementById("seg-bloqueado-res"),p=document.getElementById("seg-abierto-res"),c=document.getElementById("wz-box-pin-res");d==null||d.addEventListener("change",()=>{this.bloquearPanel=!0,c==null||c.classList.remove("hidden")}),p==null||p.addEventListener("change",()=>{this.bloquearPanel=!1,c==null||c.classList.add("hidden")}),(u=document.getElementById("wz-iniciar"))==null||u.addEventListener("click",()=>void this.enviarNuevo());const t=document.getElementById("drop-zona"),n=document.getElementById("wz-archivo-input"),s=document.getElementById("wz-archivo-cargado"),l=document.getElementById("wz-nombre-archivo");t==null||t.addEventListener("click",()=>n==null?void 0:n.click()),n==null||n.addEventListener("change",()=>{if(n.files&&n.files[0]){const g=n.files[0];l&&s&&(l.textContent=g.name,s.classList.remove("hidden"))}}),(m=document.getElementById("wz-ejecutar-restaurar"))==null||m.addEventListener("click",()=>void this.enviarRestauracion())}async enviarNuevo(){const e=document.getElementById("wz-error"),o=document.getElementById("wz-nombre").value.trim(),a=document.getElementById("wz-pin"),r=this.bloquearPanel&&(a==null?void 0:a.value.trim())||"",i=Je,d=document.getElementById("wz-licencia"),p=(d==null?void 0:d.value.trim())||"",c=document.getElementById("wz-licencia-error");if(!o){e&&(e.textContent="Escribe el nombre del negocio para continuar.",e.classList.remove("hidden"));return}if(this.bloquearPanel&&!r){e&&(e.textContent='Ingresa una clave para proteger el panel o selecciona la opción "DEJAR ABIERTO".',e.classList.remove("hidden"));return}if(p&&!je(p)){c&&c.classList.remove("hidden");return}c&&c.classList.add("hidden");try{const t=document.getElementById("priv-inv-dueno"),n=(t==null?void 0:t.checked)??!0;await this.modelo.inicializar(o,i,r,p,n);const s=this.modelo.getConfig();s&&this.alTerminar(s)}catch(t){e&&(e.textContent=t instanceof Error?t.message:String(t),e.classList.remove("hidden"))}}async enviarRestauracion(){var d;const e=document.getElementById("wz-restore-error"),o=document.getElementById("wz-archivo-input"),a=document.getElementById("wz-pin-restaurar"),r=this.bloquearPanel&&(a==null?void 0:a.value.trim())||"",i=(d=o==null?void 0:o.files)==null?void 0:d[0];if(!i){e&&(e.textContent="Selecciona un archivo de respaldo.",e.classList.remove("hidden"));return}if(this.bloquearPanel&&!r){e&&(e.textContent='Ingresa una clave para el panel en este terminal o selecciona "DEJAR ABIERTO".',e.classList.remove("hidden"));return}try{const p=await new Promise((t,n)=>{const s=new FileReader;s.onload=()=>{const l=s.result;if(typeof l=="string"){const u=l.split(",")[1]||"";t(u)}else n(new Error("Error leyendo archivo"))},s.onerror=()=>n(new Error("No se pudo leer el archivo")),s.readAsDataURL(i)});await D.restaurarDesdeArchivo(p,i.name),this.bloquearPanel&&r&&await D.cambiarPinDueno("",r).catch(()=>{});const c=await D.config();if(c)this.alTerminar(c);else throw new Error("Respaldo restaurado pero no se pudo cargar la configuración")}catch(p){e&&(e.textContent=p instanceof Error?p.message:String(p),e.classList.remove("hidden"))}}}class bt{constructor(e){T(this,"modelo");T(this,"productos",[]);T(this,"carrito",[]);T(this,"busqueda","");T(this,"cuentaSeleccionada",null);T(this,"cuentas",[]);T(this,"oyentes",[]);T(this,"edadConfirmadaSesion",!1);T(this,"tasaBloqueadaTicket",null);this.modelo=e}suscribir(e){this.oyentes.push(e),e()}notificar(){this.oyentes.forEach(e=>e())}async cargar(){this.productos=await D.productos(),this.modelo.tieneCapacidad(pe)&&(this.cuentas=await D.cuentas()),this.notificar()}get visibles(){const e=this.busqueda.trim().toLowerCase();return e?this.productos.filter(o=>o.nombre.toLowerCase().includes(e)||o.sku.toLowerCase().includes(e)).slice(0,24):this.productos.slice(0,24)}setBusqueda(e){this.busqueda=e,this.notificar()}get lineasCarrito(){return this.carrito}get tasaTicket(){return this.tasaBloqueadaTicket??this.modelo.tasaActual}get totalUsd(){return this.carrito.reduce((e,o)=>e+o.precioUsd*o.cantidad,0)}get totalBs(){return this.totalUsd*this.tasaTicket}get cuentasAbiertasListado(){return this.cuentas}get cuentaActiva(){return this.cuentaSeleccionada}get modoCuentaAbierta(){return this.cuentaSeleccionada!==null}seleccionarCuenta(e){this.cuentaSeleccionada=e,this.notificar()}requiereEdad(e){return!1}marcarEdadConfirmada(e){this.edadConfirmadaSesion=e}async agregar(e,o="unidad"){const a=this.productos.find(r=>r.sku===e);return a?this.requiereEdad(a)?"EDAD|"+a.nombre:this.empujar(a,void 0,void 0,o):"Producto no encontrado"}empujar(e,o,a,r="unidad"){const i=r&&r!=="unidad"&&e.presentaciones?e.presentaciones.find(m=>m.nombre.toLowerCase()===r.toLowerCase()):void 0,d=!i&&r==="paquete"&&(e.precioPaqueteUsd||e.esCaja&&e.unidadesPorCaja&&e.unidadesPorCaja>1),p=i?i.unidades:d&&e.unidadesPorCaja||1,c=i?Number(i.precioUsd):d?e.precioPaqueteUsd?Number(e.precioPaqueteUsd):Number(e.precioUsd)*p:Number(e.precioUsd),t=!i&&!d&&((e.capacidades&fe)!==0||e.unidad==="kg"||e.unidad==="ml"),n=t?.25:1,s=this.carrito.find(m=>m.sku===e.sku&&m.serie===o&&m.variante===a&&m.modoVenta===r),u=(s?s.cantidad:0)+n;if(!e.sinStock){const m=Number(e.stock);if(m<u*p)return`Stock insuficiente para ${e.nombre}. Disponible: ${m}, Solicitado: ${u*p}`}return this.tasaBloqueadaTicket===null&&(this.tasaBloqueadaTicket=this.modelo.tasaActual),s?s.cantidad=t?Math.round(u*1e3)/1e3:Math.round(u):this.carrito.push({sku:e.sku,nombre:e.nombre,precioUsd:c,cantidad:t?n:Math.round(n),pesable:t,conSerie:(e.capacidades&Ae)!==0,conVariantes:(e.capacidades&$e)!==0,serie:o,variante:a,modoVenta:r}),this.notificar(),null}asignarSerie(e,o){const a=this.carrito.find(r=>r.sku===e);a&&(a.serie=o.trim().toUpperCase(),this.notificar())}asignarVariante(e,o){const a=this.carrito.find(r=>r.sku===e);a&&(a.variante=o.trim(),this.notificar())}obtenerFactorPresentacion(e,o){if(!e)return 1;if(o&&o!=="unidad"&&e.presentaciones){const a=e.presentaciones.find(r=>r.nombre.toLowerCase()===o.toLowerCase());if(a)return a.unidades}return o==="paquete"&&e.esCaja&&e.unidadesPorCaja?e.unidadesPorCaja:1}cambiarCantidad(e,o,a){const r=this.carrito.find(c=>c.sku===e&&(a===void 0||c.modoVenta===a));if(!r)return null;const i=this.productos.find(c=>c.sku===e);let d=Math.max(0,o);r.pesable?d=Math.round(d*1e3)/1e3:d=Math.round(d);const p=this.obtenerFactorPresentacion(i,r.modoVenta);return i&&!i.sinStock&&d*p>Number(i.stock)?`Stock insuficiente para ${r.nombre}. Disponible: ${i.stock} un., Solicitado: ${d*p} un.`:(r.cantidad=d,r.cantidad===0?this.quitar(e,r.modoVenta):this.notificar(),null)}quitar(e,o){this.carrito=this.carrito.filter(a=>!(a.sku===e&&(o===void 0||a.modoVenta===o))),this.carrito.length===0&&(this.tasaBloqueadaTicket=null),this.notificar()}vaciar(){this.carrito=[],this.tasaBloqueadaTicket=null,this.notificar()}async cobrar(e,o,a){if(this.modoCuentaAbierta&&this.cuentaSeleccionada)throw new Error("Hay una cuenta abierta seleccionada. Usa su boton de cobro.");if(this.carrito.length===0)throw new Error("Carrito vacio");for(const i of this.carrito){const d=this.productos.find(t=>t.sku===i.sku),p=this.obtenerFactorPresentacion(d,i.modoVenta),c=i.cantidad*p;if(d&&!d.sinStock&&c>Number(d.stock))throw new Error(`Stock insuficiente para ${d.nombre}. Disponible: ${d.stock} un., En carrito: ${c} un.`)}const r=await D.registrarVenta(this.carrito.map(i=>({sku:i.sku,cantidad:String(i.cantidad),modo_venta:i.modoVenta})),this.edadConfirmadaSesion,e||"0",o,a,`sale-${Date.now()}-${Math.random().toString(36).slice(2,8)}`);return this.vaciar(),this.edadConfirmadaSesion=!1,await this.refrescarInventario(),r}async crearCuenta(e){const o=await D.abrirCuenta(e);this.cuentas.some(a=>a.ventaId===o.ventaId)||this.cuentas.push(o),this.cuentaSeleccionada=o,this.notificar()}async agregarACuenta(e,o="unidad"){if(!this.cuentaSeleccionada)return"Selecciona una cuenta primero";const a=this.productos.find(i=>i.sku===e);if(!a)return"Producto no encontrado";if(this.requiereEdad(a))return"EDAD|"+a.nombre;const r=await D.agregarConsumo(this.cuentaSeleccionada.ventaId,a.sku,"1",this.edadConfirmadaSesion,o);return this.cuentaSeleccionada=r,this.cuentas=this.cuentas.map(i=>i.ventaId===r.ventaId?r:i),await this.refrescarInventario(),null}async cerrarCuentaActual(e,o){if(!this.cuentaSeleccionada)throw new Error("Ninguna cuenta seleccionada");const a=await D.cerrarCuenta(this.cuentaSeleccionada.ventaId,e||"0",void 0,o);return this.cuentas=this.cuentas.filter(r=>r.ventaId!==a.ventaId),this.cuentaSeleccionada=null,this.edadConfirmadaSesion=!1,await this.refrescarInventario(),a}async refrescarInventario(){this.productos=await D.productos(),this.notificar()}}function ce(b,e="info"){var r;const o={success:"bg-emerald-600 text-white",error:"bg-red-600 text-white",info:"bg-brand-black text-white"},a=document.createElement("div");a.className=`fixed bottom-6 right-6 ${o[e]} border-2 border-brand-black rounded shadow-brutal px-5 py-4 font-heading font-bold max-w-md z-[110] transition-all duration-300`,a.innerHTML=`<span class="text-xs sm:text-sm">${b.replace(/"/g,"")}</span> <button class="ml-3 underline font-black text-xs uppercase">Cerrar</button>`,(r=a.querySelector("button"))==null||r.addEventListener("click",()=>a.remove()),document.body.appendChild(a),setTimeout(()=>{a.style.opacity="0",setTimeout(()=>a.remove(),300)},6e3)}function ue(b,e="CONFIRMACIÓN REQUERIDA"){return new Promise(o=>{var i;const a=document.createElement("div");a.className="fixed inset-0 bg-black/60 flex items-center justify-center p-4 z-[120]",a.innerHTML=`
        ...
        `;const r=d=>{a.remove(),o(d)};a.querySelectorAll("[data-dialog-cancel]").forEach(d=>d.addEventListener("click",()=>r(!1))),(i=a.querySelector("[data-dialog-confirm]"))==null||i.addEventListener("click",()=>r(!0)),document.body.appendChild(a)})}function be(b,e="",o="SOLICITUD DE DATO"){return new Promise(a=>{var p;const r=document.createElement("div");r.className="fixed inset-0 bg-black/60 flex items-center justify-center p-4 z-[120]",r.innerHTML=`
            <div class="bg-white border-2 border-brand-black rounded-lg shadow-brutal max-w-md w-full p-5 sm:p-6">
                <div class="flex justify-between items-center border-b-2 border-brand-black pb-2 mb-3">
        ...
        `;const i=r.querySelector("#dialog-input-val"),d=c=>{r.remove(),a(c)};r.querySelectorAll("[data-dialog-cancel]").forEach(c=>c.addEventListener("click",()=>d(null))),(p=r.querySelector("[data-dialog-accept]"))==null||p.addEventListener("click",()=>{d((i==null?void 0:i.value)??"")}),i==null||i.addEventListener("keydown",c=>{c.key==="Enter"&&d(i.value),c.key==="Escape"&&d(null)}),document.body.appendChild(r),i==null||i.focus(),i==null||i.select()})}const qe="America/Caracas";function he(b){if(!b||b<=0)return"-";const e=new Date(b*1e3);return new Intl.DateTimeFormat("es-VE",{timeZone:qe,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!1}).format(e)}function Ue(b,e=!1){return new Intl.DateTimeFormat("es-VE",{timeZone:qe,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",...e?{second:"2-digit"}:{},hour12:!1}).format(b)}function ut(b){if(!b||b<=0)return"Hoy";const e=Math.floor(Date.now()/1e3),o=Math.max(0,e-b);if(o<3600)return"Hoy (reciente)";const a=Math.floor(o/3600);if(a<24)return`Hoy (hace ${a}h)`;const r=Math.floor(a/24);return r===1?"Hace 1 día":`Hace ${r} días`}const ie=b=>X(b).toLocaleString("es-VE",{minimumFractionDigits:2,maximumFractionDigits:2});async function Fe(b){var s,l,u;const[e,o]=await Promise.all([D.obtenerJornadaActual(),D.ventas()]);if(!e){b.innerHTML=`
        ...
        </div>`,(s=b.querySelector("#btn-cerrar-historial-turno"))==null||s.addEventListener("click",()=>{b.innerHTML=""});return}const a=e.inicioUnix,r=o.filter(m=>(m.fechaUnix||0)>=a);let i=0,d=0,p={},c={};r.forEach(m=>{const g=X(m.totalUsd),y=X(m.totalBs);i+=g,d+=y;const h=m.operador||e.operadorActual||"Cajero";c[h]||(c[h]={usd:0,bs:0,tickets:0}),c[h].usd+=g,c[h].bs+=y,c[h].tickets+=1,Array.isArray(m.pagos)&&m.pagos.length>0&&m.pagos.forEach(w=>{const f=w.metodo||"EFECTIVO";p[f]||(p[f]={usd:0,bs:0}),p[f].usd+=X(w.montoUsd),p[f].bs+=X(w.montoBs)})});const t=e.operadoresActivos&&e.operadoresActivos.length>0?e.operadoresActivos.join(", "):e.operadorActual||"Sin asignar";b.innerHTML=`
    <div class="fixed inset-0 bg-black/40 flex items-center justify-center z-[100] p-4">
        <div class="bg-white border-2 border-brand-black rounded-lg shadow-brutal p-5 sm:p-6 w-full max-w-3xl max-h-[90vh] overflow-y-auto flex flex-col">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-4">
                <div class="bg-gray-50 border-2 border-brand-black rounded p-3">
                    ...
                    <p class="text-xs font-black text-brand-purple">Bs. ${ie(d)}</p>
                </div>
                <div class="bg-gray-50 border-2 border-brand-black rounded p-3">
    ...
    </div>`,b.querySelectorAll("[data-toggle-ticket-detalle]").forEach(m=>{m.addEventListener("click",()=>{const g=m.dataset.toggleTicketDetalle,y=b.querySelector(`#detalle-ticket-${g}`),h=b.querySelector(`[data-arrow-detalle="${g}"]`);y&&(y.classList.contains("hidden")?(y.classList.remove("hidden"),h&&(h.textContent="▲")):(y.classList.add("hidden"),h&&(h.textContent="▼")))})});const n=()=>{b.innerHTML=""};(l=b.querySelector("#btn-cerrar-historial-turno"))==null||l.addEventListener("click",n),(u=b.querySelector("#btn-cerrar-historial-turno-footer"))==null||u.addEventListener("click",n)}const ee=b=>X(b).toLocaleString("es-VE",{minimumFractionDigits:2,maximumFractionDigits:2});class pt{constructor(e,o,a,r){T(this,"contenedor");T(this,"vm");T(this,"modelo");T(this,"modal");T(this,"pagosBorrador",null);T(this,"resolucionVueltoBorrador",null);T(this,"semaforoStock",{rojoMax:5,amarilloMax:15});this.contenedor=e,this.modal=o,this.vm=a,this.modelo=r,D.obtenerSemaforoStock().then(i=>{this.semaforoStock=i,this.renderDinamico()}),this.vm.suscribir(()=>this.renderDinamico()),this.modelo.suscribir(()=>this.renderDinamico())}render(){var e,o,a,r,i,d;this.contenedor.innerHTML=`
        ...
        <div class="fixed inset-0 bg-black/40 flex items-center justify-center z-[100] p-4">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div class="flex items-center justify-between p-2.5 rounded border-2 border-brand-black ${s?"bg-purple-50 border-brand-purple":"bg-gray-50"}">
                    <label class="flex items-center gap-2.5 cursor-pointer flex-1 min-w-0">
                        <input type="checkbox" data-cajero-chk="${n.id}" value="${n.nombre}" ${s?"checked":""} class="w-4 h-4 rounded text-brand-purple" />
                        <div>
                            <span class="font-heading font-black text-sm text-brand-black truncate block">${n.nombre}</span>
                            <span class="text-[10px] text-gray-500 font-bold">${n.activo?"Operador Activo":"Inactivo"}</span>
                        </div>
                    </label>
                    <div class="flex items-center gap-1 shrink-0">
                        <button data-cajero-edit="${n.id}" data-cajero-nom="${n.nombre}" title="Editar nombre" class="text-xs bg-white border border-gray-400 rounded px-1.5 py-0.5 hover:bg-gray-100">✎</button>
                        <button data-cajero-del="${n.id}" data-cajero-nom="${n.nombre}" title="Eliminar operador" class="text-xs text-red-600 bg-white border border-gray-400 rounded px-1.5 py-0.5 hover:bg-red-50">✕</button>
                    </div>
            ...
            `,"max-w-md"),(d=this.modal.querySelector("[data-cerrar]"))==null||d.addEventListener("click",()=>this.cerrarModal()),(p=this.modal.querySelector("#btn-cancelar-operadores-caja"))==null||p.addEventListener("click",()=>this.cerrarModal()),this.modal.querySelectorAll("button[data-cajero-edit]").forEach(n=>{n.addEventListener("click",async()=>{const s=n.dataset.cajeroEdit||"",l=n.dataset.cajeroNom||"",u=await be("Modificar nombre del operador:",l,"EDITAR OPERADOR");u&&u.trim()&&u.trim()!==l&&(await D.editarOperador(s,u.trim()),this.cerrarModal(),this.abrirModalOperadoresCaja(),this.renderDinamico())})}),this.modal.querySelectorAll("button[data-cajero-del]").forEach(n=>{n.addEventListener("click",async()=>{const s=n.dataset.cajeroDel||"",l=n.dataset.cajeroNom||"";await ue(`¿Confirmas eliminar al operador "${l}"?`,"ELIMINAR OPERADOR")&&(await D.eliminarOperador(s),this.cerrarModal(),this.abrirModalOperadoresCaja(),this.renderDinamico())})}),(c=this.modal.querySelector("#form-nuevo-cajero-caja"))==null||c.addEventListener("submit",async n=>{n.preventDefault();const s=this.modal.querySelector("#in-nuevo-cajero-caja"),l=(s==null?void 0:s.value.trim())||"";l&&(await D.crearOperador(l),this.cerrarModal(),this.abrirModalOperadoresCaja(),this.renderDinamico())}),(t=this.modal.querySelector("#btn-guardar-operadores-caja"))==null||t.addEventListener("click",async()=>{const n=this.modal.querySelectorAll("input[data-cajero-chk]:checked"),s=[];if(n.forEach(l=>{l.value&&s.push(l.value)}),s.length===0){this.mostrarToast("Debes seleccionar al menos un operador activo en turno.","error");return}await D.asignarOperadoresTurno(s),this.cerrarModal(),this.renderDinamico()})})()}async abrirModalIniciarJornada(){const e=await D.listarOperadores();(()=>{var r,i,d,p;const a=e.length>0?e.map((c,t)=>`
            ...
            `,"max-w-md"),(r=this.modal.querySelector("[data-cerrar]"))==null||r.addEventListener("click",()=>this.cerrarModal()),(i=this.modal.querySelector("#btn-cancelar-inicio-jornada"))==null||i.addEventListener("click",()=>this.cerrarModal()),(d=this.modal.querySelector("#form-nuevo-cajero-inicio"))==null||d.addEventListener("submit",async c=>{c.preventDefault();const t=this.modal.querySelector("#in-nuevo-cajero-inicio"),n=(t==null?void 0:t.value.trim())||"";n&&(await D.crearOperador(n),this.cerrarModal(),this.abrirModalIniciarJornada())}),(p=this.modal.querySelector("#btn-abrir-turno"))==null||p.addEventListener("click",async()=>{const c=this.modal.querySelectorAll("input[data-inicio-cajero-chk]:checked"),t=[];if(c.forEach(s=>{s.value&&t.push(s.value)}),t.length===0){this.mostrarToast("Selecciona al menos un operador para abrir el turno.","error");return}const n=t[0];await D.abrirJornada(n,t),this.cerrarModal(),this.renderDinamico()})})()}async abrirModalCobro(){var g,y,h,w;if(this.vm.lineasCarrito.length===0)return;let e=[];try{e=await D.listarMetodosPago()}catch{e=[{nombre:"PUNTOD.VENTA",moneda:"BS"},{nombre:"BIOPAGO",moneda:"BS"},{nombre:"PAGO MOVIL",moneda:"BS"},{nombre:"TRANSF.BS.",moneda:"BS"},{nombre:"BS.EFEC.",moneda:"BS"},{nombre:"DOL.CASH",moneda:"USD"},{nombre:"ZELLE",moneda:"USD"},{nombre:"BINAN.USDT",moneda:"USD"}]}const o=Number(this.vm.totalUsd.toFixed(2)),a=this.vm.tasaTicket,r=Number((o*a).toFixed(2)),i=e.find(f=>f.nombre==="BIOPAGO")||e.find(f=>f.moneda==="BS")||e[0]||{nombre:"BIOPAGO",moneda:"BS"};let d;if(this.pagosBorrador&&this.pagosBorrador.length>0){if(d=this.pagosBorrador.map(f=>({...f})),d.length===1&&d[0]){const f=d[0];f.monto=f.moneda==="USD"?o:r,f.tasaCambio=a}else if(d.length>1){let f=0;for(let A=0;A<d.length-1;A++){const C=d[A],v=C.tasaCambio>0?C.tasaCambio:a;f+=C.moneda==="USD"?C.monto*v:C.monto}const S=Math.max(0,Math.round((r-f)*100)/100),B=d[d.length-1];B&&(B.monto=B.moneda==="USD"?a>0?Number((S/a).toFixed(2)):0:S,B.tasaCambio=a)}}else d=[{id:"p-1",metodo:i.nombre,moneda:i.moneda,monto:i.moneda==="USD"?o:r,tasaCambio:a,referencia:""}];let p=((g=this.resolucionVueltoBorrador)==null?void 0:g.estado)||"PAGADO",c=((y=this.resolucionVueltoBorrador)==null?void 0:y.metodo)||"BS.EFEC.",t=((h=this.resolucionVueltoBorrador)==null?void 0:h.tasa)||a;e.some(f=>f.nombre===c)||(c=((w=e[0])==null?void 0:w.nombre)||"BS.EFEC.");let n=!1;const s=()=>{let f=0;for(const L of d)if(L.moneda==="USD"){const N=L.tasaCambio>0?L.tasaCambio:a;f+=L.monto*N}else f+=L.monto;f=Math.round(f*100)/100;const S=a>0?Math.round(f/a*100)/100:0,B=Math.max(0,Math.round((r-f)*100)/100),A=a>0?Math.max(0,Math.round(B/a*100)/100):0,C=Math.max(0,Math.round((f-r)*100)/100),v=a>0?Math.max(0,Math.round(C/a*100)/100):0,E=f>=r-.01&&d.every(L=>L.monto>0);return{cubiertoUsd:S,cubiertoBs:f,faltanteUsd:A,faltanteBs:B,vueltoUsd:v,vueltoBs:C,puedeConfirmar:E}},l=f=>{const S=e.find(v=>v.nombre===c),B=(S==null?void 0:S.moneda)==="USD",A=t>0?t:a,C=B&&A>0?Number((f.vueltoBs/A).toFixed(2)):f.vueltoUsd;return f.faltanteBs>.009?`
            ...
            <div class="bg-emerald-50 border-2 border-emerald-600 rounded p-2.5 text-center mb-3">
                ...
                <p class="text-xs text-emerald-700 font-bold">Importe liquidado sin diferencia pendiente.</p>
            </div>`},u=()=>{const f=s(),S=e.filter(v=>v.moneda==="USD"),B=e.filter(v=>v.moneda==="BS"),A=d.map((v,E)=>{const L=S.map(P=>`<option value="${P.nombre}" ${P.nombre===v.metodo?"selected":""}>${P.nombre} ($ - Tasa Dinámica)</option>`).join(""),j=`
                    ...
                    <div data-pago-card="${v.id}" class="border-2 border-brand-black rounded-lg p-3 bg-gray-50 mb-2.5">
                        <div class="flex flex-wrap items-center justify-between gap-2 mb-2">
                            ...
                            ${d.length>1?`<button data-eliminar-pago="${v.id}" class="text-xs font-black text-red-600 hover:text-red-800 bg-red-50 border border-red-300 rounded px-2 py-0.5">Eliminar</button>`:""}
                        </div>
                        ${v.moneda==="USD"?`
                ...
                <div>
                    ...
                    `};this.modal.querySelectorAll("input[data-pago-tasa]").forEach(k=>{k.addEventListener("input",$=>{const U=k.dataset.pagoTasa,H=X($.target.value),G=d.find(W=>W.id===U);G&&(G.tasaCambio=H>0?H:a,this.pagosBorrador=d,A(G),B())}),k.addEventListener("keydown",$=>{var U;$.key==="Enter"&&s().puedeConfirmar&&((U=this.modal.querySelector("#btn-confirmar-cobro"))==null||U.click())})}),this.modal.querySelectorAll("button[data-reset-tasa]").forEach(k=>{k.addEventListener("click",()=>{const $=k.dataset.resetTasa,U=d.find(H=>H.id===$);U&&(U.tasaCambio=a,this.pagosBorrador=d,u())})}),this.modal.querySelectorAll("input[data-pago-monto]").forEach(k=>{k.addEventListener("input",$=>{const U=k.dataset.pagoMonto,H=X($.target.value),G=d.find(W=>W.id===U);G&&(G.monto=H,this.pagosBorrador=d,A(G),B())}),k.addEventListener("keydown",$=>{var U;$.key==="Enter"&&s().puedeConfirmar&&((U=this.modal.querySelector("#btn-confirmar-cobro"))==null||U.click())})}),this.modal.querySelectorAll("input[data-pago-ref]").forEach(k=>{k.addEventListener("input",$=>{const U=k.dataset.pagoRef,H=$.target.value,G=d.find(W=>W.id===U);G&&(G.referencia=H,this.pagosBorrador=d)}),k.addEventListener("keydown",$=>{var U;$.key==="Enter"&&s().puedeConfirmar&&((U=this.modal.querySelector("#btn-confirmar-cobro"))==null||U.click())})}),this.modal.querySelectorAll("button[data-eliminar-pago]").forEach(k=>{k.addEventListener("click",()=>{const $=k.dataset.eliminarPago;d=d.filter(U=>U.id!==$),this.pagosBorrador=d,u()})}),(K=this.modal.querySelector("#btn-agregar-pago"))==null||K.addEventListener("click",()=>{let k=s();const $="p-"+Math.random().toString(36).slice(2,7),U=e.find(G=>!d.some(W=>W.metodo===G.nombre))||e[0]||{nombre:"BS.EFEC.",moneda:"BS"};if(k.faltanteBs<=.01&&d.length===1&&d[0]){const G=d[0],W=G.tasaCambio>0?G.tasaCambio:a,J=G.moneda==="USD"?G.monto*W:G.monto,Y=Math.round(J/2*100)/100;G.monto=G.moneda==="USD"?W>0?Number((Y/W).toFixed(2)):0:Y,k=s()}const H=k.faltanteBs>0?k.faltanteBs:0;d.push({id:$,metodo:U.nombre,moneda:U.moneda,monto:U.moneda==="USD"?a>0?Number((H/a).toFixed(2)):0:H,tasaCambio:a,referencia:""}),this.pagosBorrador=d,u()}),(P=this.modal.querySelector("#btn-toggle-nuevo-metodo"))==null||P.addEventListener("click",()=>{n=!n,u()}),(Z=this.modal.querySelector("#btn-guardar-nuevo-metodo"))==null||Z.addEventListener("click",()=>{(async()=>{const k=this.modal.querySelector("#input-nuevo-metodo-nombre"),$=(k==null?void 0:k.value.trim())||"",U=this.modal.querySelector('input[name="radio-nuevo-metodo-moneda"][value="USD"]'),H=U!=null&&U.checked?"USD":"BS";if($)try{e=await D.crearMetodoPago($,H),n=!1,u()}catch{}})()}),this.modal.querySelectorAll("button[data-caja-eliminar-metodo]").forEach(k=>{k.addEventListener("click",()=>{(async()=>{const $=k.dataset.cajaEliminarMetodo||"";$&&await ue(`¿Seguro que deseas eliminar el método de pago "${$}"?`,"ELIMINAR MÉTODO")&&(e=await D.eliminarMetodoPago($),d.forEach(U=>{if(U.metodo===$){const H=e[0]||{nombre:"PUNTOD.VENTA",moneda:"BS"};U.metodo=H.nombre,U.moneda=H.moneda}}),this.pagosBorrador=d,u())})()})});let C=!1;const v=this.modal.querySelector("#btn-confirmar-cobro");v==null||v.addEventListener("click",()=>{C||(C=!0,v&&(v.disabled=!0,v.textContent="PROCESANDO COBRO..."),(async()=>{const k=this.modal.querySelector("#cobro-error");try{const $=d.filter(I=>I.monto>0).map(I=>{const q=I.moneda==="USD"&&I.tasaCambio>0?I.tasaCambio:a,V=I.moneda==="USD"?I.monto*q:I.monto,Q=a>0?V/a:0;return{metodo:I.metodo,moneda:I.moneda,montoUsd:(I.moneda==="USD"?I.monto:Q).toFixed(2),montoBs:V.toFixed(2),tasaCambio:I.moneda==="USD"?q.toFixed(2):void 0,referencia:I.referencia.trim()||void 0}});if($.length===0)throw new Error("Debe especificar al menos un pago válido.");const U=s(),H=$.reduce((I,q)=>I+Number(q.montoBs),0),G=e.find(I=>I.nombre===c),W=(G==null?void 0:G.moneda)==="USD",J=W?t>0?t:a:void 0,Y=W&&J?(U.vueltoBs/J).toFixed(2):U.vueltoUsd.toFixed(2),O={estado:U.vueltoBs>.009?p:"SIN_VUELTO",metodo:U.vueltoBs>.009&&p==="PAGADO"?c:void 0,montoBs:U.vueltoBs>.009?U.vueltoBs.toFixed(2):void 0,montoUsd:U.vueltoBs>.009?Y:void 0,tasa:U.vueltoBs>.009&&p==="PAGADO"&&J?J.toFixed(2):void 0},_=await this.vm.cobrar(H.toFixed(2),$,O);this.pagosBorrador=null,this.resolucionVueltoBorrador=null,this.cerrarModal(),this.modalTicketExito(_,H)}catch($){C=!1,v&&(v.disabled=!1,v.textContent="CONFIRMAR COBRO"),k&&(k.textContent=$ instanceof Error?$.message.replace(/"/g,""):String($),k.classList.remove("hidden"))}})())})};u()}modalTicketExito(e,o){const a=e.pagos&&e.pagos.length>0?e.pagos.map(i=>`
                <tr class="border-b border-gray-100 last:border-none">
                    <td class="py-1.5 text-left font-heading font-black text-xs text-brand-black">
                        ${i.metodo}
                        ${i.tasaCambio?`<span class="block text-[10px] text-brand-purple font-mono font-bold">Tasa: Bs. ${ee(Number(i.tasaCambio))}</span>`:""}
                        ${i.referencia?`<span class="block text-[10px] text-gray-500 font-mono font-normal">Ref: ${i.referencia}</span>`:""}
                    </td>
                    <td class="py-1.5 text-right font-black text-xs text-brand-black">$ ${ee(i.montoUsd)}</td>
                    <td class="py-1.5 text-right font-black text-xs text-brand-purple">Bs. ${ee(i.montoBs)}</td>
                </tr>
            ...
            <button data-cerrar class="w-full bg-brand-black text-white font-heading font-black text-lg py-3 rounded border-2 border-brand-black shadow-brutal-sm hover:bg-gray-800">
                LISTO
            </button>`,"max-w-md")}renderDinamico(){const e=this.contenedor.querySelector("#caja-grid");if(!e)return;const o=this.semaforoStock;e.innerHTML=this.vm.visibles.map(d=>{const p=(d.capacidades&fe)!==0,c=Number(d.stock),t=c<=0,n=d.sinStock?"text-purple-700":c<=o.rojoMax?"text-red-600":c<=o.amarilloMax?"text-amber-600":"text-emerald-700",s=d.unidad?d.unidad.toLowerCase()==="un"?"un.":d.unidad.toLowerCase():p?"kg":"un.",l=s==="kg"?"kg":s==="ml"?"ml":"un.";let u="";if(d.sinStock)u="LIBRE";else if(t)u="AGOTADO";else if(d.esCaja&&d.unidadesPorCaja&&d.unidadesPorCaja>1){const y=Math.floor(c/d.unidadesPorCaja),h=c%d.unidadesPorCaja;u=`${y} cajas y ${h} un. (${c} un.)`}else u=`${c} ${s}`;const m=d.precioPaqueteUsd&&d.nombrePaquete||d.esCaja&&d.unidadesPorCaja&&d.unidadesPorCaja>1,g=d.presentaciones&&d.presentaciones.length>0?d.presentaciones.map(y=>`
                        <button data-sku="${d.sku}" data-modo="${y.nombre}" ${t&&!d.sinStock?"disabled":""}
                        ...
                        <button data-sku="${d.sku}" data-modo="paquete" ${t&&!d.sinStock?"disabled":""}
                            class="text-left border-2 border-brand-purple rounded p-2 bg-purple-50 shadow-brutal hover:-translate-y-0.5 hover:shadow-brutal-hover transition-all active:translate-y-0.5 active:shadow-none disabled:opacity-30 w-full mt-1">
                            <div class="flex justify-between items-center">
                                <span class="font-heading font-bold text-xs text-purple-800">${d.nombrePaquete||"Caja"} (${d.precioPaqueteUsd?`$${Number(d.precioPaqueteUsd).toFixed(2)}`:`$${(Number(d.precioUsd)*(d.unidadesPorCaja||1)).toFixed(2)}`})</span>
                                <span class="text-[10px] font-black text-purple-600">${d.unidadesPorCaja||1} un.</span>
                            </div>
                        </button>`:"";return`
                <div class="relative" data-producto-card="${d.sku}">
                    <button data-sku="${d.sku}" data-modo="unidad" ${t&&!d.sinStock?"disabled":""}
                        ...
                        <div class="flex justify-between items-start mb-1 gap-1">
                            <span class="font-heading font-extrabold leading-tight text-sm text-brand-black truncate" title="${d.nombre}">${d.nombre}</span>
                            <div class="flex gap-1 shrink-0">
                                ${`<span class="text-[9px] font-black bg-amber-100 text-amber-900 border border-brand-black rounded px-1 lowercase">${l}</span>`}
                            </div>
                        </div>
                        <p class="font-heading font-black text-lg text-brand-purple">Bs. ${this.modelo.bs(d.precioUsd)}</p>
                        <div class="flex justify-between items-center mt-1">
                            <span class="text-xs font-bold text-gray-600">$${Number(d.precioUsd).toFixed(2)}</span>
                            <span class="text-[11px] font-black ${n}">
                                ${u}
                            </span>
                        </div>
                    </button>
                    ${g}
                </div>`}).join(""),e.querySelectorAll("button[data-sku]").forEach(d=>d.addEventListener("click",()=>{const p=d.dataset.sku??"",c=d.dataset.modo||"unidad";(async()=>{const t=this.vm.modoCuentaAbierta?await this.vm.agregarACuenta(p,c):await this.vm.agregar(p,c);t&&this.mostrarError(t)})()}));const a=this.contenedor.querySelector("#caja-lineas");a&&(a.innerHTML=this.vm.lineasCarrito.length===0?'<p class="text-center text-brand-text font-body py-10">Toca un producto para agregarlo</p>':this.vm.lineasCarrito.map(d=>`
                    <div class="border-2 border-brand-black rounded p-2 bg-white shadow-sm space-y-1">
                        <div class="flex items-center gap-2">
                            <div class="flex-1 min-w-0 pr-2">
                                <p class="font-heading font-bold text-sm truncate" title="${d.nombre}">
                                    ${d.nombre}
                                    ${d.modoVenta!=="unidad"?`<span class="inline-block ml-1 text-[9px] font-black bg-purple-100 text-purple-800 border border-brand-purple rounded px-1">${d.modoVenta}</span>`:""}
                                </p>
                                <p class="text-xs text-gray-600 font-bold">$${d.precioUsd.toFixed(2)} · Bs. ${this.modelo.bs(Number((d.precioUsd*d.cantidad).toFixed(2)))}</p>
                            </div>
                            ${d.pesable?`<input type="number" step="0.05" min="0.01" max="999.99" maxlength="6" value="${Number(d.cantidad.toFixed(3))}" data-qty="${d.sku}" data-modo="${d.modoVenta}" class="w-20 border-2 border-brand-black rounded px-1 py-0.5 text-right font-bold text-sm" />`:`<button data-menos="${d.sku}" data-modo="${d.modoVenta}" class="w-7 h-7 border-2 border-brand-black rounded font-black bg-amber-100 text-sm">-</button>
                                   <span class="font-black w-5 text-center text-sm">${d.cantidad}</span>
                                   <button data-mas="${d.sku}" data-modo="${d.modoVenta}" class="w-7 h-7 border-2 border-brand-black rounded font-black bg-emerald-100 text-sm">+</button>`}
                            <button data-quitar="${d.sku}" data-modo="${d.modoVenta}" class="w-7 h-7 border-2 border-brand-black rounded font-black bg-red-100 text-red-800 text-sm hover:bg-red-600 hover:text-white transition-colors">&times;</button>
                        </div>
                    </div>`).join(""));const r=this.contenedor.querySelector("#caja-total-usd"),i=this.contenedor.querySelector("#caja-total-bs");r&&(r.textContent="$ "+ee(this.vm.totalUsd)),i&&(i.textContent="Bs. "+ee(this.vm.totalBs)),D.obtenerJornadaActual().then(d=>{const p=this.contenedor.querySelector("#caja-operadores-activo-texto"),c=this.contenedor.querySelector("#btn-gestionar-operadores-caja"),t=this.contenedor.querySelector("#caja-cobrar");if(d===null){if(p&&(p.textContent="SIN TURNO ACTIVO",p.title="No hay jornada activa. Abre un turno para operar."),c){c.classList.remove("bg-purple-100","text-brand-purple","border-brand-purple","hover:bg-purple-200"),c.classList.add("bg-orange-100","text-red-800","border-red-600","hover:bg-orange-200");const n=c.querySelector("span.rounded-full");n&&(n.classList.remove("bg-emerald-500"),n.classList.add("bg-red-500"))}t&&(t.disabled=!0,t.title="Abre un turno antes de cobrar")}else{const n=d.operadoresActivos&&d.operadoresActivos.length>0?d.operadoresActivos.join(", "):d.operadorActual||"Operador en caja";if(p&&(p.textContent=n,p.title=`Operadores en caja: ${n}`),c){c.classList.add("bg-purple-100","text-brand-purple","border-brand-purple","hover:bg-purple-200"),c.classList.remove("bg-orange-100","text-red-800","border-red-600","hover:bg-orange-200");const s=c.querySelector("span.rounded-full");s&&(s.classList.add("bg-emerald-500"),s.classList.remove("bg-red-500"))}t&&(t.disabled=!1,t.title="")}}),this.contenedor.querySelectorAll("[data-mas]").forEach(d=>d.addEventListener("click",()=>{const p=d.dataset.mas??"",c=d.dataset.modo??"unidad",t=this.vm.lineasCarrito.find(n=>n.sku===p&&n.modoVenta===c);if(t){const n=this.vm.cambiarCantidad(p,t.cantidad+1,c);n&&this.mostrarError(n)}})),this.contenedor.querySelectorAll("[data-menos]").forEach(d=>d.addEventListener("click",()=>{const p=d.dataset.menos??"",c=d.dataset.modo??"unidad",t=this.vm.lineasCarrito.find(n=>n.sku===p&&n.modoVenta===c);t&&this.vm.cambiarCantidad(p,Math.max(1,t.cantidad-1),c)})),this.contenedor.querySelectorAll("[data-quitar]").forEach(d=>d.addEventListener("click",()=>{const p=d.dataset.quitar??"",c=d.dataset.modo??"unidad";this.vm.quitar(p,c)})),this.contenedor.querySelectorAll("input[data-qty]").forEach(d=>d.addEventListener("change",()=>{const p=Number(d.value||"0"),c=d.dataset.modo??"unidad",t=Math.min(999.99,Math.max(.01,Number.isFinite(p)?p:.01));d.value=String(t);const n=this.vm.cambiarCantidad(d.dataset.qty??"",t,c);n&&this.mostrarError(n)}))}mostrarToast(e,o="info"){var i;const a={success:"bg-emerald-600 text-white",error:"bg-red-600 text-white",info:"bg-brand-black text-white"},r=document.createElement("div");r.className=`fixed bottom-6 right-6 ${a[o]} border-2 border-brand-black rounded shadow-brutal px-5 py-4 font-heading font-bold max-w-md z-[110]`,r.innerHTML=`${e.replace(/"/g,"")} <button class="ml-3 underline font-black">cerrar</button>`,(i=r.querySelector("button"))==null||i.addEventListener("click",()=>r.remove()),document.body.appendChild(r),setTimeout(()=>r.remove(),8e3)}}const re=b=>{if(typeof b=="number")return Number.isFinite(b)?b:0;if(b==null)return 0;let e=String(b).trim();if(!e)return 0;e.includes(",")&&!e.includes(".")?e=e.replace(",","."):e.includes(".")&&e.includes(",")&&(e=e.replace(/\./g,"").replace(",","."));const o=parseFloat(e);return Number.isFinite(o)&&!isNaN(o)?o:0},ae=b=>{const e=re(b);return(Math.round((e+Number.EPSILON)*100)/100).toLocaleString("es-VE",{minimumFractionDigits:2,maximumFractionDigits:2})},me=b=>{const e=re(b);return e>=1e9?(e/1e9).toLocaleString("es-VE",{minimumFractionDigits:2,maximumFractionDigits:2})+" Mil Millones":e>=1e6?(e/1e6).toLocaleString("es-VE",{minimumFractionDigits:2,maximumFractionDigits:2})+" Millones":ae(e)};class mt{constructor(){T(this,"datos",null)}setDatos(e){this.datos=e}get panel(){return this.datos}}class xt{constructor(e,o,a,r){T(this,"contenedor");T(this,"vm");T(this,"modelo");T(this,"criterioGrafica","volumen");T(this,"respaldos",[]);T(this,"transacciones",[]);T(this,"productos",[]);T(this,"categorias",[]);T(this,"rangoDetalleFechas","");T(this,"jornadaActual",null);T(this,"POR_PAGINA_TRX",20);T(this,"paginaTrx",1);T(this,"margenBrutoPct",0);T(this,"margenNetoPct",0);this.contenedor=e,this.vm=a,this.modelo=r}calcularDineroPorCategoria(){const e=this.modelo.tasaActual||807.39;let o=0;const a={};return this.categorias.forEach(r=>{a[r.id]={categoriaId:r.id,nombre:r.nombre,cantidadProductos:0,unidadesStock:0,brutoUsd:0,ventaUsd:0}}),a["cat-general"]||(a["cat-general"]={categoriaId:"cat-general",nombre:"General",cantidadProductos:0,unidadesStock:0,brutoUsd:0,ventaUsd:0}),this.productos.forEach(r=>{const i=r.categoriaId||"cat-general";a[i]||(a[i]={categoriaId:i,nombre:"General",cantidadProductos:0,unidadesStock:0,brutoUsd:0,ventaUsd:0});const d=Number(r.stock)||0,p=re(r.precioBrutoUsd),c=re(r.precioUsd);a[i].cantidadProductos+=1,a[i].unidadesStock+=d;const t=d*p;a[i].brutoUsd+=t,a[i].ventaUsd+=d*c,o+=t}),Object.values(a).map(r=>{const i=o>0?(r.brutoUsd/o*100).toFixed(1):"0.0",d=Math.max(0,r.ventaUsd-r.brutoUsd),p=r.ventaUsd>0?(d/r.ventaUsd*100).toFixed(1):"0.0";return{categoriaId:r.categoriaId,nombre:r.nombre,cantidadProductos:r.cantidadProductos,unidadesStock:r.unidadesStock,dineroBrutoUsd:r.brutoUsd.toFixed(2),dineroBrutoBs:(r.brutoUsd*e).toFixed(2),dineroVentaUsd:r.ventaUsd.toFixed(2),dineroVentaBs:(r.ventaUsd*e).toFixed(2),margenBrutoProyectadoUsd:d.toFixed(2),margenBrutoPct:p,porcentajeCapital:i}})}calcularMargenes(){if(this.productos.length===0)return;let e=0,o=0;this.productos.forEach(a=>{const r=re(a.precioUsd),i=re(a.precioBrutoUsd);r>0&&(e+=r,i>0&&(o+=i))}),e>0&&(this.margenBrutoPct=Math.round((e-o)/e*100),this.margenNetoPct=Math.max(0,this.margenBrutoPct-12))}obtenerTimestampTicket(e){if(e.fechaUnix&&e.fechaUnix>0)return e.fechaUnix;if(e.fechaHora){const o=e.fechaHora.match(/(\d{4})-(\d{2})-(\d{2})[T\s](\d{2}):(\d{2}):(\d{2})/);if(o&&o[1]&&o[2]&&o[3]&&o[4]&&o[5]&&o[6]){const a=Date.UTC(parseInt(o[1],10),parseInt(o[2],10)-1,parseInt(o[3],10),parseInt(o[4],10),parseInt(o[5],10),parseInt(o[6],10));if(!isNaN(a))return Math.floor(a/1e3)}}return Math.floor(Date.now()/1e3)}renderFilasTransacciones(e){if(e.length===0)return'<tr><td colspan="7" class="py-6 text-center text-gray-400 font-bold">No se encontraron transacciones registradas.</td></tr>';const o=Math.ceil(e.length/this.POR_PAGINA_TRX);this.paginaTrx>o&&(this.paginaTrx=o),this.paginaTrx<1&&(this.paginaTrx=1);const a=(this.paginaTrx-1)*this.POR_PAGINA_TRX;return e.slice(a,a+this.POR_PAGINA_TRX).map(i=>{const d=i.fechaUnix?he(i.fechaUnix):i.fechaHora||"Reciente",p=i.ventaId.startsWith("CTA-"),c=p?"Cuenta Abierta":"Caja Directa";return`
            <tr class="hover:bg-gray-50 border-b border-gray-100 last:border-none transition-colors">
                ...
                <td class="py-2.5 text-gray-600">${d}</td>
                <td class="py-2.5">
                ...
                <td class="py-2.5 text-right font-mono text-gray-600">Bs. ${ae(Number(i.tasaDelDia))}</td>
                <td class="py-2.5 text-right font-black">$ ${ae(i.totalUsd)}</td>
                <td class="py-2.5 text-right font-black text-brand-purple">Bs. ${ae(i.totalBs)}</td>
            </tr>`}).join("")}async render(){var S;const[e,o,a,r,i,d]=await Promise.all([D.panel(),D.respaldos(),D.ventas(),D.productos(),D.categorias(),D.obtenerJornadaActual()]);this.vm.setDatos(e),this.respaldos=o,this.transacciones=a,this.productos=r,this.categorias=i,this.jornadaActual=d,this.calcularMargenes();const p=new Date,c=new Date(p.getTime()-864e5);this.rangoDetalleFechas||(this.rangoDetalleFechas=`Del ${Ue(c)} al ${Ue(p)}`);const t=this.modelo.bs(e.valorInventarioUsd),n=this.modelo.tieneCapacidad(8)||this.modelo.tieneRubro(4),s=e.dineroPorCategoria&&e.dineroPorCategoria.length>0?e.dineroPorCategoria:this.calcularDineroPorCategoria(),l=s.reduce((B,A)=>B+A.cantidadProductos,0),u=s.reduce((B,A)=>B+A.unidadesStock,0),m=s.reduce((B,A)=>B+re(A.dineroBrutoUsd),0),g=s.reduce((B,A)=>B+re(A.dineroBrutoBs),0),y=s.reduce((B,A)=>B+re(A.dineroVentaUsd),0),h=Math.max(0,y-m),w=y>0?(h/y*100).toFixed(1):"0.0",f=s.map(B=>{const A=re(B.porcentajeCapital);return`
                ...
                <div>
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex justify-between items-center py-1.5 border-b border-gray-200">
                            ...
                            <span class="font-black font-heading text-base">${n?e.cuentasAbiertas:"N/A"}</span>
                        </div>
                        <div class="flex justify-between items-center py-1.5 border-b border-gray-200">
                            <div>
                            ...
                            <div class="text-right">
                                <span class="font-black font-heading text-base text-amber-700">${n?e.deudasAbiertas??0:"N/A"}</span>
                                ${n&&e.dineroEnLaCalleUsd?`
        ...
        <div class="border-2 border-brand-black rounded-lg shadow-brutal-sm p-4 ${r} flex flex-col justify-between min-w-0 overflow-hidden" title="${i}">
            ...
            `}).join(""),m=r?`${Math.round(d)} un.`:`$ ${ae(d)}`;o.innerHTML=`
        ...
        </div>`}mostrarToast(e,o="info"){var i;const a={success:"bg-emerald-600 text-white",error:"bg-red-600 text-white",info:"bg-brand-black text-white"},r=document.createElement("div");r.className=`fixed bottom-6 right-6 ${a[o]} border-2 border-brand-black rounded shadow-brutal px-5 py-4 font-heading font-bold max-w-md z-[110]`,r.innerHTML=`${e.replace(/"/g,"")} <button class="ml-3 underline font-black">cerrar</button>`,(i=r.querySelector("button"))==null||i.addEventListener("click",()=>r.remove()),document.body.appendChild(r),setTimeout(()=>r.remove(),8e3)}}const oe=b=>{if(typeof b=="number")return Number.isFinite(b)?b:0;if(b==null)return 0;let e=String(b).trim();if(!e)return 0;e.includes(",")&&!e.includes(".")?e=e.replace(",","."):e.includes(".")&&e.includes(",")&&(e=e.replace(/\./g,"").replace(",","."));const o=parseFloat(e);return Number.isFinite(o)&&!isNaN(o)?o:0},R=b=>oe(b).toLocaleString("es-VE",{minimumFractionDigits:2,maximumFractionDigits:2});function Ie(b){if(b.sinStock)return"Ilimitado";const e=Number(b.stock);if(b.esCaja&&b.unidadesPorCaja&&b.unidadesPorCaja>1){const o=Math.floor(e/b.unidadesPorCaja),a=e%b.unidadesPorCaja;return`${o} cj. + ${a} un.`}return`${e} un.`}const Se=(b,e,o,a)=>{b.maxLength=o,b.addEventListener("input",()=>{let r=b.value.replace(/[^0-9.,]/g,"");const i=r.split(/[.,]/);i.length>2&&(r=i[0]+"."+i.slice(1).join("")),r.length>o&&(r=r.slice(0,o));const d=oe(r);Number.isFinite(d)&&d>e&&(r=String(e)),b.value!==r&&(b.value=r),a&&a()})},Ce=(b,e,o=!1)=>{b.maxLength=e,b.addEventListener("input",()=>{let a=o?b.value.replace(/[<>{}\\]/g,""):b.value.replace(/[^a-zA-Z0-9áéíóúÁÉÍÓÚñÑüÜ .,/_#-]/g,"");a.length>e&&(a=a.slice(0,e)),b.value!==a&&(b.value=a)})};function Pe(b){return ut(b)}class gt{constructor(e,o,a){T(this,"contenedor");T(this,"modal");T(this,"modelo");T(this,"cuentas",[]);T(this,"productos",[]);T(this,"cuentaSeleccionada",null);T(this,"filtroTab","todas");T(this,"POR_PAGINA_CUENTAS",15);T(this,"paginaCuentas",1);T(this,"pagosBorradorPorCuenta",new Map);T(this,"resolucionVueltoPorCuenta",new Map);this.contenedor=e,this.modal=o,this.modelo=a}async render(){[this.cuentas,this.productos]=await Promise.all([D.cuentas(),D.productos()]);const e=this.modelo.tieneRubro(4);!e&&this.filtroTab==="activa"&&(this.filtroTab="deuda");const o=this.cuentas.filter(n=>(n.tipo||"activa")==="activa"),a=this.cuentas.filter(n=>n.tipo==="deuda"),r=this.cuentas.filter(n=>e?this.filtroTab==="activa"?(n.tipo||"activa")==="activa":this.filtroTab==="deuda"?n.tipo==="deuda":!0:n.tipo==="deuda");this.cuentaSeleccionada&&(this.cuentaSeleccionada=this.cuentas.find(n=>{var s;return n.ventaId===((s=this.cuentaSeleccionada)==null?void 0:s.ventaId)})||null),this.cuentaSeleccionada&&!r.some(n=>{var s;return n.ventaId===((s=this.cuentaSeleccionada)==null?void 0:s.ventaId)})?this.cuentaSeleccionada=r[0]||null:!this.cuentaSeleccionada&&r.length>0&&(this.cuentaSeleccionada=r[0]);const i=this.modelo.tasaActual||807.39;let d=0;a.forEach(n=>{const s=oe(n.totalParcialUsd),l=oe(n.abonosUsd);d+=Math.max(0,s-l)});const p=d*i;let c=0;o.forEach(n=>{const s=oe(n.totalParcialUsd),l=oe(n.abonosUsd);c+=Math.max(0,s-l)});const t=this.cuentas.reduce((n,s)=>n+oe(s.abonosUsd),0);this.contenedor.innerHTML=`
        <div class="mb-4 sm:mb-6 flex flex-wrap items-center justify-between gap-3">
            <div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 mb-4 sm:mb-6">
            <div class="bg-amber-50 border-2 border-brand-black rounded-lg p-3 sm:p-4 shadow-brutal-sm">
                ...
                <p class="font-heading font-black text-2xl sm:text-3xl text-amber-950 mt-1">$ ${R(d)}</p>
            ...
            <div class="bg-white border-2 border-brand-black rounded-lg p-3 sm:p-4 shadow-brutal-sm">
                ...
                <p class="text-xs font-bold text-gray-500">Bs. ${R(t*i)}</p>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 items-start">
            ...
            <div class="space-y-3">
                ...
                ${(()=>{const n=Math.ceil(r.length/this.POR_PAGINA_CUENTAS);return n<=1?"":`
                    <div class="flex items-center justify-between border-2 border-brand-black rounded bg-white p-2 mt-2 shadow-brutal-sm">
                        <span class="text-[10px] font-bold text-gray-600">Pág. ${this.paginaCuentas} de ${n} (${r.length} reg.)</span>
                        <div class="flex gap-1">
                            ...
                            <button id="cta-pag-sig" class="border-2 border-brand-black px-2 py-0.5 rounded text-[10px] font-heading font-black shadow-brutal-sm ${this.paginaCuentas===n?"opacity-30 pointer-events-none":"hover:bg-gray-100"}">SIG.</button>
                        </div>
                    </div>`})()}
            </div>
            ...
            <div class="lg:col-span-2">
                ${this.cuentaSeleccionada?(()=>{var y;const n=this.cuentaSeleccionada.tipo==="deuda",s=oe(this.cuentaSeleccionada.totalParcialUsd),l=oe(this.cuentaSeleccionada.abonosUsd),u=Math.max(0,s-l),m=Math.max(0,l-s),g=Pe(this.cuentaSeleccionada.fechaCreacionUnix);return`
                <div class="bg-white border-2 border-brand-black rounded-lg shadow-brutal p-4 sm:p-6 flex flex-col space-y-4">
                    ...
                    <div class="flex flex-wrap justify-between items-center border-b-2 border-brand-black pb-4 gap-2">
                        ...
                        <div class="text-right">
                            ${m>0?`
                                ...
                                <div class="flex items-center justify-end gap-1.5 mt-1">
                                    <span class="font-bold text-[10px] text-gray-500">
                                        Consumo: $${R(s)} · Abonado: <strong class="text-brand-black">$${R(l)}</strong>
                                    </span>
                            ...
                            `:`
                                <span class="text-xs font-bold text-gray-500 uppercase">${n?"Monto Adeudado Pendiente":"Saldo Pendiente"}</span>
                                <p class="font-heading font-black text-2xl sm:text-3xl text-brand-black">
                                    $${R(u)} USD
                                </p>
                                <p class="text-xs font-bold text-gray-600">
                                    Bs. ${R(u*i)} <span class="text-[10px] text-gray-400">(${n?"tasa hoy":"actual"})</span>
                                </p>
                                <div class="flex items-center justify-end gap-1.5 mt-1">
                                    <span class="font-bold text-xs text-gray-600">
                                        Total: $${R(s)} · Abonado: <strong class="text-brand-black">$${R(l)}</strong>
                                    </span>
                                    <button data-editar-abono title="Corregir monto abonado por error" class="text-[10px] font-black uppercase px-2 py-0.5 rounded border border-brand-black bg-amber-200 hover:bg-amber-300 text-brand-black">
                                        Editar
                                    </button>
                    ...
                    <div class="border-t-2 border-brand-black pt-4 grid grid-cols-1 sm:grid-cols-${n?"3":"4"} gap-2 sm:gap-3">
                        ${n?"":`
                        ...
                        <button id="btn-cerrar-cuenta" class="${m>0?"bg-emerald-600 hover:bg-emerald-700":"bg-green-700 hover:bg-green-800"} text-white font-heading font-black text-xs py-3.5 rounded border-2 border-brand-black shadow-brutal active:translate-y-0.5">
                            ${n?"COBRAR Y LIQUIDAR DEUDA (TASA LIBRE)":m>0?`LIQUIDAR (+$${R(m)})`:"LIQUIDAR Y COBRAR"}
                        </button>
                    </div>
                </div>`})():`
            ...
            </div>`;const i=this.modal.querySelector("#modal-tab-activa"),d=this.modal.querySelector("#modal-tab-deuda");i==null||i.addEventListener("click",()=>{o="activa",a()}),d==null||d.addEventListener("click",()=>{o="deuda",a()});const p=this.modal.querySelector("#modal-cta-nombre"),c=this.modal.querySelector("#modal-cta-nota");p&&Ce(p,40),c&&Ce(c,60),setTimeout(()=>p==null?void 0:p.focus(),50);const t=()=>{this.modal.innerHTML=""};(n=this.modal.querySelector("#modal-cta-cancel"))==null||n.addEventListener("click",t),(s=this.modal.querySelector("#modal-cta-ok"))==null||s.addEventListener("click",async()=>{const l=p==null?void 0:p.value.trim().slice(0,40),u=c==null?void 0:c.value.trim().slice(0,60);if(l){const m=await D.abrirCuenta(l,o,u,l);this.cuentaSeleccionada=m,o==="deuda"&&(this.filtroTab="deuda"),t(),this.render()}else this.mostrarToast(r?"Debe ingresar el nombre del cliente o empresa deudora.":"Debe ingresar un identificador válido para la cuenta.","error"),p==null||p.focus()})};a()}async modalAbono(){if(!this.cuentaSeleccionada)return;let e=[];try{e=await D.listarMetodosPago()}catch{e=[{nombre:"PUNTOD.VENTA",moneda:"BS"},{nombre:"BIOPAGO",moneda:"BS"},{nombre:"PAGO MOVIL",moneda:"BS"},{nombre:"TRANSF.BS.",moneda:"BS"},{nombre:"BS.EFEC.",moneda:"BS"},{nombre:"DOL.CASH",moneda:"USD"},{nombre:"ZELLE",moneda:"USD"},{nombre:"BINAN.USDT",moneda:"USD"}]}const o=oe(this.cuentaSeleccionada.totalParcialUsd),a=oe(this.cuentaSeleccionada.abonosUsd),r=Math.max(0,o-a),i=this.modelo.tasaActual||807.39,d=(r*i).toFixed(2),p=this.cuentaSeleccionada.tipo==="deuda";let c=e.find(g=>g.nombre==="BIOPAGO")||e[0]||{nombre:"BIOPAGO",moneda:"BS"},t=c.moneda==="USD"?r:Number(d),n=i,s="";const l=()=>{var j;const g=e.filter(F=>F.moneda==="USD"),y=e.filter(F=>F.moneda==="BS"),h=g.map(F=>`<option value="${F.nombre}" ${F.nombre===c.nombre?"selected":""}>${F.nombre} ($ USD - Tasa Dinámica)</option>`).join(""),f=`
                <optgroup label="MÉTODOS EN BOLÍVARES (Bs.)">
            ...
            `,S=c.moneda==="USD",B=S&&n>0?n:i,A=S?t*B:t,C=i>0?A/i:0,v=a+C,E=v-o,L=E*i;let N="";if(t<=1e-4)N=`
                    <div class="rounded p-2.5 border-2 border-brand-black bg-gray-50 text-xs text-gray-700 font-bold">
                        ...
                        <div class="flex justify-between items-center text-gray-600 border-t border-gray-300 pt-1 mt-1">
                            ...
                            <span class="font-heading font-black text-sm text-brand-black">$${R(r)} USD (Bs. ${R(d)})</span>
                        </div>
                    </div>
                `;else if(E>.001)N=`
                ...
                `;else if(E<-.001){const F=Math.abs(E),M=F*i;N=`
            ...
            <div class="fixed inset-0 bg-black/40 flex items-center justify-center z-[100] p-4">
                <div class="bg-white border-2 border-brand-black rounded-lg shadow-brutal p-6 w-full max-w-md">
                    ...
                    <div class="space-y-3 mb-4">
                        ...
                        <div>
                            ...
                            <p class="text-[11px] text-gray-500 mt-1">Equivalente oficial acreditado: <span class="font-bold text-brand-black">$ ${R(C)} USD</span> (Tasa BCV: ${R(i)})</p>
                        </div>
                        `}
            ...
            </div>`,m()},u=()=>{const g=c.moneda==="USD",y=g&&n>0?n:i,h=g?t*y:t,w=i>0?h/i:0,f=a+w,S=f-o,B=S*i;let A="";if(t<=1e-4)A=`
                    <div class="rounded p-2.5 border-2 border-brand-black bg-gray-50 text-xs text-gray-700 font-bold">
                        <div class="flex justify-between items-center">
                            <span>Aporte de este abono:</span>
                            <span class="font-heading font-black text-sm text-gray-800">$0.00 USD (Bs. 0.00)</span>
                ...
                `;else if(S<-.001){const E=Math.abs(S),L=E*i;A=`
                    <div class="rounded p-2.5 border-2 border-brand-black bg-gray-50 text-xs text-gray-800 font-bold">
                        <div class="flex justify-between items-center mb-1">
                            <span>Nuevo Total Abonado:</span>
        ...
        <div class="fixed inset-0 bg-black/40 flex items-center justify-center z-[100] p-4">
            <div class="bg-white border-2 border-brand-black rounded-lg shadow-brutal p-6 w-full max-w-md">
                ...
                <div class="grid grid-cols-2 gap-3">
        ...
        </div>`;const r=this.modal.querySelector("#tab-edit-usd"),i=this.modal.querySelector("#tab-edit-bs"),d=this.modal.querySelector("#sec-edit-usd"),p=this.modal.querySelector("#sec-edit-bs"),c=this.modal.querySelector("#edit-abono-usd-val"),t=this.modal.querySelector("#edit-abono-bs-val"),n=this.modal.querySelector("#edit-usd-equiv"),s=this.modal.querySelector("#edit-bs-equiv"),l=this.modal.querySelector("#edit-preview-box");let u="usd";const m=()=>{let S=0;u==="usd"?(S=oe(c==null?void 0:c.value),n&&(n.textContent=`Bs. ${(S*a).toFixed(2)}`)):(S=oe(t==null?void 0:t.value)/a,s&&(s.textContent=`$${S.toFixed(2)} USD`)),Number.isFinite(S)||(S=0);const B=S-e;if(l)if(B>.001)l.className="rounded p-2.5 border-2 border-emerald-600 bg-emerald-50 text-xs text-emerald-950 font-bold",l.innerHTML=`
                        <div class="flex justify-between items-center mb-1">
                    ...
                    `};c&&Se(c,5e4,8,m),t&&Se(t,5e7,11,m),m(),(y=this.modal.querySelector("#btn-preset-cero"))==null||y.addEventListener("click",async()=>{const S=oe(u==="usd"?c==null?void 0:c.value:t==null?void 0:t.value);(o>0||S>0)&&!await ue("¿Desea restablecer el saldo abonado a $0.00? Esta acción dejará los pagos registrados en cero.","RESTABLECER ABONO")||(c&&(c.value="0.00"),t&&(t.value="0.00"),m())}),(h=this.modal.querySelector("#btn-preset-exacto"))==null||h.addEventListener("click",()=>{c&&(c.value=e.toFixed(2)),t&&(t.value=(e*a).toFixed(2)),m()}),r==null||r.addEventListener("click",()=>{u="usd",r.className="flex-1 py-1.5 font-heading font-black text-xs rounded bg-brand-black text-white",i.className="flex-1 py-1.5 font-heading font-bold text-xs rounded text-brand-black hover:bg-white",d==null||d.classList.remove("hidden"),p==null||p.classList.add("hidden"),m()}),i==null||i.addEventListener("click",()=>{u="bs",i.className="flex-1 py-1.5 font-heading font-black text-xs rounded bg-brand-black text-white",r.className="flex-1 py-1.5 font-heading font-bold text-xs rounded text-brand-black hover:bg-white",p==null||p.classList.remove("hidden"),d==null||d.classList.add("hidden"),m()});const g=()=>{this.modal.innerHTML=""};(w=this.modal.querySelector("#modal-edit-cancel"))==null||w.addEventListener("click",g),(f=this.modal.querySelector("#modal-edit-ok"))==null||f.addEventListener("click",async()=>{if(!this.cuentaSeleccionada)return;let S=0;if(u==="usd"?S=oe(c==null?void 0:c.value):S=oe(t==null?void 0:t.value)/a,!Number.isFinite(S)||S<0||S>5e4){this.mostrarToast("Monto inválido. Ingrese un valor entre $0.00 y $50,000.00 USD.","error");return}if(Math.abs(S-o)>.009){const C=S===0?`¿Confirmas reiniciar el saldo abonado a $0.00? (Monto previo registrado: $${R(o)})`:`¿Confirmas modificar el saldo abonado de esta cuenta a $${R(S)} USD (Bs. ${R(S*a)})? (Monto previo registrado: $${R(o)})`;if(!await ue(C,"MODIFICAR ABONO"))return}const A=await D.editarAbonoCuenta(this.cuentaSeleccionada.ventaId,S);A&&(this.cuentaSeleccionada=A),g(),this.render()})}async modalCierre(){var A,C,v;if(!this.cuentaSeleccionada)return;const e=this.cuentaSeleccionada.tipo==="deuda",o=oe(this.cuentaSeleccionada.totalParcialUsd),a=oe(this.cuentaSeleccionada.abonosUsd),r=Math.max(0,Math.round((o-a)*100)/100),i=Math.max(0,Math.round((a-o)*100)/100),d=this.modelo.tasaActual||807.39;if(r<=.009){this.modal.innerHTML=`
            <div class="fixed inset-0 bg-black/40 flex items-center justify-center z-[100] p-4">
                <div class="bg-white border-2 border-brand-black rounded-lg shadow-brutal p-6 w-full max-w-md">
                    ...
                    <div class="space-y-2 mb-4">
                        ...
                        <div class="bg-emerald-50 border-2 border-emerald-600 rounded p-4 text-center mt-3">
                            ...
                            <p class="font-bold text-xs text-emerald-800">Bs. ${R(i*d)}</p>
            ...
            </div>`;const E=()=>{this.modal.innerHTML=""};(A=this.modal.querySelector("#modal-liq-cancel"))==null||A.addEventListener("click",E);let L=!1;(C=this.modal.querySelector("#modal-liq-ok"))==null||C.addEventListener("click",async()=>{if(!L&&this.cuentaSeleccionada){L=!0;try{await D.cerrarCuenta(this.cuentaSeleccionada.ventaId,"0.00",d.toFixed(4)),this.cuentaSeleccionada=null,E(),this.render()}catch{L=!1}}});return}let p=[];try{p=await D.listarMetodosPago()}catch{p=[{nombre:"PUNTOD.VENTA",moneda:"BS"},{nombre:"BIOPAGO",moneda:"BS"},{nombre:"PAGO MOVIL",moneda:"BS"},{nombre:"TRANSF.BS.",moneda:"BS"},{nombre:"BS.EFEC.",moneda:"BS"},{nombre:"DOL.CASH",moneda:"USD"},{nombre:"ZELLE",moneda:"USD"},{nombre:"BINAN.USDT",moneda:"USD"}]}let c=d;const t=e?p.find(E=>E.nombre==="TRANSF.BS.")||p[0]||{nombre:"PUNTOD.VENTA",moneda:"BS"}:p.find(E=>E.nombre==="PUNTOD.VENTA")||p[0]||{nombre:"PUNTOD.VENTA",moneda:"BS"},n=this.cuentaSeleccionada.ventaId,s=this.pagosBorradorPorCuenta.get(n);let l;if(s&&s.length>0){if(l=s.map(E=>({...E})),l.length===1&&l[0]){const E=l[0];E.monto=E.moneda==="USD"?r:Number((r*c).toFixed(2)),E.tasaCambio=c}else if(l.length>1){const E=Number((r*c).toFixed(2));let L=0;for(let F=0;F<l.length-1;F++){const M=l[F],K=M.tasaCambio>0?M.tasaCambio:c;L+=M.moneda==="USD"?M.monto*K:M.monto}const N=Math.max(0,Math.round((E-L)*100)/100),j=l[l.length-1];j&&(j.monto=j.moneda==="USD"?c>0?Number((N/c).toFixed(2)):0:N,j.tasaCambio=c)}}else l=[{id:"p-1",metodo:t.nombre,moneda:t.moneda,monto:t.moneda==="USD"?r:Number((r*c).toFixed(2)),tasaCambio:c,referencia:""}];const u=this.resolucionVueltoPorCuenta.get(n);let m=(u==null?void 0:u.estado)||"PAGADO",g=(u==null?void 0:u.metodo)||(e?"TRANSF.BS.":"BS.EFEC."),y=(u==null?void 0:u.tasa)||c;p.some(E=>E.nombre===g)||(g=((v=p[0])==null?void 0:v.nombre)||(e?"TRANSF.BS.":"BS.EFEC."));let h=!1;const w=()=>{let E=0;for(const Z of l)if(Z.moneda==="USD"){const k=Z.tasaCambio>0?Z.tasaCambio:c;E+=Z.monto*k}else E+=Z.monto;E=Math.round(E*100)/100;const L=Math.round(r*c*100)/100,N=c>0?Math.round(E/c*100)/100:0,j=Math.max(0,Math.round((L-E)*100)/100),F=c>0?Math.max(0,Math.round(j/c*100)/100):0,M=Math.max(0,Math.round((E-L)*100)/100),K=c>0?Math.max(0,Math.round(M/c*100)/100):0,P=E>=L-.01&&l.every(Z=>Z.monto>0);return{cubiertoUsd:N,cubiertoBs:E,totalEsperadoBs:L,faltanteUsd:F,faltanteBs:j,vueltoUsd:K,vueltoBs:M,puedeConfirmar:P}},f=E=>{const L=p.find(M=>M.nombre===g),N=(L==null?void 0:L.moneda)==="USD",j=y>0?y:c,F=N&&j>0?Number((E.vueltoBs/j).toFixed(2)):E.vueltoUsd;return E.faltanteBs>.009?`
                ...
                <div class="bg-white border-2 border-brand-black rounded-lg shadow-brutal p-4 sm:p-6 flex flex-col min-h-[300px] max-h-[480px] lg:max-h-[650px]">
                    ...
                    <div class="space-y-2 mb-3">
                        <select id="cat-filtro-lateral" class="w-full border-2 border-brand-black rounded px-2.5 py-1.5 text-xs font-bold bg-white focus:ring-2 focus:ring-brand-cyan">
                            ...
                            ${this.categorias.map(s=>`<option value="${s.id}" ${this.filtroCategoriaCatalogo===s.id?"selected":""}>${s.nombre} (${d[s.id]||0} prods)</option>`).join("")}
                        </select>
        ...
        <div id="inv-seccion-stock" class="${this.tabActiva==="stock"?"block":"hidden"} space-y-4">
            <div class="bg-white border-2 border-brand-black rounded-lg shadow-brutal p-4 sm:p-6">
                ...
                <div class="flex items-center gap-1.5 overflow-x-auto pb-2 mb-3 max-w-full" id="repo-chips-categorias">
                    ...
                    ${this.categorias.map(s=>{const l=d[s.id]||0,u=this.filtroCategoriaRepo===s.id;return`
                        <button data-cat-chip="${s.id}" class="px-3 py-1 rounded text-xs font-heading font-black border-2 border-brand-black shrink-0 transition-colors ${u?"bg-brand-black text-white":"bg-gray-100 text-brand-black hover:bg-gray-200"}">
                            ${s.nombre} (${l})
                        </button>`}).join("")}
                </div>
        ...
        <div id="inv-seccion-ajustes" class="${this.tabActiva==="ajustes"?"block":"hidden"} grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="bg-white border-2 border-brand-black rounded-lg shadow-brutal p-6 space-y-4">
                ...
                <div class="space-y-2 max-h-[350px] overflow-y-auto">
                    ${this.categorias.map(s=>{const l=d[s.id]||0;return`
            ...
            <div class="border border-brand-black rounded p-2 bg-gray-50 flex justify-between items-center text-xs">
                ...
                </div>`,e.insertAdjacentElement("afterend",n),(c=document.getElementById("cat-pag-ant"))==null||c.addEventListener("click",()=>{this.paginaCat>1&&(this.paginaCat--,this.renderCatalogoLista())}),(t=document.getElementById("cat-pag-sig"))==null||t.addEventListener("click",()=>{this.paginaCat<a&&(this.paginaCat++,this.renderCatalogoLista())})}}renderRepoLista(){var c,t,n;const e=document.getElementById("repo-lista");if(!e)return;const o=this.productos.filter(s=>{const l=!this.busquedaRepo||s.nombre.toLowerCase().includes(this.busquedaRepo)||s.sku.toLowerCase().includes(this.busquedaRepo),u=this.filtroCategoriaRepo==="todas"||(s.categoriaId||"cat-general")===this.filtroCategoriaRepo;return l&&u}),a=document.getElementById("repo-contador-estado");if(a){const s=this.filtroCategoriaRepo==="todas"?"en depósito":`en ${this.getNombreCategoria(this.filtroCategoriaRepo)}`;a.textContent=`${o.length} de ${this.productos.length} artículos ${s}`}if(o.length===0){e.innerHTML='<p class="col-span-full py-8 text-center text-gray-500 font-bold">No se encontraron productos en la categoría seleccionada.</p>';return}const r=this.semaforoStock,i=Math.ceil(o.length/this.POR_PAGINA_REPO);this.paginaRepo>i&&(this.paginaRepo=i);const d=(this.paginaRepo-1)*this.POR_PAGINA_REPO,p=o.slice(d,d+this.POR_PAGINA_REPO);if(e.innerHTML=p.map(s=>{var f;const l=Number(s.stock),u=s.sinStock?"text-purple-700":l<=r.rojoMax?"text-red-600":l<=r.amarilloMax?"text-amber-600":"text-emerald-700",m=this.getUnitLabel(s),g=this.getNombreCategoria(s.categoriaId),y=s.sinStock?"Venta libre":s.esCaja&&s.unidadesPorCaja&&s.unidadesPorCaja>1?`${Math.floor(l/s.unidadesPorCaja)} cajas y ${l%s.unidadesPorCaja} un. (${l} un.)`:`${l} ${m}`,w=((f=this.modelo.getConfig())==null?void 0:f.privacidadInventario)&&!this.duenoAutenticado;return`
            <div class="border-2 border-brand-black rounded-lg p-3 bg-white shadow-sm flex flex-col justify-between h-[175px] min-h-[175px] max-h-[175px] box-border overflow-hidden">
                <div class="min-w-0">
                    <div class="flex justify-between items-start gap-1">
                        ...
                        <div class="flex gap-1 shrink-0">
                            <button data-repo-edit="${s.sku}" title="Editar precio y datos del producto" class="w-5 h-5 rounded border border-brand-black text-brand-black hover:bg-brand-black hover:text-white flex items-center justify-center font-black text-[10px] shrink-0">✎</button>
                    ...
                    <p class="text-xs font-bold text-gray-500 mt-0.5">${w?'Stock: <span class="font-black text-gray-400">•••</span>':`Precio: <span class="font-black text-brand-black">$${Number(s.precioUsd).toFixed(2)}</span> · Stock: <span class="font-black ${u}">${y}</span>`}</p>
                </div>
                ...
                <div class="flex items-center gap-1 mt-auto pt-2 border-t border-gray-100">
                    ...
                    `:""}
                    <input type="number" step="${m==="kg"||m==="ml"?"0.1":"1"}" min="${m==="kg"||m==="ml"?"0.01":"1"}" max="9999" maxlength="5" placeholder="Cant." data-repo-cant="${s.sku}" class="w-14 h-8 border-2 border-brand-black rounded px-1.5 py-0.5 font-bold text-xs shrink-0" />
            ...
            </div>`}).join(""),(c=document.getElementById("paginacion-repo"))==null||c.remove(),i>1){const s=document.createElement("div");s.id="paginacion-repo",s.className="col-span-full flex items-center justify-between mt-3 gap-3 flex-wrap",s.innerHTML=`
                ...
                </div>`,e.insertAdjacentElement("afterend",s),(t=document.getElementById("repo-pag-ant"))==null||t.addEventListener("click",()=>{this.paginaRepo>1&&(this.paginaRepo--,this.renderRepoLista())}),(n=document.getElementById("repo-pag-sig"))==null||n.addEventListener("click",()=>{this.paginaRepo<i&&(this.paginaRepo++,this.renderRepoLista())})}e.querySelectorAll("input[data-repo-cant]").forEach(s=>{ge(s,9999,5)}),e.querySelectorAll("[data-repo-edit]").forEach(s=>{s.addEventListener("click",async()=>{var h;const l=s.dataset.repoEdit,u=this.productos.find(w=>w.sku===l);if(!l||!u)return;if(((h=this.modelo.getConfig())==null?void 0:h.privacidadInventario)&&!this.duenoAutenticado){ce("Acción no permitida en modo operador. Solicite al Dueño(a).","error");return}if(!this.duenoAutenticado&&this.modelo.hasPinSet()){const w=await be("Acción protegida. Ingrese el PIN de Administrador(a) / Dueño(a):","","AUTENTICACIÓN DUEÑO(A)");if(!w||!await this.modelo.verificarPin(w)){ce("PIN incorrecto o no suministrado. Acción cancelada.","error");return}}const g=await be(`Ingrese el nuevo precio neto de venta (USD) para "${u.nombre}":`,Number(u.precioUsd).toFixed(2),"ACTUALIZAR PRECIO DE VENTA");if(!g)return;const y=parseFloat(g.replace(",","."));if(isNaN(y)||y<=0){ce("Precio inválido. Debe ser un número mayor a cero.","error");return}try{await D.actualizarProducto({sku:u.sku,nombre:u.nombre,precioUsd:y.toFixed(2),impuestoPct:u.impuestoPct,precioBrutoUsd:u.precioBrutoUsd,margenPct:u.margenPct,categoriaId:u.categoriaId,sinStock:u.sinStock,unidad:u.unidad,esCaja:u.esCaja,unidadesPorCaja:u.unidadesPorCaja,precioPaqueteUsd:u.precioPaqueteUsd,nombrePaquete:u.nombrePaquete,presentaciones:u.presentaciones});const w=await D.productos();this.productos=w,this.renderRepoLista(),this.renderCatalogoLista(),ce(`Precio de "${u.nombre}" actualizado a $${y.toFixed(2)}.`,"success")}catch(w){ce(w instanceof Error?w.message:String(w),"error")}})}),e.querySelectorAll("[data-repo-del]").forEach(s=>{s.addEventListener("click",async()=>{var y;const l=s.dataset.repoDel,u=this.productos.find(h=>h.sku===l);if(!l||!u)return;if(((y=this.modelo.getConfig())==null?void 0:y.privacidadInventario)&&!this.duenoAutenticado){ce("Acción no permitida en modo operador. Solicite al Dueño(a).","error");return}if(!this.duenoAutenticado&&this.modelo.hasPinSet()){const h=await be("Acción protegida. Ingrese el PIN de Administrador(a) / Dueño(a):","","AUTENTICACIÓN DUEÑO(A)");if(!h||!await this.modelo.verificarPin(h)){ce("PIN incorrecto o no suministrado. Acción cancelada.","error");return}}await ue(`¿Seguro que deseas eliminar permanentemente el producto "${u.nombre}" del catálogo?`,"ELIMINAR PRODUCTO")&&D.eliminarProducto(l).then(()=>{D.productos().then(h=>{this.productos=h,this.renderRepoLista(),this.renderCatalogoLista();const w=document.getElementById("repo-contador-estado");w&&(w.textContent=`${this.productos.length} artículos en depósito`)})})})}),e.querySelectorAll("[data-repo-in]").forEach(s=>{s.addEventListener("click",async()=>{var g;const l=s.dataset.repoIn,u=e.querySelector(`input[data-repo-cant="${l}"]`),m=u==null?void 0:u.value;if(l&&m&&Number(m)>0&&Number(m)<=9999){if(((g=this.modelo.getConfig())==null?void 0:g.privacidadInventario)&&!this.duenoAutenticado){ce("Acción no permitida en modo operador. Solicite al Dueño(a).","error");return}if(!this.duenoAutenticado&&this.modelo.hasPinSet()){const B=await be("Acción de inventario protegida. Ingrese el PIN de Administrador(a) / Dueño(a):","","AUTENTICACIÓN DUEÑO(A)");if(!B||!await this.modelo.verificarPin(B)){ce("PIN incorrecto o no suministrado. Operación cancelada.","error");return}}const h=e.querySelector(`select[data-repo-tipo="${l}"]`),w=(h==null?void 0:h.value)||"unidad",f=this.productos.find(B=>B.sku===l);let S=Number(m);w==="caja"&&(f!=null&&f.esCaja)&&(f!=null&&f.unidadesPorCaja)&&f.unidadesPorCaja>1&&(S=S*f.unidadesPorCaja),D.compraStock(l,String(S)).then(()=>{D.productos().then(B=>{this.productos=B,this.renderRepoLista(),this.renderCatalogoLista()})})}})}),e.querySelectorAll("[data-repo-red]").forEach(s=>{s.addEventListener("click",async()=>{var g;const l=s.dataset.repoRed,u=e.querySelector(`input[data-repo-cant="${l}"]`),m=u==null?void 0:u.value;if(l&&m&&Number(m)>0&&Number(m)<=9999){if(((g=this.modelo.getConfig())==null?void 0:g.privacidadInventario)&&!this.duenoAutenticado){ce("Acción no permitida en modo operador. Solicite al Dueño(a).","error");return}if(!this.duenoAutenticado&&this.modelo.hasPinSet()){const B=await be("Acción de inventario protegida. Ingrese el PIN de Administrador(a) / Dueño(a):","","AUTENTICACIÓN DUEÑO(A)");if(!B||!await this.modelo.verificarPin(B)){ce("PIN incorrecto o no suministrado. Operación cancelada.","error");return}}const h=e.querySelector(`select[data-repo-tipo="${l}"]`),w=(h==null?void 0:h.value)||"unidad",f=this.productos.find(B=>B.sku===l);let S=Number(m);w==="caja"&&(f!=null&&f.esCaja)&&(f!=null&&f.unidadesPorCaja)&&f.unidadesPorCaja>1&&(S=S*f.unidadesPorCaja),D.reducirStock(l,String(S)).then(()=>{D.productos().then(B=>{this.productos=B,this.renderRepoLista(),this.renderCatalogoLista()})})}})}),e.querySelectorAll("[data-repo-out]").forEach(s=>{s.addEventListener("click",async()=>{var g;const l=s.dataset.repoOut,u=e.querySelector(`input[data-repo-cant="${l}"]`),m=u==null?void 0:u.value;if(l&&m&&Number(m)>0&&Number(m)<=9999){if(((g=this.modelo.getConfig())==null?void 0:g.privacidadInventario)&&!this.duenoAutenticado){ce("Acción no permitida en modo operador. Solicite al Dueño(a).","error");return}if(!this.duenoAutenticado&&this.modelo.hasPinSet()){const B=await be("Acción de inventario protegida. Ingrese el PIN de Administrador(a) / Dueño(a):","","AUTENTICACIÓN DUEÑO(A)");if(!B||!await this.modelo.verificarPin(B)){ce("PIN incorrecto o no suministrado. Operación cancelada.","error");return}}const h=e.querySelector(`select[data-repo-tipo="${l}"]`),w=(h==null?void 0:h.value)||"unidad",f=this.productos.find(B=>B.sku===l);let S=Number(m);w==="caja"&&(f!=null&&f.esCaja)&&(f!=null&&f.unidadesPorCaja)&&f.unidadesPorCaja>1&&(S=S*f.unidadesPorCaja),D.merma(l,String(S),null).then(()=>{D.productos().then(B=>{this.productos=B,this.renderRepoLista(),this.renderCatalogoLista()})})}})})}async guardarProducto(){var F;const e=document.getElementById("prod-nombre"),o=document.getElementById("prod-categoria"),a=document.getElementById("prod-impuesto"),r=document.getElementById("prod-precio-bruto"),i=document.getElementById("prod-margen"),d=document.getElementById("prod-precio-neto"),p=document.getElementById("prod-stock"),c=((F=document.getElementById("prod-unidad"))==null?void 0:F.value)||"un",t=document.getElementById("prod-sin-stock"),n=document.getElementById("alta-prod-msg"),s=M=>{if(!M)return 0;const K=M.trim().replace(",","."),P=parseFloat(K);return Number.isFinite(P)&&!isNaN(P)?P:0};if(n&&(n.classList.add("hidden"),n.textContent=""),!(e!=null&&e.value.trim())){n&&(n.textContent="El nombre del producto o servicio es obligatorio.",n.style.color="#C60C15",n.classList.remove("hidden"),e==null||e.focus());return}const l=s(d==null?void 0:d.value);if(l<=0||l>99999.99){n&&(n.textContent="El precio neto final debe ser un monto positivo entre $0.01 y $99,999.99 USD.",n.style.color="#C60C15",n.classList.remove("hidden"),d==null||d.focus());return}const u=s(p==null?void 0:p.value),m=(t==null?void 0:t.checked)||!1;if(!m&&(u<0||u>99999)){n&&(n.textContent="El stock inicial debe estar comprendido entre 0 y 99,999 unidades.",n.style.color="#C60C15",n.classList.remove("hidden"),p==null||p.focus());return}if(!m&&c==="un"&&(!Number.isInteger(u)||u%1!==0)){n&&(n.textContent='Los productos vendidos por Unidad (un.) deben tener un stock entero exacto (ej: 10). Para registrar fracciones o decimales, seleccione Tipo de Medida "Por Peso (kg)" o "Por Volumen (ml)".',n.style.color="#C60C15",n.classList.remove("hidden"),p==null||p.focus());return}const g=s((a==null?void 0:a.value)||"0"),y=s((i==null?void 0:i.value)||"30");let h=s(r==null?void 0:r.value);h<=0&&(h=l/(1+g/100)/(1+y/100));const w=document.getElementById("prod-es-caja"),f=document.getElementById("prod-unidades-caja"),S=(w==null?void 0:w.checked)||!1,B=S&&f?Math.max(2,parseInt(f.value,10)||12):void 0,A=document.getElementById("prod-tiene-paquete"),C=document.getElementById("prod-nombre-paquete"),v=document.getElementById("prod-precio-paquete"),E=(A==null?void 0:A.checked)||!1,L=E&&C?C.value.trim():void 0,N=E&&v?s(v.value).toFixed(2):void 0,j=[];document.querySelectorAll('[id^="pres-row-"]').forEach(M=>{const K=M.id.replace("pres-row-",""),P=document.getElementById(`pres-nombre-${K}`),Z=document.getElementById(`pres-precio-${K}`),k=document.getElementById(`pres-unidades-${K}`),$=P==null?void 0:P.value.trim(),U=s(Z==null?void 0:Z.value),H=parseInt((k==null?void 0:k.value)||"1",10);$&&U>0&&Number.isFinite(H)&&H>=1&&j.push({nombre:$,precioUsd:U.toFixed(2),unidades:H})});try{await D.crearProducto({nombre:e.value.trim(),precioBrutoUsd:h.toFixed(2),margenPct:String(y),precioUsd:l.toFixed(2),impuestoPct:String(g),stockInicial:t!=null&&t.checked?"0":String(u),categoriaId:(o==null?void 0:o.value)||"",sinStock:(t==null?void 0:t.checked)||!1,pesable:c==="kg"||c==="ml",unidad:c,alcoholica:!1,esCaja:S,unidadesPorCaja:B,precioPaqueteUsd:N,nombrePaquete:L,presentaciones:j.length>0?j:void 0}),n&&(n.textContent="Producto o servicio registrado exitosamente.",n.style.color="#00823B",n.classList.remove("hidden")),setTimeout(()=>void this.render("alta"),800)}catch(M){n&&(n.textContent=M instanceof Error?M.message:String(M),n.style.color="#C60C15",n.classList.remove("hidden"))}}}const ye=b=>{if(typeof b=="number")return Number.isFinite(b)?b:0;if(b==null)return 0;let e=String(b).trim();if(!e)return 0;e.includes(",")&&!e.includes(".")?e=e.replace(",","."):e.includes(".")&&e.includes(",")&&(e=e.replace(/\./g,"").replace(",","."));const o=parseFloat(e);return Number.isFinite(o)&&!isNaN(o)?o:0},te=b=>ye(b).toLocaleString("es-VE",{minimumFractionDigits:2,maximumFractionDigits:2}),Ve=b=>{const e=b.finUnix||Math.floor(Date.now()/1e3),o=Math.max(0,e-b.inicioUnix),a=Math.floor(o/3600),r=Math.floor(o%3600/60);return`${a}h ${r}m`},ht=(b,e)=>{const o=b.operadoresRelevo.length>0?b.operadoresRelevo.join(" / "):b.operadorActual,a=e.filter(s=>{const l=s.fechaUnix&&s.fechaUnix>0?s.fechaUnix:(()=>{const u=(s.fechaHora||"").match(/(\d{4})-(\d{2})-(\d{2})[T\s](\d{2}):(\d{2}):(\d{2})/);if(u&&u[1]&&u[2]&&u[3]&&u[4]&&u[5]&&u[6]){const m=Date.UTC(parseInt(u[1],10),parseInt(u[2],10)-1,parseInt(u[3],10),parseInt(u[4],10),parseInt(u[5],10),parseInt(u[6],10));if(!isNaN(m))return Math.floor(m/1e3)}return 0})();return!(l<=0||l<b.inicioUnix||b.finUnix&&l>b.finUnix)}),r=[["INFORME DE JORNADA",b.id],["Estado",b.estado==="abierta"?"En curso":"Cerrada"],["Apertura",b.inicioStr],["Cierre",b.finStr||"-"],["Duracion",Ve(b)],["Operadores",o],["Total USD",`$${te(b.ventasTotalUsd)}`],["Total Bs",`Bs. ${te(b.ventasTotalBs)}`],["Tickets emitidos",String(b.ticketsEmitidos)],["Vuelto pagado Bs",`Bs. ${te(b.vueltoPagadoBs)}`],["Vuelto retenido Bs",`Bs. ${te(b.vueltoRetenidoBs)}`],["Deudas liquidadas USD",`$${te(b.deudasLiquidadasUsd)}`],["Entradas stock",String(b.entradasStockReg)],["Mermas",String(b.mermasStockReg)],["Cambios de precio",String(b.cambiosPrecioReg)],["Tasa apertura",`Bs. ${b.tasaInicio}`],["Tasa cierre",b.tasaFin?`Bs. ${b.tasaFin}`:"-"],...b.checksumSha256?[["SHA-256",b.checksumSha256]]:[],[],["TICKETS DE LA JORNADA"],["ID Ticket","Fecha/Hora","Canal","Operador","Metodo(s) de Pago","Total USD","Total Bs"]],i=a.map(s=>{const l=s.pagos&&s.pagos.length>0?s.pagos.map(u=>`${u.metodo}:$${te(u.montoUsd)}`).join(" | "):"DIRECTO";return[s.ventaId,s.fechaUnix&&s.fechaUnix>0?he(s.fechaUnix):s.fechaHora||"",s.canal||"VENTA DIRECTA",s.operador||"Principal",l,`$${te(s.totalUsd)}`,`Bs. ${te(s.totalBs)}`]}),p=[...r,...i].map(s=>s.map(l=>`"${String(l).replace(/"/g,'""')}"`).join(",")).join(`\r
`),c=new Blob(["\uFEFF"+p],{type:"text/csv;charset=utf-8;"}),t=URL.createObjectURL(c),n=document.createElement("a");n.href=t,n.download=`jornada_${b.id}.csv`,document.body.appendChild(n),n.click(),document.body.removeChild(n),URL.revokeObjectURL(t)};class vt{constructor(e,o,a){T(this,"contenedor");T(this,"modalRoot");T(this,"modelo");T(this,"jornadas",[]);T(this,"jornadaActual",null);T(this,"todosLosTickets",[]);T(this,"busqueda","");T(this,"expandidos",new Set);T(this,"paginaActual",1);T(this,"POR_PAGINA",20);this.contenedor=e,this.modalRoot=o,this.modelo=a}parseFechaUnix(e){if(!e)return 0;const o=e.match(/(\d{4})-(\d{2})-(\d{2})[T\s](\d{2}):(\d{2}):(\d{2})/);if(o&&o[1]&&o[2]&&o[3]&&o[4]&&o[5]&&o[6]){const a=Date.UTC(parseInt(o[1],10),parseInt(o[2],10)-1,parseInt(o[3],10),parseInt(o[4],10),parseInt(o[5],10),parseInt(o[6],10));if(!isNaN(a))return Math.floor(a/1e3)}return 0}async render(){const[e,o,a]=await Promise.all([D.obtenerJornadaActual(),D.listarHistoricoJornadas(),D.ventas()]);this.jornadaActual=e,this.jornadas=o,this.todosLosTickets=a;const r=e?o.filter(t=>t.id!==e.id):o,i=[...e?[e]:[],...r],d=i.length,p=i.reduce((t,n)=>t+ye(n.ventasTotalUsd),0),c=i.reduce((t,n)=>t+n.ticketsEmitidos,0);this.contenedor.innerHTML=`
        <div class="mb-4 sm:mb-6 flex flex-wrap items-center justify-between gap-3">
            <div>
        ...
        <!-- Lista -->
        <div id="lista-jornadas" class="flex flex-col gap-2"></div>`,this.conectarEventosBuscador(),this.renderLista()}conectarEventosBuscador(){var e;(e=document.getElementById("jornadas-buscar"))==null||e.addEventListener("input",o=>{this.busqueda=o.target.value,this.paginaActual=1,this.renderLista()})}renderLista(){var s,l;const e=document.getElementById("lista-jornadas");if(!e)return;const o=this.jornadaActual?this.jornadas.filter(u=>{var m;return u.id!==((m=this.jornadaActual)==null?void 0:m.id)}):this.jornadas,a=[...this.jornadaActual?[this.jornadaActual]:[],...o],r=this.busqueda.trim().toLowerCase(),i=r?a.filter(u=>u.id.toLowerCase().includes(r)||u.operadorActual.toLowerCase().includes(r)||u.operadoresRelevo.some(m=>m.toLowerCase().includes(r))||u.inicioStr.toLowerCase().includes(r)||(u.finStr||"").toLowerCase().includes(r)):a,d=document.getElementById("paginacion-jornadas");if(d&&d.remove(),i.length===0){e.innerHTML=`
            ...
            </div>`;return}const p=Math.max(1,Math.ceil(i.length/this.POR_PAGINA));this.paginaActual>p&&(this.paginaActual=p),this.paginaActual<1&&(this.paginaActual=1);const c=this.paginaActual,t=i.slice((c-1)*this.POR_PAGINA,c*this.POR_PAGINA);e.innerHTML=t.map(u=>this.renderFila(u)).join(""),t.forEach(u=>{if(this.expandidos.has(u.id)){const m=document.getElementById(`detalle-${u.id}`);m==null||m.classList.remove("hidden");const g=document.getElementById(`icon-${u.id}`);g&&(g.textContent="▲")}}),e.querySelectorAll("[data-toggle-jornada]").forEach(u=>{u.addEventListener("click",()=>{const m=u.dataset.toggleJornada,g=document.getElementById(`detalle-${m}`),y=document.getElementById(`icon-${m}`);if(g){const h=g.classList.contains("hidden");g.classList.toggle("hidden",!h),y&&(y.textContent=h?"▲":"▼"),h?this.expandidos.add(m):this.expandidos.delete(m)}})}),e.querySelectorAll("[data-exportar-jornada]").forEach(u=>{u.addEventListener("click",m=>{m.stopPropagation();const g=u.dataset.exportarJornada,y=i.find(h=>h.id===g);y&&ht(y,this.todosLosTickets)})}),e.querySelectorAll("[data-ver-ticket]").forEach(u=>{u.addEventListener("click",()=>{const m=u.dataset.verTicket,g=this.todosLosTickets.find(y=>y.ventaId===m);g&&this.mostrarModalTicket(g)})});const n=document.createElement("div");n.id="paginacion-jornadas",n.innerHTML=`
            <div class="flex items-center justify-between mt-3 gap-3 flex-wrap">
                <span class="text-xs font-bold text-gray-600">
                    Pagina ${c} de ${p} &middot; ${i.length} jornada${i.length!==1?"s":""}
                </span>
                <div class="flex gap-2">
            ...
            </div>`,e.insertAdjacentElement("afterend",n),(s=document.getElementById("btn-pag-ant"))==null||s.addEventListener("click",()=>{this.paginaActual>1&&(this.paginaActual--,this.renderLista())}),(l=document.getElementById("btn-pag-sig"))==null||l.addEventListener("click",()=>{this.paginaActual<p&&(this.paginaActual++,this.renderLista())})}renderFila(e){const o=e.estado==="abierta",a=e.operadoresRelevo.length>0?e.operadoresRelevo.join(", "):e.operadorActual,r=this.todosLosTickets.filter(c=>{const t=c.fechaUnix&&c.fechaUnix>0?c.fechaUnix:this.parseFechaUnix(c.fechaHora);return!(t<=0||t<e.inicioUnix||e.finUnix&&t>e.finUnix)}),i={};r.forEach(c=>{(c.pagos||[]).forEach(t=>{i[t.metodo]||(i[t.metodo]={usd:0,bs:0}),i[t.metodo].usd+=ye(t.montoUsd),i[t.metodo].bs+=ye(t.montoBs)})});const d=Object.entries(i).map(([c,t])=>`
            ...
            </div>`).join(""),p=r.length>0?r.map(c=>{const n=c.canal==="CONSUMO EN CUENTA"||c.ventaId.startsWith("CTA-")?'<span class="bg-amber-100 text-amber-900 border border-brand-black px-1.5 py-0.5 rounded font-black text-[9px]">CUENTA</span>':'<span class="bg-blue-100 text-blue-900 border border-brand-black px-1.5 py-0.5 rounded font-black text-[9px]">VENTA</span>';let s="";return c.pagos&&c.pagos.length>1?s='<span class="bg-amber-50 text-amber-950 border border-amber-500 px-1.5 py-0.5 rounded font-black text-[9px]">MIXTO</span>':c.pagos&&c.pagos.length===1?s=`<span class="bg-gray-100 text-brand-black border border-brand-black px-1.5 py-0.5 rounded font-black text-[9px]">${c.pagos[0].metodo}</span>`:s='<span class="bg-gray-100 text-gray-500 border border-gray-300 px-1.5 py-0.5 rounded font-mono text-[9px]">DIRECTO</span>',`
                <tr class="hover:bg-gray-50 transition-colors">
        ...
        </div>`}mostrarModalTicket(e){var i,d;const o=e.tasaDelDia?`Bs. ${te(e.tasaDelDia)}`:`Bs. ${te(this.modelo.tasaActual||807.39)}`,a=e.lineas&&e.lineas.length>0?e.lineas.map(p=>`
                <tr class="border-b border-gray-100 last:border-none">
                    <td class="py-2 pr-2">
        ...
        </div>`;const r=()=>{this.modalRoot.innerHTML=""};(i=document.getElementById("modal-ticket-cerrar"))==null||i.addEventListener("click",r),(d=document.getElementById("modal-ticket-ok"))==null||d.addEventListener("click",r)}}class kt{constructor(e){T(this,"contenedor");this.contenedor=e}render(){this.contenedor.innerHTML=`
        ...
        </div>`;const o=()=>{this.modalRoot.innerHTML=""};(r=document.getElementById("pin-inv-cancelar"))==null||r.addEventListener("click",o);const a=()=>void(async()=>{var n;const c=document.getElementById("pin-inv-input").value;await D.validarPin(c).catch(()=>!1)?(o(),await this.abrirInventario(!0)):(n=document.getElementById("pin-inv-error"))==null||n.classList.remove("hidden")})();(i=document.getElementById("pin-inv-ok"))==null||i.addEventListener("click",a),(d=document.getElementById("pin-inv-sin-clave"))==null||d.addEventListener("click",()=>{o(),this.abrirInventario(!1)}),(p=document.getElementById("pin-inv-input"))==null||p.addEventListener("keydown",c=>{c.key==="Enter"&&a()})}async abrirInventario(e=!0){this.marcarActivo("inventario");const o=new ft(this.root,this.modelo,e);try{await o.render()}catch(a){this.toastError(a instanceof Error?a.message:String(a))}}marcarActivo(e){document.querySelectorAll("[data-nav-btn]").forEach(o=>{o.dataset.navBtn===e?(o.classList.remove("bg-white"),o.classList.add("bg-brand-yellow")):(o.classList.remove("bg-brand-yellow","bg-brand-cyan"),o.classList.add("bg-white"))})}solicitarAccesoPanel(){var r,i,d;const e=this.modelo.getConfig();if(!(e!=null&&e.tienePin)){this.abrirPanel();return}this.modalRoot.innerHTML=`
        <div class="fixed inset-0 bg-black/40 flex items-center justify-center z-[100] p-4">
            <div class="bg-white border-2 border-brand-black rounded-lg shadow-brutal p-8 w-full max-w-sm">
