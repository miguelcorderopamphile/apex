...
Esta tasa afectará todos los nuevos cobros y tickets a partir de este momento.`)){const p=await F("fijar_tasa_manual",{tasa:d.toFixed(2)});p&&this.pintar(p),n()}})}async actualizar(){const e=await this.obtenerTasa("obtener_tasa_bcv");e&&this.pintar(e)}async forzar(){const e=document.getElementById("bcv-refresh");e&&e.classList.add("animate-spin");const o=await this.obtenerTasa("forzar_actualizacion_tasa");e&&e.classList.remove("animate-spin"),o&&this.pintar(o)}async obtenerTasa(e){try{return await F(e)}catch{return null}}pintar(e){const o=document.getElementById("bcv-valor"),a=document.getElementById("bcv-fluctuacion");if(!o||!a)return;const n=Number(e.valor);o.textContent=Number.isFinite(n)&&n>0?n.toLocaleString("es-VE",{minimumFractionDigits:2,maximumFractionDigits:2}):"--",Number.isFinite(n)&&n>0&&window.dispatchEvent(new CustomEvent("tasa_actualizada",{detail:n}));const c=Number(e.fluctuacionPct);if(e.direccion&&Number.isFinite(c)){const i=e.direccion==="subio"?Fe:e.direccion==="bajo"?Ve:Ge,b=c>0?"+":"";a.textContent=`${b}${c.toFixed(2)}%`,a.style.color=i}else a.textContent=""}}class Je{constructor(){C(this,"config",null);C(this,"rol","caja");C(this,"tasa",0);C(this,"oyentes",[])}suscribir(e){this.oyentes.push(e)}notificar(){this.oyentes.forEach(e=>e())}async cargarConfig(){return this.config=await D.config(),this.config}getConfig(){return this.config}async inicializar(e,o,a,n,c){await D.inicializar(e,o,a,n,c),await this.cargarConfig(),this.notificar()}get rubroAbasto(){var e,o;return(((e=this.config)==null?void 0:e.rubros)??0&ve)!==0||(((o=this.config)==null?void 0:o.rubros)??0)===ve}tieneRubro(e){var o;return((((o=this.config)==null?void 0:o.rubros)??0)&e)!==0}tieneCapacidad(e){var o;return((((o=this.config)==null?void 0:o.capacidades)??0)&e)!==0}setRol(e){this.rol=e,this.notificar()}get rolActual(){return this.rol}setTasa(e){this.tasa=e,this.notificar()}get tasaActual(){return this.tasa}bs(e){return(Number(e)*this.tasa).toLocaleString("es-VE",{minimumFractionDigits:2,maximumFractionDigits:2})}hasPinSet(){var e;return!!((e=this.config)!=null&&e.tienePin)}async verificarPin(e){return D.validarPin(e)}}function Ke(u,e){const o=u.replace(/[^a-zA-Z0-9]/g,"");if(o.length!==16)return!1;const a=o.split("").map(b=>parseInt(b,10)).filter(b=>!isNaN(b)&&b<10);if(a.length!==16)return!1;let n=0;for(let b=0;b<12;b++)n+=a[b]*(b+1);const c=n%1e4,i=a[12]*1e3+a[13]*100+a[14]*10+a[15];return c===i}class We{constructor(e,o,a){C(this,"contenedor");C(this,"modelo");C(this,"alTerminar");C(this,"modo","nuevo");C(this,"bloquearPanel",!0);this.contenedor=e,this.modelo=o,this.alTerminar=a}render(){this.contenedor.innerHTML=`
                ...
                <div id="wz-sec-nuevo" class="${this.modo==="nuevo"?"block":"hidden"} space-y-5">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
                            ...
                            ${this.tarjetaRubro("wz-licoreria","Licorería","Cuentas y consumo",Ce,"bg-brand-pink")}
        ...
        <div class="fixed inset-0 bg-black/40 flex items-center justify-center z-[100] p-4">
            ...
            `,"max-w-md"),(n=this.modal.querySelector("[data-cerrar]"))==null||n.addEventListener("click",()=>this.cerrarModal()),(c=this.modal.querySelector("#btn-cancelar-inicio-jornada"))==null||c.addEventListener("click",()=>this.cerrarModal()),(i=this.modal.querySelector("#form-nuevo-cajero-inicio"))==null||i.addEventListener("submit",async t=>{t.preventDefault();const r=this.modal.querySelector("#in-nuevo-cajero-inicio"),s=(r==null?void 0:r.value.trim())||"";s&&(await D.crearOperador(s),this.cerrarModal(),this.abrirModalIniciarJornada())}),(b=this.modal.querySelector("#btn-abrir-turno"))==null||b.addEventListener("click",async()=>{const t=this.modal.querySelectorAll("input[data-inicio-cajero-chk]:checked"),r=[];if(t.forEach(d=>{d.value&&r.push(d.value)}),r.length===0){this.mostrarToast("Selecciona al menos un operador para abrir el turno.","error");return}const s=r[0];await D.abrirJornada(s,r),this.cerrarModal(),this.renderDinamico()})})()}async abrirModalCobro(){var x,h,g,y;if(this.vm.lineasCarrito.length===0)return;let e=[];try{e=await D.listarMetodosPago()}catch{e=[{nombre:"PUNTOD.VENTA",moneda:"BS"},{nombre:"BIOPAGO",moneda:"BS"},{nombre:"PAGO MOVIL",moneda:"BS"},{nombre:"TRANSF.BS.",moneda:"BS"},{nombre:"BS.EFEC.",moneda:"BS"},{nombre:"DOL.CASH",moneda:"USD"},{nombre:"ZELLE",moneda:"USD"},{nombre:"BINAN.USDT",moneda:"USD"}]}const o=Number(this.vm.totalUsd.toFixed(2)),a=this.vm.tasaTicket,n=Number((o*a).toFixed(2)),c=e.find(E=>E.nombre==="BIOPAGO")||e.find(E=>E.moneda==="BS")||e[0]||{nombre:"BIOPAGO",moneda:"BS"};let i;if(this.pagosBorrador&&this.pagosBorrador.length>0){if(i=this.pagosBorrador.map(E=>({...E})),i.length===1&&i[0]){const E=i[0];E.monto=E.moneda==="USD"?o:n,E.tasaCambio=a}else if(i.length>1){let E=0;for(let _=0;_<i.length-1;_++){const f=i[_],v=f.tasaCambio>0?f.tasaCambio:a;E+=f.moneda==="USD"?f.monto*v:f.monto}const I=Math.max(0,Math.round((n-E)*100)/100),L=i[i.length-1];L&&(L.monto=L.moneda==="USD"?a>0?Number((I/a).toFixed(2)):0:I,L.tasaCambio=a)}}else i=[{id:"p-1",metodo:c.nombre,moneda:c.moneda,monto:c.moneda==="USD"?o:n,tasaCambio:a,referencia:""}];let b=((x=this.resolucionVueltoBorrador)==null?void 0:x.estado)||"PAGADO",t=((h=this.resolucionVueltoBorrador)==null?void 0:h.metodo)||"BS.EFEC.",r=((g=this.resolucionVueltoBorrador)==null?void 0:g.tasa)||a;e.some(E=>E.nombre===t)||(t=((y=e[0])==null?void 0:y.nombre)||"BS.EFEC.");let s=!1;const d=()=>{let E=0;for(const P of i)if(P.moneda==="USD"){const T=P.tasaCambio>0?P.tasaCambio:a;E+=P.monto*T}else E+=P.monto;E=Math.round(E*100)/100;const I=a>0?Math.round(E/a*100)/100:0,L=Math.max(0,Math.round((n-E)*100)/100),_=a>0?Math.max(0,Math.round(L/a*100)/100):0,f=Math.max(0,Math.round((E-n)*100)/100),v=a>0?Math.max(0,Math.round(f/a*100)/100):0,k=E>=n-.01&&i.every(P=>P.monto>0);return{cubiertoUsd:I,cubiertoBs:E,faltanteUsd:_,faltanteBs:L,vueltoUsd:v,vueltoBs:f,puedeConfirmar:k}},l=()=>{const E=d(),I=e.filter(A=>A.moneda==="USD"),L=e.filter(A=>A.moneda==="BS"),_=i.map((A,G)=>{const q=I.map(w=>`<option value="${w.nombre}" ${w.nombre===A.metodo?"selected":""}>${w.nombre} ($ - Tasa Dinámica)</option>`).join(""),B=`
                        <optgroup label="MÉTODOS EN BOLÍVARES (Bs.)">
                            ${L.map(w=>`<option value="${w.nombre}" ${w.nombre===A.metodo?"selected":""}>${w.nombre} (Bs.)</option>`).join("")}
                        </optgroup>
                    ...
                    <div class="border-2 border-brand-black rounded-lg p-3 bg-gray-50 mb-2.5">
                        ...
                        `}
                    </div>`}).join(""),f=e.find(A=>A.nombre===t),v=(f==null?void 0:f.moneda)==="USD",k=r>0?r:a,P=v&&k>0?Number((E.vueltoBs/k).toFixed(2)):E.vueltoUsd,T=E.faltanteBs>.009?`
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
            ...
            <div class="bg-white border-2 border-brand-black rounded-lg shadow-brutal p-4 sm:p-6 flex flex-col justify-between">
                ...
                `).join(""),j.querySelectorAll("button[data-metodo-del]").forEach($=>{$.addEventListener("click",async()=>{const V=$.dataset.metodoDel||"";window.confirm(`¿Confirmas eliminar el método de pago "${V}"?`)&&(await D.eliminarMetodoPago(V),l())})})}const w=document.getElementById("in-semaforo-rojo"),M=document.getElementById("in-semaforo-amarillo");w&&!w.dataset.modificado&&(w.value=String(k.rojoMax)),M&&!M.dataset.modificado&&(M.value=String(k.amarilloMax))};l(),(g=document.getElementById("btn-relevar-operador"))==null||g.addEventListener("click",async()=>{var G,q,z;const f=(await D.listarOperadores()).filter(B=>B.activo);if(f.length===0){this.mostrarToast("No hay operadores activos disponibles. Registre uno a continuación.","error");return}const v=await D.obtenerJornadaActual(),k=(v==null?void 0:v.operadoresActivos)||[(v==null?void 0:v.operadorActual)||""],P=document.getElementById("modal-root")||document.body,T=document.createElement("div");T.id="modal-asignar-operadores",T.innerHTML=`
                <div class="fixed inset-0 bg-black/40 flex items-center justify-center z-[100] p-4">
                    <div class="bg-white border-2 border-brand-black rounded-lg shadow-brutal p-6 w-full max-w-md max-h-[90vh] overflow-y-auto">
                        ...
                        <div class="space-y-2 max-h-56 overflow-y-auto pr-1 mb-4">
                            ${f.map(B=>{const N=k.some(S=>S.toLowerCase()===B.nombre.toLowerCase());return`
                ...
                </div>`,P.appendChild(T);const A=()=>T.remove();(G=T.querySelector("#modal-asig-close"))==null||G.addEventListener("click",A),(q=T.querySelector("#modal-asig-cancelar"))==null||q.addEventListener("click",A),(z=T.querySelector("#modal-asig-guardar"))==null||z.addEventListener("click",async()=>{const B=T.querySelectorAll("input[data-asig-chk]:checked"),N=[];if(B.forEach(S=>{S.dataset.asigChk&&N.push(S.dataset.asigChk)}),N.length===0){this.mostrarToast("Selecciona al menos un operador para el turno.","error");return}await D.asignarOperadoresTurno(N),A(),l()})}),(y=document.getElementById("form-crear-metodo-panel"))==null||y.addEventListener("submit",async f=>{f.preventDefault();const v=document.getElementById("in-nuevo-metodo-nombre"),k=document.getElementById("select-nuevo-metodo-moneda"),P=(v==null?void 0:v.value.trim())||"",T=(k==null?void 0:k.value)==="USD"?"USD":"BS";P&&(await D.crearMetodoPago(P,T),v&&(v.value=""),l())}),(E=document.getElementById("form-crear-operador"))==null||E.addEventListener("submit",async f=>{f.preventDefault();const v=document.getElementById("in-nuevo-operador"),k=(v==null?void 0:v.value.trim())||"";k&&(await D.crearOperador(k),v&&(v.value=""),l())}),(I=document.getElementById("form-semaforo-stock"))==null||I.addEventListener("submit",async f=>{f.preventDefault();const v=document.getElementById("in-semaforo-rojo"),k=document.getElementById("in-semaforo-amarillo"),P=document.getElementById("msg-semaforo-stock"),T=parseInt((v==null?void 0:v.value)||"5",10),A=parseInt((k==null?void 0:k.value)||"15",10);if(T>=A){this.mostrarToast("El umbral rojo debe ser estrictamente menor que el umbral amarillo.","error");return}await D.guardarSemaforoStock(T,A),P&&(P.textContent="Umbrales del semáforo guardados y aplicados a todo el sistema.",P.classList.remove("hidden"),setTimeout(()=>P.classList.add("hidden"),2500))}),(L=document.getElementById("btn-reset-semaforo"))==null||L.addEventListener("click",async()=>{await D.guardarSemaforoStock(5,15),l()}),(_=document.getElementById("form-cambiar-clave"))==null||_.addEventListener("submit",async f=>{f.preventDefault();const v=document.getElementById("pin-actual"),k=document.getElementById("pin-nuevo"),P=document.getElementById("msg-cambio-clave");if(P)try{await D.cambiarPinDueno((v==null?void 0:v.value.trim())||"",(k==null?void 0:k.value.trim())||""),await this.modelo.cargarConfig(),P.textContent=k!=null&&k.value.trim()?"Clave actualizada exitosamente. El panel requerirá esta nueva clave para ingresar.":"Clave eliminada. El panel ha quedado en modo abierto sin clave.",P.style.color="#00823B",P.classList.remove("hidden"),setTimeout(()=>void this.render(),1200)}catch(T){P.textContent=T instanceof Error?T.message:String(T),P.style.color="#C60C15",P.classList.remove("hidden")}})}aplicarFiltroFechas(e){const o=document.getElementById("filtro-fecha-desde"),a=document.getElementById("filtro-fecha-hasta"),n=document.getElementById("label-estado-fechas"),c=document.getElementById("tabla-transacciones-body"),i=document.getElementById("conteo-transacciones-badge"),b=(o==null?void 0:o.value.trim())||"",t=(a==null?void 0:a.value.trim())||"";if(!b&&!t){n&&(n.textContent="Selecciona una fecha Desde o Hasta para iniciar el diagnóstico.",n.classList.remove("hidden"));return}let r=0,s=Number.MAX_SAFE_INTEGER;if(b){const[w,M,J]=b.split("-").map(Number);r=Math.floor(new Date(w,M-1,J,0,0,0,0).getTime()/1e3)}if(t){const[w,M,J]=t.split("-").map(Number);s=Math.floor(new Date(w,M-1,J,23,59,59,999).getTime()/1e3)}if(r>s){n&&(n.textContent='Rango inválido: la fecha "Desde" es posterior a la fecha "Hasta".',n.classList.remove("hidden"));return}const d=this.transacciones.filter(w=>{const M=this.obtenerTimestampTicket(w);return M>=r&&M<=s}),l=d.reduce((w,M)=>w+ee(M.totalUsd),0),p=d.reduce((w,M)=>w+ee(M.totalBs),0),x=d.length;let h=0;d.forEach(w=>{(w.lineas||[]).forEach(M=>{const J=this.productos.find(te=>te.sku===M.sku);J&&(h+=ee(J.precioBrutoUsd)*ee(M.cantidad))})});const g=Math.max(0,l-h),y=g*.95,E=y*(this.modelo.tasaActual||807.39),I=x>0?(l/x).toFixed(2):"0.00",L=document.getElementById("kpi-ventas-usd"),_=document.getElementById("kpi-ventas-bs"),f=document.getElementById("kpi-tickets"),v=document.getElementById("kpi-gan-bruta"),k=document.getElementById("kpi-gan-neta"),P=document.getElementById("kpi-gan-neta-bs"),T=document.getElementById("kpi-ticket-prom");L&&(L.textContent="$ "+W(l)),_&&(_.textContent="Bs. "+se(p),_.title="Bs. "+W(p)),f&&(f.textContent=String(x)),v&&(v.textContent="$ "+W(g)),k&&(k.textContent="$ "+W(y)),P&&(P.textContent="Bs. "+se(E),P.title="Bs. "+W(E)),T&&(T.textContent="$ "+I),c&&(c.innerHTML=this.renderFilasTransacciones(d)),i&&(i.textContent=`${d.length} transacciones en rango`),this.contenedor.querySelectorAll("[data-rango]").forEach(w=>{w.className="w-12 sm:w-14 h-8 flex items-center justify-center font-heading font-bold text-xs rounded text-brand-black hover:bg-gray-100 transition-colors shrink-0"});const G={};d.forEach(w=>{(w.lineas||[]).forEach(M=>{G[M.nombre]||(G[M.nombre]={nombre:M.nombre,cantidad:0,totalUsd:0}),G[M.nombre].cantidad+=Number(M.cantidad)||0,G[M.nombre].totalUsd+=ee(M.subtotalUsd)||Number(M.cantidad)*ee(M.precioUsd)})});const q=Object.values(G).reduce((w,M)=>w+M.totalUsd,0)||1,z=Object.values(G).sort((w,M)=>M.totalUsd-w.totalUsd).map(w=>({nombre:w.nombre,cantidad:String(w.cantidad),totalUsd:w.totalUsd.toFixed(2),porcentaje:(w.totalUsd/q*100).toFixed(1)})),B={...e,ventas24hUsd:l.toFixed(2),ventas24hBs:p.toFixed(2),gananciaBrutaUsd:g.toFixed(2),gananciaNetaUsd:y.toFixed(2),tickets24h:x,topProductos:z.length>0?z:d.length===0?[]:e.topProductos};this.vm.setDatos(B),this.pintarGrafico(B);const N=w=>w.toLocaleString("es-VE",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}),S=b?new Date(r*1e3):new Date(2020,0,1),j=t?new Date(s*1e3):new Date;if(this.rangoDetalleFechas=`Del ${N(S)} al ${N(j)}`,n){const w=b||"Inicio",M=t||"Actualidad";n.textContent=`Diagnóstico activo (${w} al ${M}): ${d.length} transacciones registradas`,n.classList.remove("hidden")}}aplicarRango(e,o){const a=new Date,n=v=>v.toLocaleString("es-VE",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"});let c=864e5;e==="7d"?c=7*864e5:e==="30d"?c=30*864e5:e==="1a"?c=365*864e5:e==="todo"&&(c=5*365*864e5);const i=new Date(a.getTime()-c);this.rangoDetalleFechas=`Del ${n(i)} al ${n(a)}`;const b=Math.floor(i.getTime()/1e3),t=this.transacciones.filter(v=>this.obtenerTimestampTicket(v)>=b),r=this.modelo.tasaActual||807.39;let s=0,d=0;t.forEach(v=>{s+=ee(v.totalUsd),d+=ee(v.totalBs)});const l=t.length,p=document.getElementById("kpi-ventas-usd"),x=document.getElementById("kpi-ventas-bs"),h=document.getElementById("kpi-tickets"),g=document.getElementById("kpi-gan-bruta"),y=document.getElementById("kpi-gan-neta"),E=document.getElementById("kpi-gan-neta-bs"),I=document.getElementById("kpi-ticket-prom");if(p&&(p.textContent="$ "+W(s)),x&&(x.textContent="Bs. "+se(d),x.title="Bs. "+W(d)),h&&(h.textContent=String(l)),g&&(g.textContent="$ "+W(s*this.margenBrutoPct/100)),y&&(y.textContent="$ "+W(s*this.margenNetoPct/100)),E){const v=s*this.margenNetoPct/100*r;E.textContent="Bs. "+se(v),E.title="Bs. "+W(v)}I&&(I.textContent="$ "+(l>0?(s/l).toFixed(2):"0.00"));const L=new Map;t.forEach(v=>{var k;(k=v.lineas)==null||k.forEach(P=>{const T=L.get(P.sku);T?(T.cantidad+=ee(P.cantidad),T.totalUsd+=ee(P.subtotalUsd)):L.set(P.sku,{nombre:P.nombre,cantidad:ee(P.cantidad),totalUsd:ee(P.subtotalUsd)})})});const _=Array.from(L.values()).sort((v,k)=>k.totalUsd-v.totalUsd).slice(0,10).map(v=>({nombre:v.nombre,cantidad:String(Math.round(v.cantidad)),totalUsd:v.totalUsd>0?String(v.totalUsd.toFixed(2)):void 0,porcentaje:s>0?(v.totalUsd/s*100).toFixed(1):"0.0"})),f={...o,topProductos:_};this.vm.setDatos(f),this.pintarGrafico(f)}kpi(e,o,a,n,c=""){return`
        <div class="border-2 border-brand-black rounded-lg shadow-brutal-sm p-4 ${n} flex flex-col justify-between min-w-0 overflow-hidden" title="${c}">
            ...
            ${c?`<div class="text-[10px] text-gray-500 font-bold truncate mt-0.5 border-t border-gray-200/60 pt-1">${c}</div>`:""}
                ...
                `,t+=E});const p=b.map((h,g)=>{const y=a[g%a.length],E=n?`${h.valor} un.`:`$ ${W(h.valor)}`;return`
                <tr class="border-b border-gray-100 last:border-none">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 items-start">
                        ...
                        <div data-cuenta-id="${p.ventaId}" class="${_}">
                            <div class="flex justify-between items-start gap-2">
                                ...
                                <div class="text-right shrink-0">
                                    ...
                                    ${E>0?`<p class="text-[11px] font-black text-emerald-700">A favor: +$${R(E)}</p>`:y>0?`<p class="text-xs font-bold ${x?"text-amber-900":"text-blue-900"}">Pend: $${R(y)}</p>`:'<p class="text-[11px] font-bold text-gray-400">Cubierta ($0,00)</p>'}
                                </div>
                            </div>
            ...
            <div class="lg:col-span-2">
                ${this.cuentaSeleccionada?(()=>{var g;const s=this.cuentaSeleccionada.tipo==="deuda",d=X(this.cuentaSeleccionada.totalParcialUsd),l=X(this.cuentaSeleccionada.abonosUsd),p=Math.max(0,d-l),x=Math.max(0,l-d),h=Ee(this.cuentaSeleccionada.fechaCreacionUnix);return`
                <div class="bg-white border-2 border-brand-black rounded-lg shadow-brutal p-4 sm:p-6 flex flex-col space-y-4">
                    ...
                    <div>
                        ...
                        <div id="cta-grid-prod" class="grid grid-cols-2 sm:grid-cols-3 gap-2 max-h-48 overflow-y-auto p-1">
                            ${this.productos.map(y=>{const E=!y.sinStock&&Number(y.stock)<=0,I=y.precioPaqueteUsd&&y.nombrePaquete||y.esCaja&&y.unidadesPorCaja&&y.unidadesPorCaja>1;return`
                                <div class="relative" data-producto-row="${y.sku}">
                                    <button data-add-sku="${y.sku}" data-modo="unidad" data-agotado="${E?"1":"0"}" class="text-left border-2 border-brand-black rounded p-2 transition-all text-xs font-bold ${E?"bg-gray-100 opacity-60 cursor-not-allowed":"bg-gray-50 hover:bg-white shadow-sm hover:shadow-brutal-sm"} w-full">
                                        ...
                                        <div class="flex justify-between items-center mt-1">
                                            ...
                                            <span class="text-[10px] ${E?"text-red-700 font-black":"text-gray-500"}">${we(y)}</span>
                                        </div>
                                    </button>
                                    ${I?`
                                    <button data-add-sku="${y.sku}" data-modo="paquete" data-agotado="${E?"1":"0"}" class="text-left border-2 border-brand-purple rounded p-1 transition-all text-[10px] font-bold mt-1 w-full ${E?"bg-gray-100 opacity-60 cursor-not-allowed":"bg-purple-50 hover:bg-purple-100 shadow-sm hover:shadow-brutal-sm"}">
                                        <div class="flex justify-between items-center">
            ...
            `,L=t.moneda==="USD",_=L&&s>0?s:c,f=L?r*_:r,v=c>0?f/c:0,k=a+v,P=k-o,T=P*c;let A="";if(r<=1e-4)A=`
            ...
            <div class="fixed inset-0 bg-black/40 flex items-center justify-center z-[100] p-4">
            ...
            </div>`,x()},p=()=>{const h=t.moneda==="USD",g=h&&s>0?s:c,y=h?r*g:r,E=c>0?y/c:0,I=a+E,L=I-o,_=L*c;let f="";if(r<=1e-4)f=`
                    <div class="rounded p-2.5 border-2 border-brand-black bg-gray-50 text-xs text-gray-700 font-bold">
                        <div class="flex justify-between items-center">
                            <span>Aporte de este abono:</span>
                            <span class="font-heading font-black text-sm text-gray-800">$0.00 USD (Bs. 0.00)</span>
                ...
                `;const v=this.modal.querySelector("#abono-preview-container");v&&(v.innerHTML=f);const k=this.modal.querySelector("#modal-abono-ok");if(k&&(k.disabled=r<=0),h){const P=this.modal.querySelector("[data-aporte-bs]");P&&(P.textContent=`Bs. ${R(y)}`);const T=this.modal.querySelector("[data-abono-computable]");T&&(T.textContent=`$ ${R(E)} USD`)}},x=()=>{var g,y,E,I,L,_,f;const h=()=>{this.modal.innerHTML=""};(g=this.modal.querySelector("#modal-abono-cancel"))==null||g.addEventListener("click",h),(y=this.modal.querySelector("#select-metodo-abono"))==null||y.addEventListener("change",v=>{const k=v.target.value,P=e.find(T=>T.nombre===k);if(P){const T=t.moneda==="USD";t=P,P.moneda==="USD"?(s=c,T||(r=n)):T&&(r=Number(i)),l()}}),(E=this.modal.querySelector("#input-monto-abono"))==null||E.addEventListener("input",v=>{r=X(v.target.value),p()}),(I=this.modal.querySelector("#input-tasa-abono"))==null||I.addEventListener("input",v=>{s=X(v.target.value),p()}),(L=this.modal.querySelector("#btn-reset-tasa-abono"))==null||L.addEventListener("click",()=>{s=c,l()}),(_=this.modal.querySelector("#input-ref-abono"))==null||_.addEventListener("input",v=>{d=v.target.value}),(f=this.modal.querySelector("#modal-abono-ok"))==null||f.addEventListener("click",async()=>{if(!this.cuentaSeleccionada)return;const v=t.moneda==="USD",k=v&&s>0?s:c,P=v?r*k:r,T=c>0?P/c:0;if(T<=0||!Number.isFinite(T)){this.mostrarToast("Por favor ingrese un monto válido.","error");return}const A=await D.abonarCuenta(this.cuentaSeleccionada.ventaId,T,P);A&&(this.cuentaSeleccionada=A),h(),this.render()})};l()}modalEditarAbono(){var g,y,E,I;if(!this.cuentaSeleccionada)return;const e=X(this.cuentaSeleccionada.totalParcialUsd),o=X(this.cuentaSeleccionada.abonosUsd),a=this.modelo.tasaActual||807.39;this.modal.innerHTML=`
        <div class="fixed inset-0 bg-black/40 flex items-center justify-center z-[100] p-4">
            <div class="bg-white border-2 border-brand-black rounded-lg shadow-brutal p-6 w-full max-w-md">
                ...
                <div class="bg-white border-2 border-brand-black rounded-lg shadow-brutal p-6 w-full max-w-md">
                    ...
                    <div class="border-2 border-brand-black rounded-lg p-2.5 bg-gray-50 mb-2">
                        <div class="flex flex-wrap items-center justify-between gap-1 mb-1.5">
                            <span class="font-heading font-black text-xs uppercase text-gray-700">
                                Pago #${M+1} · <span class="${w.moneda==="USD"?"text-brand-purple":"text-brand-black"}">${w.moneda==="USD"?"Divisa ($ USD)":"Moneda Nacional (Bs.)"}</span>
                            </span>
                            ${l.length>1?`<button data-eliminar-pago="${w.id}" class="text-[11px] font-black text-red-600 hover:text-red-800 bg-red-50 border border-red-300 rounded px-2 py-0.5">Eliminar</button>`:""}
                        </div>
                        ${w.moneda==="USD"?`
                        <div class="grid grid-cols-1 sm:grid-cols-12 gap-2 items-center">
                            <div class="sm:col-span-4">
                                <label class="block text-[10px] font-bold text-gray-500 uppercase mb-0.5">Medio en Divisa</label>
                                <select data-pago-metodo="${w.id}" class="w-full border-2 border-brand-black rounded px-2 py-1 font-heading font-black text-xs bg-white focus:outline-none">
                                    ${H}
                                </select>
                            </div>
                            <div class="sm:col-span-3">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <input type="number" step="0.01" min="0.01" max="999999" data-pago-monto="${w.id}" value="${w.monto>0?w.monto:""}" placeholder="0.00"
                            ...
                            <div class="sm:col-span-3">
                                <div class="flex items-center justify-between mb-0.5">
                                    <label class="block text-[10px] font-bold text-gray-500 uppercase">Tasa (Bs./$)</label>
                                    <button type="button" data-reset-tasa-cuenta="${w.id}" class="text-[9px] font-black uppercase text-brand-purple hover:underline" title="Restablecer a tasa oficial">Base: ${R(t)}</button>
                                </div>
                                <input type="number" step="0.01" min="1" max="100000" data-pago-tasa="${w.id}" value="${U>0?U:t}"
                                    class="w-full border-2 border-brand-black rounded px-2 py-1 text-xs font-mono font-black focus:outline-none text-right" />
                            </div>
                            <div class="sm:col-span-2">
                                <label class="block text-[10px] font-bold text-gray-500 uppercase mb-0.5">Referencia</label>
                                <input type="text" maxlength="25" data-pago-ref="${w.id}" value="${w.referencia||""}" placeholder="Opcional"
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-12 gap-2 items-center">
                            ...
                            <div class="sm:col-span-4">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <input type="number" step="0.01" min="0.01" max="999999999" data-pago-monto="${w.id}" value="${w.monto>0?w.monto:""}" placeholder="0.00"
                                        class="w-full border-2 border-brand-black rounded-r px-2 py-1 text-xs font-mono font-black focus:outline-none text-right" />
                                </div>
                            </div>
                            <div class="sm:col-span-3">
                        ...
                        <div class="flex flex-wrap items-center justify-between gap-1 mt-1 text-[11px]">
                            <span class="font-bold text-brand-black">Aporte directo: Bs. ${R(w.monto)}</span>
                            <span class="text-gray-500 font-mono">Equiv. base: $ ${R(V)}</span>
                        </div>
                        `}
                    </div>`}).join(""),G=b.find(w=>w.nombre===h),q=(G==null?void 0:G.moneda)==="USD",z=g>0?g:t,B=q&&z>0?Number((k.vueltoBs/z).toFixed(2)):k.vueltoUsd,N=k.faltanteBs>.009?`
                        ...
                        <div class="bg-white border border-emerald-600 rounded p-2.5 space-y-2">
                            <div class="flex flex-wrap items-center justify-between gap-2">
                                ...
                                <select id="select-metodo-vuelto-cuenta" class="border-2 border-brand-black rounded px-2 py-1 text-xs font-bold bg-white focus:outline-none">
                                    ${b.map(w=>`
                                        <option value="${w.nombre}" ${w.nombre===h?"selected":""}>
                                            ${w.nombre} (${w.moneda==="USD"?"$ Dólares":"Bs. Bolívares"})
                                        </option>
                                    `).join("")}
                                </select>
                            </div>
            ...
            </div>`,L()},L=()=>{var G,q,z,B,N,S,j,w,M,J,te;const k=()=>{this.cuentaSeleccionada&&(this.pagosBorradorPorCuenta.set(this.cuentaSeleccionada.ventaId,l),this.resolucionVueltoPorCuenta.set(this.cuentaSeleccionada.ventaId,{estado:x,metodo:h,tasa:g}))},P=()=>{k(),this.modal.innerHTML=""};(G=this.modal.querySelector("#modal-liq-cerrar"))==null||G.addEventListener("click",P),(q=this.modal.querySelector("#modal-liq-cancel"))==null||q.addEventListener("click",P),(z=this.modal.querySelector("#modal-liq-agregar-mas"))==null||z.addEventListener("click",()=>{k(),this.modal.innerHTML=""}),(B=this.modal.querySelector("#btn-vuelto-pagado-cuenta"))==null||B.addEventListener("click",()=>{x="PAGADO",k(),I()}),(N=this.modal.querySelector("#btn-vuelto-retenido-cuenta"))==null||N.addEventListener("click",()=>{x="RETENIDO",k(),I()}),(S=this.modal.querySelector("#select-metodo-vuelto-cuenta"))==null||S.addEventListener("change",H=>{h=H.target.value,k(),I()});const T=this.modal.querySelector("#input-tasa-vuelto-cuenta");if(T&&(T.addEventListener("input",H=>{const U=X(H.target.value);g=U>0?U:t,k()}),T.addEventListener("blur",()=>{I()})),(j=this.modal.querySelector("#btn-reset-tasa-vuelto-cuenta"))==null||j.addEventListener("click",()=>{g=t,k(),I()}),e){const H=this.modal.querySelector("#deuda-tasa-input"),U=this.modal.querySelector("#btn-tasa-bcv");H&&fe(H,1e5,9,()=>{const $=X(H.value);t=Number.isFinite($)&&$>0?$:i,k(),I()}),U==null||U.addEventListener("click",()=>{t=i,k(),I()})}this.modal.querySelectorAll("select[data-pago-metodo]").forEach(H=>{H.addEventListener("change",U=>{const $=H.dataset.pagoMetodo,V=U.target.value,O=l.find(Q=>Q.id===$);if(O){const Q=b.find(de=>de.nombre===V),oe=(Q==null?void 0:Q.moneda)||"BS";O.moneda=oe,O.tasaCambio=t,l.length===1?O.monto=O.moneda==="USD"?n:Number((n*t).toFixed(2)):oe!==O.moneda&&(oe==="USD"?O.monto=Number((t>0?O.monto/t:0).toFixed(2)):O.monto=Number((O.monto*t).toFixed(2))),O.metodo=V,k(),I()}})}),this.modal.querySelectorAll("input[data-pago-tasa]").forEach(H=>{H.addEventListener("input",U=>{const $=H.dataset.pagoTasa,V=X(U.target.value),O=l.find(Q=>Q.id===$);if(O){O.tasaCambio=V>0?V:t,k();const Q=E(),oe=this.modal.querySelector("#modal-liq-ok");oe&&(oe.disabled=!Q.puedeConfirmar)}}),H.addEventListener("blur",()=>{I()})}),this.modal.querySelectorAll("button[data-reset-tasa-cuenta]").forEach(H=>{H.addEventListener("click",()=>{const U=H.dataset.resetTasaCuenta,$=l.find(V=>V.id===U);$&&($.tasaCambio=t,k(),I())})}),this.modal.querySelectorAll("input[data-pago-monto]").forEach(H=>{H.addEventListener("input",U=>{const $=H.dataset.pagoMonto,V=X(U.target.value),O=l.find(Q=>Q.id===$);if(O){O.monto=V,k();const Q=E(),oe=this.modal.querySelector("#modal-liq-ok");oe&&(oe.disabled=!Q.puedeConfirmar)}}),H.addEventListener("blur",()=>{I()})}),this.modal.querySelectorAll("input[data-pago-ref]").forEach(H=>{H.addEventListener("input",U=>{const $=H.dataset.pagoRef,V=U.target.value,O=l.find(Q=>Q.id===$);O&&(O.referencia=V,k())})}),this.modal.querySelectorAll("button[data-eliminar-pago]").forEach(H=>{H.addEventListener("click",()=>{const U=H.dataset.eliminarPago;l=l.filter($=>$.id!==U),k(),I()})}),(w=this.modal.querySelector("#btn-agregar-pago-cuenta"))==null||w.addEventListener("click",()=>{let H=E();const U="p-"+Math.random().toString(36).slice(2,7),$=b.find(O=>!l.some(Q=>Q.metodo===O.nombre))||b[0]||{nombre:"BS.EFEC.",moneda:"BS"};if(H.faltanteBs<=.01&&l.length===1&&l[0]){const O=l[0],Q=O.tasaCambio>0?O.tasaCambio:t,oe=O.moneda==="USD"?O.monto*Q:O.monto,de=Math.round(oe/2*100)/100;O.monto=O.moneda==="USD"?Q>0?Number((de/Q).toFixed(2)):0:de,H=E()}const V=H.faltanteBs>0?H.faltanteBs:0;l.push({id:U,metodo:$.nombre,moneda:$.moneda,monto:$.moneda==="USD"?t>0?Number((V/t).toFixed(2)):0:V,tasaCambio:t,referencia:""}),k(),I()}),(M=this.modal.querySelector("#btn-toggle-nuevo-metodo-cuenta"))==null||M.addEventListener("click",()=>{y=!y,I()}),(J=this.modal.querySelector("#btn-guardar-nuevo-metodo-cuenta"))==null||J.addEventListener("click",()=>{(async()=>{const H=this.modal.querySelector("#input-nuevo-metodo-nombre-cuenta"),U=(H==null?void 0:H.value.trim())||"",$=this.modal.querySelector('input[name="radio-nuevo-metodo-moneda-cuenta"][value="USD"]'),V=$!=null&&$.checked?"USD":"BS";if(U)try{b=await D.crearMetodoPago(U,V),y=!1,I()}catch{}})()});let A=!1;(te=this.modal.querySelector("#modal-liq-ok"))==null||te.addEventListener("click",()=>{A||(A=!0,(async()=>{if(!this.cuentaSeleccionada)return;const H=this.modal.querySelector("#cobro-error-cuenta");try{const U=l.filter(ne=>ne.monto>0).map(ne=>{const ue=ne.moneda==="USD"&&ne.tasaCambio>0?ne.tasaCambio:t,ke=ne.moneda==="USD"?ne.monto*ue:ne.monto,Te=t>0?ke/t:0;return{metodo:ne.metodo,moneda:ne.moneda,montoUsd:(ne.moneda==="USD"?ne.monto:Te).toFixed(2),montoBs:ke.toFixed(2),tasaCambio:ne.moneda==="USD"?ue.toFixed(2):void 0,referencia:ne.referencia.trim()||void 0}});if(U.length===0)throw new Error("Debe especificar al menos un pago válido.");const $=E(),V=U.reduce((ne,ue)=>ne+Number(ue.montoBs),0),O=b.find(ne=>ne.nombre===h),Q=(O==null?void 0:O.moneda)==="USD",oe=Q?g>0?g:t:void 0,de=Q&&oe?($.vueltoBs/oe).toFixed(2):$.vueltoUsd.toFixed(2),Ue={estado:$.vueltoBs>.009?x:"SIN_VUELTO",metodo:$.vueltoBs>.009&&x==="PAGADO"?h:void 0,montoBs:$.vueltoBs>.009?$.vueltoBs.toFixed(2):void 0,montoUsd:$.vueltoBs>.009?de:void 0,tasa:$.vueltoBs>.009&&x==="PAGADO"&&oe?oe.toFixed(2):void 0},xe=this.cuentaSeleccionada.ventaId;await D.cerrarCuenta(xe,V.toFixed(2),t.toFixed(4),U,Ue),this.pagosBorradorPorCuenta.delete(xe),this.resolucionVueltoPorCuenta.delete(xe),this.cuentaSeleccionada=null,this.modal.innerHTML="",this.render()}catch(U){A=!1,H&&(H.textContent=U instanceof Error?U.message.replace(/"/g,""):String(U),H.classList.remove("hidden"))}})())})};I()}mostrarToast(e,o="info"){var c;const a={success:"bg-emerald-600 text-white",error:"bg-red-600 text-white",info:"bg-brand-black text-white"},n=document.createElement("div");n.className=`fixed bottom-6 right-6 ${a[o]} border-2 border-brand-black rounded shadow-brutal px-5 py-4 font-heading font-bold max-w-md z-[110]`,n.innerHTML=`${e.replace(/"/g,"")} <button class="ml-3 underline font-black">cerrar</button>`,(c=n.querySelector("button"))==null||c.addEventListener("click",()=>n.remove()),document.body.appendChild(n),setTimeout(()=>n.remove(),8e3)}}const ie=(u,e,o,a)=>{u.maxLength=o,u.addEventListener("input",()=>{let n=u.value.replace(/[^0-9.,]/g,"");const c=n.split(/[.,]/);c.length>2?n=c[0]+"."+c.slice(1).join(""):c.length===2&&(n=c[0]+"."+c[1].slice(0,2)),n.length>o&&(n=n.slice(0,o));const i=parseFloat(n.replace(",","."));Number.isFinite(i)&&i>e&&(n=String(e)),u.value!==n&&(u.value=n),a&&a()})},Se=(u,e,o,a,n)=>{u.maxLength=a,u.addEventListener("input",()=>{let c=u.value.replace(/[^0-9]/g,"");c.length>a&&(c=c.slice(0,a));const i=parseInt(c,10);Number.isFinite(i)&&i>o&&(c=String(o)),u.value!==c&&(u.value=c),n&&n()}),u.addEventListener("blur",()=>{const c=parseInt(u.value,10);Number.isFinite(c)&&c<e&&(u.value=String(e),n&&n())})},le=(u,e,o=!1)=>{u.maxLength=e,u.addEventListener("input",()=>{let a=o?u.value.replace(/[<>{}\\]/g,""):u.value.replace(/[^a-zA-Z0-9áéíóúÁÉÍÓÚñÑüÜ .,/_#-]/g,"");a.length>e&&(a=a.slice(0,e)),u.value!==a&&(u.value=a)})};class tt{constructor(e,o,a=!0){C(this,"contenedor");C(this,"modelo");C(this,"categorias",[]);C(this,"tasasImpuestos",[]);C(this,"productos",[]);C(this,"busquedaRepo","");C(this,"busquedaCatalogo","");C(this,"filtroCategoriaRepo","todas");C(this,"filtroCategoriaCatalogo","todas");C(this,"tabActiva","alta");C(this,"semaforoStock",{rojoMax:5,amarilloMax:15});C(this,"POR_PAGINA_CAT",40);C(this,"POR_PAGINA_REPO",24);C(this,"paginaCat",1);C(this,"paginaRepo",1);this.duenoAutenticado=a,this.contenedor=e,this.modelo=o,this.modelo}getUnitLabel(e){return e.unidad==="kg"?"kg":e.unidad==="ml"?"ml":e.unidad==="un"?"un.":e.capacidades&2?"kg":"un."}getNombreCategoria(e){if(!e)return"General";const o=this.categorias.find(a=>a.id===e);return o?o.nombre:"General"}getConteoCategorias(){const e={todas:this.productos.length};return this.categorias.forEach(o=>{e[o.id]=0}),e["cat-general"]===void 0&&(e["cat-general"]=0),this.productos.forEach(o=>{const a=o.categoriaId||"cat-general";e[a]=(e[a]||0)+1}),e}async render(e){var s;e&&(this.tabActiva=e);const[o,a,n,c]=await Promise.all([D.categorias(),D.tasasImpuestos(),D.productos(),D.obtenerSemaforoStock()]);this.categorias=o,this.tasasImpuestos=a,this.productos=n,this.semaforoStock=c;const i=this.getConteoCategorias(),b="Ej: Artículo Comercial 1L, Presentación 500g, Pack Estándar...",r=((s=this.modelo.getConfig())==null?void 0:s.privacidadInventario)&&!this.duenoAutenticado;this.contenedor.innerHTML=`
        <div class="mb-4 sm:mb-6 flex flex-wrap items-center justify-between gap-3">
            <div>
...
`),t=new Blob(["\uFEFF"+b],{type:"text/csv;charset=utf-8;"}),r=URL.createObjectURL(t),s=document.createElement("a");s.href=r,s.download=`jornada_${u.id}.csv`,document.body.appendChild(s),s.click(),document.body.removeChild(s),URL.revokeObjectURL(r)};class ot{constructor(e,o,a){C(this,"contenedor");C(this,"modalRoot");C(this,"modelo");C(this,"jornadas",[]);C(this,"jornadaActual",null);C(this,"todosLosTickets",[]);C(this,"busqueda","");C(this,"expandidos",new Set);C(this,"paginaActual",1);C(this,"POR_PAGINA",20);this.contenedor=e,this.modalRoot=o,this.modelo=a}parseFechaUnix(e){if(!e)return 0;const o=e.match(/(\d{4})-(\d{2})-(\d{2})[T\s](\d{2}):(\d{2}):(\d{2})/);if(o&&o[1]&&o[2]&&o[3]&&o[4]&&o[5]&&o[6]){const a=Date.UTC(parseInt(o[1],10),parseInt(o[2],10)-1,parseInt(o[3],10),parseInt(o[4],10),parseInt(o[5],10),parseInt(o[6],10));if(!isNaN(a))return Math.floor(a/1e3)}return 0}async render(){const[e,o,a]=await Promise.all([D.obtenerJornadaActual(),D.listarHistoricoJornadas(),D.ventas()]);this.jornadaActual=e,this.jornadas=o,this.todosLosTickets=a;const n=(e?1:0)+o.length,c=[...e?[e]:[],...o],i=c.reduce((t,r)=>t+be(r.ventasTotalUsd),0),b=c.reduce((t,r)=>t+r.ticketsEmitidos,0);this.contenedor.innerHTML=`
        ...
        <div id="lista-jornadas" class="flex flex-col gap-2"></div>`,this.conectarEventosBuscador(),this.renderLista()}conectarEventosBuscador(){var e;(e=document.getElementById("jornadas-buscar"))==null||e.addEventListener("input",o=>{this.busqueda=o.target.value,this.paginaActual=1,this.renderLista()})}renderLista(){var s,d;const e=document.getElementById("lista-jornadas");if(!e)return;const o=[...this.jornadaActual?[this.jornadaActual]:[],...this.jornadas],a=this.busqueda.trim().toLowerCase(),n=a?o.filter(l=>l.id.toLowerCase().includes(a)||l.operadorActual.toLowerCase().includes(a)||l.operadoresRelevo.some(p=>p.toLowerCase().includes(a))||l.inicioStr.toLowerCase().includes(a)||(l.finStr||"").toLowerCase().includes(a)):o,c=document.getElementById("paginacion-jornadas");if(c&&c.remove(),n.length===0){e.innerHTML=`
            ...
            </div>`;return}const i=Math.max(1,Math.ceil(n.length/this.POR_PAGINA));this.paginaActual>i&&(this.paginaActual=i),this.paginaActual<1&&(this.paginaActual=1);const b=this.paginaActual,t=n.slice((b-1)*this.POR_PAGINA,b*this.POR_PAGINA);e.innerHTML=t.map(l=>this.renderFila(l)).join(""),t.forEach(l=>{if(this.expandidos.has(l.id)){const p=document.getElementById(`detalle-${l.id}`);p==null||p.classList.remove("hidden");const x=document.getElementById(`icon-${l.id}`);x&&(x.textContent="▲")}}),e.querySelectorAll("[data-toggle-jornada]").forEach(l=>{l.addEventListener("click",()=>{const p=l.dataset.toggleJornada,x=document.getElementById(`detalle-${p}`),h=document.getElementById(`icon-${p}`);if(x){const g=x.classList.contains("hidden");x.classList.toggle("hidden",!g),h&&(h.textContent=g?"▲":"▼"),g?this.expandidos.add(p):this.expandidos.delete(p)}})}),e.querySelectorAll("[data-exportar-jornada]").forEach(l=>{l.addEventListener("click",p=>{p.stopPropagation();const x=l.dataset.exportarJornada,h=n.find(g=>g.id===x);h&&at(h,this.todosLosTickets)})}),e.querySelectorAll("[data-ver-ticket]").forEach(l=>{l.addEventListener("click",()=>{const p=l.dataset.verTicket,x=this.todosLosTickets.find(h=>h.ventaId===p);x&&this.mostrarModalTicket(x)})});const r=document.createElement("div");r.id="paginacion-jornadas",r.innerHTML=`
        ...
        </div>`;const n=()=>{this.modalRoot.innerHTML=""};(c=document.getElementById("modal-ticket-cerrar"))==null||c.addEventListener("click",n),(i=document.getElementById("modal-ticket-ok"))==null||i.addEventListener("click",n)}}class nt{constructor(e){C(this,"contenedor");this.contenedor=e}render(){this.contenedor.innerHTML=`
