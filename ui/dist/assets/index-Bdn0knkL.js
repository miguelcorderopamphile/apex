...
Esta tasa afectará todos los nuevos cobros y tickets a partir de este momento.`)){const g=await H("fijar_tasa_manual",{tasa:c.toFixed(2)});g&&this.pintar(g),n()}})}async actualizar(){const e=await this.obtenerTasa("obtener_tasa_bcv");e&&this.pintar(e)}async forzar(){const e=document.getElementById("bcv-refresh");e&&e.classList.add("animate-spin");const a=await this.obtenerTasa("forzar_actualizacion_tasa");e&&e.classList.remove("animate-spin"),a&&this.pintar(a)}async obtenerTasa(e){try{return await H(e)}catch{return null}}pintar(e){const a=document.getElementById("bcv-valor"),o=document.getElementById("bcv-fluctuacion");if(!a||!o)return;const n=Number(e.valor);a.textContent=Number.isFinite(n)&&n>0?n.toLocaleString("es-VE",{minimumFractionDigits:2,maximumFractionDigits:2}):"--",Number.isFinite(n)&&n>0&&window.dispatchEvent(new CustomEvent("tasa_actualizada",{detail:n}));const l=Number(e.fluctuacionPct);if(e.direccion&&Number.isFinite(l)){const i=e.direccion==="subio"?Re:e.direccion==="bajo"?Ne:Me,r=l>0?"+":"";o.textContent=`${r}${l.toFixed(2)}%`,o.style.color=i}else o.textContent=""}}class Fe{constructor(){w(this,"config",null);w(this,"rol","caja");w(this,"tasa",0);w(this,"oyentes",[])}suscribir(e){this.oyentes.push(e)}notificar(){this.oyentes.forEach(e=>e())}async cargarConfig(){return this.config=await D.config(),this.config}getConfig(){return this.config}async inicializar(e,a,o){await D.inicializar(e,a,o),await this.cargarConfig(),this.notificar()}get rubroAbasto(){var e,a;return(((e=this.config)==null?void 0:e.rubros)??0&pe)!==0||(((a=this.config)==null?void 0:a.rubros)??0)===pe}tieneRubro(e){var a;return((((a=this.config)==null?void 0:a.rubros)??0)&e)!==0}tieneCapacidad(e){var a;return((((a=this.config)==null?void 0:a.capacidades)??0)&e)!==0}setRol(e){this.rol=e,this.notificar()}get rolActual(){return this.rol}setTasa(e){this.tasa=e,this.notificar()}get tasaActual(){return this.tasa}bs(e){return(Number(e)*this.tasa).toLocaleString("es-VE",{minimumFractionDigits:2,maximumFractionDigits:2})}}class qe{constructor(e,a,o){w(this,"contenedor");w(this,"modelo");w(this,"alTerminar");w(this,"modo","nuevo");w(this,"bloquearPanel",!0);this.contenedor=e,this.modelo=a,this.alTerminar=o}render(){this.contenedor.innerHTML=`
        ...
        </div>`,this.conectarEventos()}tarjetaRubro(e,a,o,n,l,i=!1){return`
        <label for="${e}" class="cursor-pointer block select-none">
            <div class="border-2 border-brand-black rounded-lg p-3 ${l} bg-opacity-30 hover:bg-opacity-50 transition-all hover:-translate-y-0.5 shadow-brutal-sm">
        ...
        <div class="fixed inset-0 bg-black/40 flex items-center justify-center z-[100] p-4">
            ...
            `,"max-w-md"),(n=this.modal.querySelector("[data-cerrar]"))==null||n.addEventListener("click",()=>this.cerrarModal()),(l=this.modal.querySelector("#btn-cancelar-inicio-jornada"))==null||l.addEventListener("click",()=>this.cerrarModal()),(i=this.modal.querySelector("#form-nuevo-cajero-inicio"))==null||i.addEventListener("submit",async t=>{t.preventDefault();const s=this.modal.querySelector("#in-nuevo-cajero-inicio"),d=(s==null?void 0:s.value.trim())||"";d&&(await D.crearOperador(d),this.cerrarModal(),this.abrirModalIniciarJornada())}),(r=this.modal.querySelector("#btn-abrir-turno"))==null||r.addEventListener("click",async()=>{const t=this.modal.querySelectorAll("input[data-inicio-cajero-chk]:checked"),s=[];if(t.forEach(c=>{c.value&&s.push(c.value)}),s.length===0){alert("Selecciona al menos un operador para abrir el turno.");return}const d=s[0];await D.abrirJornada(d,s),this.cerrarModal(),this.renderDinamico()})})()}async abrirModalCobro(){var h,y,k,U;if(this.vm.lineasCarrito.length===0)return;let e=[];try{e=await D.listarMetodosPago()}catch{e=[{nombre:"PUNTOD.VENTA",moneda:"BS"},{nombre:"BIOPAGO",moneda:"BS"},{nombre:"PAGO MOVIL",moneda:"BS"},{nombre:"TRANSF.BS.",moneda:"BS"},{nombre:"BS.EFEC.",moneda:"BS"},{nombre:"DOL.CASH",moneda:"USD"},{nombre:"ZELLE",moneda:"USD"},{nombre:"BINAN.USDT",moneda:"USD"}]}const a=Number(this.vm.totalUsd.toFixed(2)),o=this.vm.tasaTicket,n=Number((a*o).toFixed(2)),l=e.find(A=>A.nombre==="PUNTOD.VENTA")||e.find(A=>A.moneda==="BS")||e[0]||{nombre:"PUNTOD.VENTA",moneda:"BS"};let i;if(this.pagosBorrador&&this.pagosBorrador.length>0){if(i=this.pagosBorrador.map(A=>({...A})),i.length===1&&i[0]){const A=i[0];A.monto=A.moneda==="USD"?a:n,A.tasaCambio=o}else if(i.length>1){let A=0;for(let F=0;F<i.length-1;F++){const C=i[F],f=C.tasaCambio>0?C.tasaCambio:o;A+=C.moneda==="USD"?C.monto*f:C.monto}const O=Math.max(0,Math.round((n-A)*100)/100),R=i[i.length-1];R&&(R.monto=R.moneda==="USD"?o>0?Number((O/o).toFixed(2)):0:O,R.tasaCambio=o)}}else i=[{id:"p-1",metodo:l.nombre,moneda:l.moneda,monto:l.moneda==="USD"?a:n,tasaCambio:o,referencia:""}];let r=((h=this.resolucionVueltoBorrador)==null?void 0:h.estado)||"PAGADO",t=((y=this.resolucionVueltoBorrador)==null?void 0:y.metodo)||"BS.EFEC.",s=((k=this.resolucionVueltoBorrador)==null?void 0:k.tasa)||o;e.some(A=>A.nombre===t)||(t=((U=e[0])==null?void 0:U.nombre)||"BS.EFEC.");let d=!1;const c=()=>{let A=0;for(const S of i)if(S.moneda==="USD"){const M=S.tasaCambio>0?S.tasaCambio:o;A+=S.monto*M}else A+=S.monto;A=Math.round(A*100)/100;const O=o>0?Math.round(A/o*100)/100:0,R=Math.max(0,Math.round((n-A)*100)/100),F=o>0?Math.max(0,Math.round(R/o*100)/100):0,C=Math.max(0,Math.round((A-n)*100)/100),f=o>0?Math.max(0,Math.round(C/o*100)/100):0,m=A>=n-.01&&i.every(S=>S.monto>0);return{cubiertoUsd:O,cubiertoBs:A,faltanteUsd:F,faltanteBs:R,vueltoUsd:f,vueltoBs:C,puedeConfirmar:m}},b=()=>{const A=c(),O=e.filter(B=>B.moneda==="USD"),R=e.filter(B=>B.moneda==="BS"),F=i.map((B,_)=>{const x=O.map(E=>`<option value="${E.nombre}" ${E.nombre===B.metodo?"selected":""}>${E.nombre} ($ - Tasa Dinámica)</option>`).join(""),P=`
                    ...
                    `,I=B.tasaCambio>0?B.tasaCambio:o,G=B.moneda==="USD"?B.monto*I:B.monto,T=o>0?G/o:0;return`
                    <div class="border-2 border-brand-black rounded-lg p-3 bg-gray-50 mb-2.5">
                        ...
                        <div class="flex flex-wrap items-center justify-between gap-1 mt-1.5 text-[11px]">
                            ...
                            <span class="text-gray-500 font-mono">Equiv. oficial BCV: $ ${Y(T)} ${I!==o?`(Tasa: Bs. ${Y(I)} vs BCV: Bs. ${Y(o)})`:""}</span>
                        </div>
                        `:`
                        <div class="grid grid-cols-1 sm:grid-cols-12 gap-2 items-center">
                        ...
                        <div class="flex flex-wrap items-center justify-between gap-1 mt-1.5 text-[11px]">
                            ...
                            <span class="text-gray-500 font-mono">Equiv. oficial BCV: $ ${Y(T)}</span>
                        </div>
                        `}
                    </div>`}).join(""),C=e.find(B=>B.nombre===t),f=(C==null?void 0:C.moneda)==="USD",m=s>0?s:o,S=f&&m>0?Number((A.vueltoBs/m).toFixed(2)):A.vueltoUsd,M=A.faltanteBs>.009?`
                ...
                </div>`,"max-w-xl"),g()},g=()=>{var R,F,C,f,m,S,M,B,_,x;const A=()=>{this.pagosBorrador=i,this.resolucionVueltoBorrador={estado:r,metodo:t,tasa:s},this.cerrarModal()};this.modal.querySelectorAll("[data-cerrar]").forEach(v=>v.addEventListener("click",A)),(R=this.modal.querySelector("[data-cancelar]"))==null||R.addEventListener("click",A),(F=this.modal.querySelector("#btn-volver-caja"))==null||F.addEventListener("click",()=>{this.pagosBorrador=i,this.resolucionVueltoBorrador={estado:r,metodo:t,tasa:s},this.cerrarModal();const v=document.getElementById("caja-buscar");v==null||v.focus()}),(C=this.modal.querySelector("#btn-vuelto-pagado"))==null||C.addEventListener("click",()=>{r="PAGADO",this.resolucionVueltoBorrador={estado:r,metodo:t,tasa:s},b()}),(f=this.modal.querySelector("#btn-vuelto-retenido"))==null||f.addEventListener("click",()=>{r="RETENIDO",this.resolucionVueltoBorrador={estado:r,metodo:t,tasa:s},b()}),(m=this.modal.querySelector("#select-metodo-vuelto"))==null||m.addEventListener("change",v=>{t=v.target.value,this.resolucionVueltoBorrador={estado:r,metodo:t,tasa:s},b()});const O=this.modal.querySelector("#input-tasa-vuelto");O&&(O.addEventListener("input",v=>{const P=Q(v.target.value);s=P>0?P:o,this.resolucionVueltoBorrador={estado:r,metodo:t,tasa:s}}),O.addEventListener("blur",()=>{b()})),(S=this.modal.querySelector("#btn-reset-tasa-vuelto"))==null||S.addEventListener("click",()=>{s=o,this.resolucionVueltoBorrador={estado:r,metodo:t,tasa:s},b()}),this.modal.querySelectorAll("select[data-pago-metodo]").forEach(v=>{v.addEventListener("change",P=>{const I=v.dataset.pagoMetodo,G=P.target.value,T=i.find(E=>E.id===I);if(T){const E=e.find(W=>W.nombre===G),K=(E==null?void 0:E.moneda)||"BS";T.moneda=K,T.tasaCambio=o,i.length===1?T.monto=T.moneda==="USD"?a:n:K!==T.moneda&&(K==="USD"?T.monto=Number((o>0?T.monto/o:0).toFixed(2)):T.monto=Number((T.monto*o).toFixed(2))),T.metodo=G,this.pagosBorrador=i,b()}})}),this.modal.querySelectorAll("input[data-pago-tasa]").forEach(v=>{v.addEventListener("input",P=>{const I=v.dataset.pagoTasa,G=Q(P.target.value),T=i.find(E=>E.id===I);if(T){T.tasaCambio=G>0?G:o,this.pagosBorrador=i;const E=c(),K=this.modal.querySelector("#btn-confirmar-cobro");K&&(K.disabled=!E.puedeConfirmar)}}),v.addEventListener("blur",()=>{b()})}),this.modal.querySelectorAll("button[data-reset-tasa]").forEach(v=>{v.addEventListener("click",()=>{const P=v.dataset.resetTasa,I=i.find(G=>G.id===P);I&&(I.tasaCambio=o,this.pagosBorrador=i,b())})}),this.modal.querySelectorAll("input[data-pago-monto]").forEach(v=>{v.addEventListener("input",P=>{const I=v.dataset.pagoMonto,G=Q(P.target.value),T=i.find(E=>E.id===I);if(T){T.monto=G,this.pagosBorrador=i;const E=c(),K=this.modal.querySelector("#btn-confirmar-cobro");K&&(K.disabled=!E.puedeConfirmar)}}),v.addEventListener("blur",()=>{b()})}),this.modal.querySelectorAll("input[data-pago-ref]").forEach(v=>{v.addEventListener("input",P=>{const I=v.dataset.pagoRef,G=P.target.value,T=i.find(E=>E.id===I);T&&(T.referencia=G,this.pagosBorrador=i)})}),this.modal.querySelectorAll("button[data-eliminar-pago]").forEach(v=>{v.addEventListener("click",()=>{const P=v.dataset.eliminarPago;i=i.filter(I=>I.id!==P),this.pagosBorrador=i,b()})}),(M=this.modal.querySelector("#btn-agregar-pago"))==null||M.addEventListener("click",()=>{let v=c();const P="p-"+Math.random().toString(36).slice(2,7),I=e.find(T=>!i.some(E=>E.metodo===T.nombre))||e[0]||{nombre:"BS.EFEC.",moneda:"BS"};if(v.faltanteBs<=.01&&i.length===1&&i[0]){const T=i[0],E=T.tasaCambio>0?T.tasaCambio:o,K=T.moneda==="USD"?T.monto*E:T.monto,W=Math.round(K/2*100)/100;T.monto=T.moneda==="USD"?E>0?Number((W/E).toFixed(2)):0:W,v=c()}const G=v.faltanteBs>0?v.faltanteBs:0;i.push({id:P,metodo:I.nombre,moneda:I.moneda,monto:I.moneda==="USD"?o>0?Number((G/o).toFixed(2)):0:G,tasaCambio:o,referencia:""}),this.pagosBorrador=i,b()}),(B=this.modal.querySelector("#btn-toggle-nuevo-metodo"))==null||B.addEventListener("click",()=>{d=!d,b()}),(_=this.modal.querySelector("#btn-guardar-nuevo-metodo"))==null||_.addEventListener("click",()=>{(async()=>{const v=this.modal.querySelector("#input-nuevo-metodo-nombre"),P=(v==null?void 0:v.value.trim())||"",I=this.modal.querySelector('input[name="radio-nuevo-metodo-moneda"][value="USD"]'),G=I!=null&&I.checked?"USD":"BS";if(P)try{e=await D.crearMetodoPago(P,G),d=!1,b()}catch{}})()}),this.modal.querySelectorAll("button[data-caja-eliminar-metodo]").forEach(v=>{v.addEventListener("click",()=>{(async()=>{const P=v.dataset.cajaEliminarMetodo||"";P&&window.confirm(`¿Seguro que deseas eliminar el método de pago "${P}"?`)&&(e=await D.eliminarMetodoPago(P),i.forEach(I=>{if(I.metodo===P){const G=e[0]||{nombre:"PUNTOD.VENTA",moneda:"BS"};I.metodo=G.nombre,I.moneda=G.moneda}}),this.pagosBorrador=i,b())})()})}),(x=this.modal.querySelector("#btn-confirmar-cobro"))==null||x.addEventListener("click",()=>{(async()=>{const v=this.modal.querySelector("#cobro-error");try{const P=i.filter($=>$.monto>0).map($=>{const q=$.moneda==="USD"&&$.tasaCambio>0?$.tasaCambio:o,V=$.moneda==="USD"?$.monto*q:$.monto,z=o>0?V/o:0;return{metodo:$.metodo,moneda:$.moneda,montoUsd:($.moneda==="USD"?$.monto:z).toFixed(2),montoBs:V.toFixed(2),tasaCambio:$.moneda==="USD"?q.toFixed(2):void 0,referencia:$.referencia.trim()||void 0}});if(P.length===0)throw new Error("Debe especificar al menos un pago válido.");const I=c(),G=P.reduce(($,q)=>$+Number(q.montoBs),0),T=e.find($=>$.nombre===t),E=(T==null?void 0:T.moneda)==="USD",K=E?s>0?s:o:void 0,W=E&&K?(I.vueltoBs/K).toFixed(2):I.vueltoUsd.toFixed(2),L={estado:I.vueltoBs>.009?r:"SIN_VUELTO",metodo:I.vueltoBs>.009&&r==="PAGADO"?t:void 0,montoBs:I.vueltoBs>.009?I.vueltoBs.toFixed(2):void 0,montoUsd:I.vueltoBs>.009?W:void 0,tasa:I.vueltoBs>.009&&r==="PAGADO"&&K?K.toFixed(2):void 0},j=await this.vm.cobrar(G.toFixed(2),P,L);this.pagosBorrador=null,this.resolucionVueltoBorrador=null,this.cerrarModal(),this.modalTicketExito(j,G)}catch(P){v&&(v.textContent=P instanceof Error?P.message.replace(/"/g,""):String(P),v.classList.remove("hidden"))}})()})};b()}modalTicketExito(e,a){const o=e.pagos&&e.pagos.length>0?e.pagos.map(l=>`
            ...
            <button data-cerrar class="w-full bg-brand-black text-white font-heading font-black text-lg py-3 rounded border-2 border-brand-black shadow-brutal-sm hover:bg-gray-800">
                LISTO
            </button>`,"max-w-md")}renderDinamico(){const e=this.contenedor.querySelector("#caja-grid");if(!e)return;const a=this.semaforoStock;e.innerHTML=this.vm.visibles.map(i=>{const r=(i.capacidades&ie)!==0,t=Number(i.stock),s=t<=0,d=i.sinStock?"text-purple-700":t<=a.rojoMax?"text-red-600":t<=a.amarilloMax?"text-amber-600":"text-emerald-700",c=i.unidad?i.unidad.toLowerCase()==="un"?"un.":i.unidad.toLowerCase():r?"kg":"un.",b=c==="kg"?"kg":c==="ml"?"ml":"un.";let g="";if(i.sinStock)g="LIBRE";else if(s)g="AGOTADO";else if(i.esCaja&&i.unidadesPorCaja&&i.unidadesPorCaja>1){const h=Math.floor(t/i.unidadesPorCaja),y=t%i.unidadesPorCaja;g=`${h} cajas y ${y} un. (${t} un.)`}else g=`${t} ${c}`;return`
            ...
            </tr>`}).join("")}async render(){var C;const[e,a,o,n,l,i,r]=await Promise.all([D.panel(),D.respaldos(),D.ventas(),D.productos(),D.categorias(),D.cuentas(),D.obtenerJornadaActual()]);this.vm.setDatos(e),this.respaldos=a,this.transacciones=o,this.productos=n,this.categorias=l,this.cuentas=i,this.jornadaActual=r;const t=new Date,s=new Date(t.getTime()-864e5),d=f=>f.toLocaleString("es-VE",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"});if(!this.rangoDetalleFechas){this.rangoDescripcion="Últimas 24 Horas",this.rangoDetalleFechas=`Del ${d(s)} al ${d(t)}`;const f=Math.floor(s.getTime()/1e3),m=this.transacciones.filter(S=>this.obtenerTimestampTicket(S)>=f);this.transaccionesFiltradasRango=m.length>0?m:this.transacciones.slice(0,15)}const c=this.modelo.bs(e.valorInventarioUsd),b=this.modelo.tieneCapacidad(8)||this.modelo.tieneRubro(4),g=e.dineroPorCategoria&&e.dineroPorCategoria.length>0?e.dineroPorCategoria:this.calcularDineroPorCategoria(),h=g.reduce((f,m)=>f+m.cantidadProductos,0),y=g.reduce((f,m)=>f+m.unidadesStock,0),k=g.reduce((f,m)=>f+te(m.dineroBrutoUsd),0),U=g.reduce((f,m)=>f+te(m.dineroBrutoBs),0),A=g.reduce((f,m)=>f+te(m.dineroVentaUsd),0),O=Math.max(0,A-k),R=A>0?(O/A*100).toFixed(1):"0.0",F=g.map(f=>{const m=te(f.porcentajeCapital);return`
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-4 sm:mb-6">
            ...
            ${this.kpi("Inventario Total",`$ ${J(e.valorInventarioUsd)}`,`<span class="break-words" title="Bs. ${c}">Bs. ${re(c)}</span>`,"bg-purple-50","Valoración monetaria total del stock físico actual disponible")}
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
            ...
            <div class="bg-white border-2 border-brand-black rounded-lg shadow-brutal p-4 sm:p-6 flex flex-col justify-between">
                ...
                <div class="mt-4 pt-3 border-t border-brand-black">
                    ...
                    `,(L=P.querySelector("#btn-abrir-jornada"))==null||L.addEventListener("click",async()=>{var V;const $=(await D.listarOperadores()).filter(z=>z.activo),q=((V=$[0])==null?void 0:V.nombre)||"Cajero Principal";await D.abrirJornada(q,$.map(z=>z.nombre)),b()}),(j=P.querySelector("#btn-cerrar-jornada"))==null||j.addEventListener("click",async()=>{if(window.confirm("¿Confirmas el cierre de la jornada operativa actual? Se generará el balance consolidado del turno.")){const q=await D.cerrarJornada();alert(`Jornada cerrada con éxito.
Identificador: ${q.id}
...
Disponibles: ${M}`,S.join(", "));if(B!==null){const x=B.split(",").map(v=>v.trim()).filter(v=>f.some(P=>P.nombre.toLowerCase()===v.toLowerCase()));x.length>0?(await D.asignarOperadoresTurno(x),b()):B.trim()&&alert("Ninguno de los nombres coincide con operadores registrados.")}}),(A=document.getElementById("form-crear-metodo-panel"))==null||A.addEventListener("submit",async f=>{f.preventDefault();const m=document.getElementById("in-nuevo-metodo-nombre"),S=document.getElementById("select-nuevo-metodo-moneda"),M=(m==null?void 0:m.value.trim())||"",B=(S==null?void 0:S.value)==="USD"?"USD":"BS";M&&(await D.crearMetodoPago(M,B),m&&(m.value=""),b())}),(O=document.getElementById("form-crear-operador"))==null||O.addEventListener("submit",async f=>{f.preventDefault();const m=document.getElementById("in-nuevo-operador"),S=(m==null?void 0:m.value.trim())||"";S&&(await D.crearOperador(S),m&&(m.value=""),b())}),(R=document.getElementById("form-semaforo-stock"))==null||R.addEventListener("submit",async f=>{f.preventDefault();const m=document.getElementById("in-semaforo-rojo"),S=document.getElementById("in-semaforo-amarillo"),M=document.getElementById("msg-semaforo-stock"),B=parseInt((m==null?void 0:m.value)||"5",10),_=parseInt((S==null?void 0:S.value)||"15",10);if(B>=_){alert("El umbral rojo debe ser estrictamente menor que el umbral amarillo.");return}await D.guardarSemaforoStock(B,_),M&&(M.textContent="Umbrales del semáforo guardados y aplicados a todo el sistema.",M.classList.remove("hidden"),setTimeout(()=>M.classList.add("hidden"),2500))}),(F=document.getElementById("btn-reset-semaforo"))==null||F.addEventListener("click",async()=>{await D.guardarSemaforoStock(5,15),b()}),(C=document.getElementById("form-cambiar-clave"))==null||C.addEventListener("submit",async f=>{f.preventDefault();const m=document.getElementById("pin-actual"),S=document.getElementById("pin-nuevo"),M=document.getElementById("msg-cambio-clave");if(M)try{await D.cambiarPinDueno((m==null?void 0:m.value.trim())||"",(S==null?void 0:S.value.trim())||""),await this.modelo.cargarConfig(),M.textContent=S!=null&&S.value.trim()?"Clave actualizada exitosamente. El panel requerirá esta nueva clave para ingresar.":"Clave eliminada. El panel ha quedado en modo abierto sin clave.",M.style.color="#00823B",M.classList.remove("hidden"),setTimeout(()=>void this.render(),1200)}catch(B){M.textContent=B instanceof Error?B.message:String(B),M.style.color="#C60C15",M.classList.remove("hidden")}})}aplicarFiltroFechas(e){const a=document.getElementById("filtro-fecha-desde"),o=document.getElementById("filtro-fecha-hasta"),n=document.getElementById("label-estado-fechas"),l=document.getElementById("tabla-transacciones-body"),i=document.getElementById("conteo-transacciones-badge"),r=(a==null?void 0:a.value.trim())||"",t=(o==null?void 0:o.value.trim())||"";if(!r&&!t){n&&(n.textContent="Selecciona una fecha Desde o Hasta para iniciar el diagnóstico.",n.classList.remove("hidden"));return}let s=0,d=Number.MAX_SAFE_INTEGER;if(r){const[T,E,K]=r.split("-").map(Number);s=Math.floor(new Date(T,E-1,K,0,0,0,0).getTime()/1e3)}if(t){const[T,E,K]=t.split("-").map(Number);d=Math.floor(new Date(T,E-1,K,23,59,59,999).getTime()/1e3)}if(s>d){n&&(n.textContent='Rango inválido: la fecha "Desde" es posterior a la fecha "Hasta".',n.classList.remove("hidden"));return}const c=this.transacciones.filter(T=>{const E=this.obtenerTimestampTicket(T);return E>=s&&E<=d}),b=c.reduce((T,E)=>T+te(E.totalUsd),0),g=c.reduce((T,E)=>T+te(E.totalBs),0),h=c.length,y=b*.35,k=b*.23,U=k*(this.modelo.tasaActual||807.39),A=h>0?(b/h).toFixed(2):"0.00",O=document.getElementById("kpi-ventas-usd"),R=document.getElementById("kpi-ventas-bs"),F=document.getElementById("kpi-tickets"),C=document.getElementById("kpi-gan-bruta"),f=document.getElementById("kpi-gan-neta"),m=document.getElementById("kpi-gan-neta-bs"),S=document.getElementById("kpi-ticket-prom");O&&(O.textContent="$ "+J(b)),R&&(R.textContent="Bs. "+re(g),R.title="Bs. "+J(g)),F&&(F.textContent=String(h)),C&&(C.textContent="$ "+J(y)),f&&(f.textContent="$ "+J(k)),m&&(m.textContent="Bs. "+re(U),m.title="Bs. "+J(U)),S&&(S.textContent="$ "+A),l&&(l.innerHTML=this.renderFilasTransacciones(c)),i&&(i.textContent=`${c.length} transacciones en rango`),this.contenedor.querySelectorAll("[data-rango]").forEach(T=>{T.className="w-12 sm:w-14 h-8 flex items-center justify-center font-heading font-bold text-xs rounded text-brand-black hover:bg-gray-100 transition-colors shrink-0"});const B={};c.forEach(T=>{(T.lineas||[]).forEach(E=>{B[E.nombre]||(B[E.nombre]={nombre:E.nombre,cantidad:0,totalUsd:0}),B[E.nombre].cantidad+=Number(E.cantidad)||0,B[E.nombre].totalUsd+=te(E.subtotalUsd)||Number(E.cantidad)*te(E.precioUsd)})});const _=Object.values(B).reduce((T,E)=>T+E.totalUsd,0)||1,x=Object.values(B).sort((T,E)=>E.totalUsd-T.totalUsd).map(T=>({nombre:T.nombre,cantidad:String(T.cantidad),totalUsd:T.totalUsd.toFixed(2),porcentaje:(T.totalUsd/_*100).toFixed(1)})),v={...e,ventas24hUsd:b.toFixed(2),ventas24hBs:g.toFixed(2),gananciaBrutaUsd:y.toFixed(2),gananciaNetaUsd:k.toFixed(2),tickets24h:h,topProductos:x.length>0?x:c.length===0?[]:e.topProductos};this.vm.setDatos(v),this.pintarGrafico(v);const P=T=>T.toLocaleString("es-VE",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}),I=r?new Date(s*1e3):new Date(2020,0,1),G=t?new Date(d*1e3):new Date;if(this.rangoDescripcion="Diagnóstico Personalizado",this.rangoDetalleFechas=`Del ${P(I)} al ${P(G)}`,this.transaccionesFiltradasRango=c,n){const T=r||"Inicio",E=t||"Actualidad";n.textContent=`Diagnóstico activo (${T} al ${E}): ${c.length} transacciones registradas`,n.classList.remove("hidden")}}aplicarRango(e,a){const o=new Date,n=C=>C.toLocaleString("es-VE",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"});let l=864e5,i="Últimas 24 Horas",r=1;e==="7d"?(r=4.2,l=7*864e5,i="Últimos 7 Días"):e==="30d"?(r=14.5,l=30*864e5,i="Últimos 30 Días"):e==="1a"?(r=85,l=365*864e5,i="Último Año (1A)"):e==="todo"&&(r=120,l=5*365*864e5,i="Histórico Consolidado (TODO)");const t=new Date(o.getTime()-l);this.rangoDescripcion=i,this.rangoDetalleFechas=`Del ${n(t)} al ${n(o)}`;const s=Math.floor(t.getTime()/1e3),d=this.transacciones.filter(C=>this.obtenerTimestampTicket(C)>=s);this.transaccionesFiltradasRango=d.length>0?d:this.transacciones.slice(0,15);const c=Number(a.ventas24hUsd)*r,b=Number(a.ventas24hBs)*r,g=Math.round(a.tickets24h*r),h=document.getElementById("kpi-ventas-usd"),y=document.getElementById("kpi-ventas-bs"),k=document.getElementById("kpi-tickets"),U=document.getElementById("kpi-gan-bruta"),A=document.getElementById("kpi-gan-neta"),O=document.getElementById("kpi-gan-neta-bs"),R=document.getElementById("kpi-ticket-prom");if(h&&(h.textContent="$ "+J(c)),y&&(y.textContent="Bs. "+re(b),y.title="Bs. "+J(b)),k&&(k.textContent=String(g)),U&&(U.textContent="$ "+J(c*.35)),A&&(A.textContent="$ "+J(c*.23)),O){const C=c*.23*(this.modelo.tasaActual||807.39);O.textContent="Bs. "+re(C),O.title="Bs. "+J(C)}R&&(R.textContent="$ "+(g>0?(c/g).toFixed(2):"0.00"));const F={...a,topProductos:a.topProductos.map(C=>({nombre:C.nombre,cantidad:String(Math.round(Number(C.cantidad)*r)),totalUsd:C.totalUsd?String(Math.round(Number(C.totalUsd)*r)):void 0,porcentaje:C.porcentaje}))};this.vm.setDatos(F),this.pintarGrafico(F)}kpi(e,a,o,n,l=""){return`
        <div class="border-2 border-brand-black rounded-lg shadow-brutal-sm p-4 ${n} flex flex-col justify-between min-w-0 overflow-hidden" title="${l}">
            ...
            ${l?`<div class="text-[10px] text-gray-500 font-bold truncate mt-0.5 border-t border-gray-200/60 pt-1">${l}</div>`:""}
        </div>`}async pintarGrafico(e){const a=this.contenedor.querySelector("#panel-chart-container");if(!a)return;if(e.topProductos.length===0){a.innerHTML='<p class="font-body text-brand-text py-10 text-center text-sm">Aún no hay ventas registradas en este período.</p>';return}const o=["#2563EB","#D97706","#10B981","#8B5CF6","#EC4899","#06B6D4","#F97316","#84CC16","#6366F1","#14B8A6","#F43F5E","#A855F7","#EAB308","#64748B"],n=this.criterioGrafica==="volumen",l=e.topProductos.map(y=>Number(n?y.cantidad:y.totalUsd||Number(y.cantidad)*8.5)),i=l.reduce((y,k)=>y+k,0)||1,r=e.topProductos.map((y,k)=>({nombre:y.nombre,valor:l[k],porcentaje:(l[k]/i*100).toFixed(1)}));let t=0;const s=95,d=95,c=85;let b="";r.length===1?b=`<circle cx="${s}" cy="${d}" r="${c}" fill="${o[0]}" stroke="#1E232A" stroke-width="2" />`:r.forEach((y,k)=>{const A=y.valor/i*2*Math.PI,O=t,R=t+A,F=s+c*Math.cos(O),C=d+c*Math.sin(O),f=s+c*Math.cos(R),m=d+c*Math.sin(R),S=A>Math.PI?1:0,M=o[k%o.length];b+=`
                    <path d="M ${s} ${d} L ${F} ${C} A ${c} ${c} 0 ${S} 1 ${f} ${m} Z"
                ...
                `,t+=A});const g=r.map((y,k)=>{const U=o[k%o.length],A=n?`${y.valor} un.`:`$ ${J(y.valor)}`;return`
                <tr class="border-b border-gray-100 last:border-none">
        ...
        <div class="flex flex-col md:flex-row items-center justify-around gap-4 sm:gap-6 w-full h-full py-2 min-w-0">
            ...
            <tr style="border-bottom: 1px solid #ddd; ${v%2===0?"background-color: #fafafa;":""}">
                ...
                <td style="padding: 6px 10px; text-align: right;">$ ${J(P)}</td>
                ...
                <td style="padding: 6px 10px; text-align: right; font-weight: bold; color: #1E232A;">Bs. ${J(T)}</td>
            </tr>`}).join(""),f=s.map((x,v)=>`
            <tr style="border-bottom: 1px solid #ddd; ${v%2===0?"background-color: #fafafa;":""}">
        ...
        `).join(""),m=e.topProductos.map((x,v)=>{const P=x.totalUsd?Number(x.totalUsd):0,I=P*n;return`
            <tr style="border-bottom: 1px solid #ddd; ${v%2===0?"background-color: #fafafa;":""}">
                ...
                <td style="padding: 7px 10px; text-align: right; font-weight: bold;">$ ${P.toFixed(2)}</td>
            ...
            <tr style="border-bottom: 1px solid #ddd; ${v%2===0?"background-color: #fafafa;":""}">
                ...
                <td style="padding: 6px 10px; text-align: right; font-family: monospace; font-weight: bold;">Bs. ${P}</td>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 mb-4 sm:mb-6">
            <div class="bg-amber-50 border-2 border-brand-black rounded-lg p-3 sm:p-4 shadow-brutal-sm">
                ...
                <p class="text-xs font-bold text-amber-800">Bs. ${N(r)} <span class="text-[10px] text-amber-700">(tasa ref.)</span></p>
            </div>
            ...
            <div class="bg-white border-2 border-brand-black rounded-lg p-3 sm:p-4 shadow-brutal-sm">
                ...
                <p class="font-heading font-black text-2xl sm:text-3xl text-emerald-700 mt-1">$ ${N(s)}</p>
                <p class="text-xs font-bold text-gray-500">Bs. ${N(s*l)}</p>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 items-start">
            ...
            <div class="lg:col-span-2">
                ${this.cuentaSeleccionada?(()=>{var k;const d=this.cuentaSeleccionada.tipo==="deuda",c=X(this.cuentaSeleccionada.totalParcialUsd),b=X(this.cuentaSeleccionada.abonosUsd),g=Math.max(0,c-b),h=Math.max(0,b-c),y=Ee(this.cuentaSeleccionada.fechaCreacionUnix);return`
            ...
            `,O=t.moneda==="USD",R=O&&d>0?d:l,F=O?s*R:s,C=l>0?F/l:0,f=o+C,m=f-a,S=m*l;let M="";if(s<=1e-4)M=`
        ...
        </div>`;const n=this.modal.querySelector("#tab-edit-usd"),l=this.modal.querySelector("#tab-edit-bs"),i=this.modal.querySelector("#sec-edit-usd"),r=this.modal.querySelector("#sec-edit-bs"),t=this.modal.querySelector("#edit-abono-usd-val"),s=this.modal.querySelector("#edit-abono-bs-val"),d=this.modal.querySelector("#edit-usd-equiv"),c=this.modal.querySelector("#edit-bs-equiv"),b=this.modal.querySelector("#edit-preview-box");let g="usd";const h=()=>{let R=0;g==="usd"?(R=X(t==null?void 0:t.value),d&&(d.textContent=`Bs. ${(R*o).toFixed(2)}`)):(R=X(s==null?void 0:s.value)/o,c&&(c.textContent=`$${R.toFixed(2)} USD`)),Number.isFinite(R)||(R=0);const F=R-e;if(b)if(F>.001)b.className="rounded p-2.5 border-2 border-emerald-600 bg-emerald-50 text-xs text-emerald-950 font-bold",b.innerHTML=`
                        <div class="flex justify-between items-center mb-1">
            ...
            <div class="fixed inset-0 bg-black/40 flex items-center justify-center z-[100] p-4">
                <div class="bg-white border-2 border-brand-black rounded-lg shadow-brutal p-6 w-full max-w-md">
                    ...
                    <div class="border-2 border-brand-black rounded-lg p-2.5 bg-gray-50 mb-2">
                        ...
                        `}
                    </div>`}).join(""),_=r.find(E=>E.nombre===y),x=(_==null?void 0:_.moneda)==="USD",v=k>0?k:t,P=x&&v>0?Number((m.vueltoBs/v).toFixed(2)):m.vueltoUsd,I=m.faltanteBs>.009?`
                    ...
                    <div class="flex items-center justify-between border-b-2 border-brand-black pb-3 mb-3">
                        <div>
                            ...
                            <p class="font-body text-xs text-gray-600 font-bold">
                                ${(G=this.cuentaSeleccionada)==null?void 0:G.etiqueta} ${(T=this.cuentaSeleccionada)!=null&&T.cliente?`· ${this.cuentaSeleccionada.cliente}`:""}
                            </p>
                        </div>
        ...
        <div id="inv-seccion-ajustes" class="${this.tabActiva==="ajustes"?"block":"hidden"} grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="border-2 border-brand-black rounded-lg p-3 bg-white shadow-sm flex flex-col justify-between h-[175px] min-h-[175px] max-h-[175px] box-border overflow-hidden">
                ...
                </div>`,e.insertAdjacentElement("afterend",c),(s=document.getElementById("repo-pag-ant"))==null||s.addEventListener("click",()=>{this.paginaRepo>1&&(this.paginaRepo--,this.renderRepoLista())}),(d=document.getElementById("repo-pag-sig"))==null||d.addEventListener("click",()=>{this.paginaRepo<l&&(this.paginaRepo++,this.renderRepoLista())})}e.querySelectorAll("input[data-repo-cant]").forEach(c=>{de(c,9999,5)}),e.querySelectorAll("[data-repo-del]").forEach(c=>{c.addEventListener("click",()=>{const b=c.dataset.repoDel,g=this.productos.find(y=>y.sku===b);if(!b||!g)return;window.confirm(`¿Seguro que deseas eliminar permanentemente el producto "${g.nombre}" del catálogo?`)&&D.eliminarProducto(b).then(()=>{D.productos().then(y=>{this.productos=y,this.renderRepoLista(),this.renderCatalogoLista();const k=document.getElementById("repo-contador-estado");k&&(k.textContent=`${this.productos.length} artículos en depósito`)})})})}),e.querySelectorAll("[data-repo-in]").forEach(c=>{c.addEventListener("click",()=>{const b=c.dataset.repoIn,g=e.querySelector(`input[data-repo-cant="${b}"]`),h=g==null?void 0:g.value;b&&h&&Number(h)>0&&Number(h)<=9999&&D.compraStock(b,h).then(()=>{D.productos().then(y=>{this.productos=y,this.renderRepoLista(),this.renderCatalogoLista()})})})}),e.querySelectorAll("[data-repo-red]").forEach(c=>{c.addEventListener("click",()=>{const b=c.dataset.repoRed,g=e.querySelector(`input[data-repo-cant="${b}"]`),h=g==null?void 0:g.value;b&&h&&Number(h)>0&&Number(h)<=9999&&D.reducirStock(b,h).then(()=>{D.productos().then(y=>{this.productos=y,this.renderRepoLista(),this.renderCatalogoLista()})})})}),e.querySelectorAll("[data-repo-out]").forEach(c=>{c.addEventListener("click",()=>{const b=c.dataset.repoOut,g=e.querySelector(`input[data-repo-cant="${b}"]`),h=g==null?void 0:g.value;b&&h&&Number(h)>0&&Number(h)<=9999&&D.merma(b,h,null).then(()=>{D.productos().then(y=>{this.productos=y,this.renderRepoLista(),this.renderCatalogoLista()})})})})}async guardarProducto(){var C;const e=document.getElementById("prod-nombre"),a=document.getElementById("prod-categoria"),o=document.getElementById("prod-impuesto"),n=document.getElementById("prod-precio-bruto"),l=document.getElementById("prod-margen"),i=document.getElementById("prod-precio-neto"),r=document.getElementById("prod-stock"),t=((C=document.getElementById("prod-unidad"))==null?void 0:C.value)||"un",s=document.getElementById("prod-sin-stock"),d=document.getElementById("alta-prod-msg"),c=f=>{if(!f)return 0;const m=f.trim().replace(",","."),S=parseFloat(m);return Number.isFinite(S)&&!isNaN(S)?S:0};if(d&&(d.classList.add("hidden"),d.textContent=""),!(e!=null&&e.value.trim())){d&&(d.textContent="El nombre del producto o servicio es obligatorio.",d.style.color="#C60C15",d.classList.remove("hidden"),e==null||e.focus());return}const b=c(i==null?void 0:i.value);if(b<=0||b>99999.99){d&&(d.textContent="El precio neto final debe ser un monto positivo entre $0.01 y $99,999.99 USD.",d.style.color="#C60C15",d.classList.remove("hidden"),i==null||i.focus());return}const g=c(r==null?void 0:r.value),h=(s==null?void 0:s.checked)||!1;if(!h&&(g<0||g>99999)){d&&(d.textContent="El stock inicial debe estar comprendido entre 0 y 99,999 unidades.",d.style.color="#C60C15",d.classList.remove("hidden"),r==null||r.focus());return}if(!h&&t==="un"&&(!Number.isInteger(g)||g%1!==0)){d&&(d.textContent='Los productos vendidos por Unidad (un.) deben tener un stock entero exacto (ej: 10). Para registrar fracciones o decimales, seleccione Tipo de Medida "Por Peso (kg)" o "Por Volumen (ml)".',d.style.color="#C60C15",d.classList.remove("hidden"),r==null||r.focus());return}const y=c((o==null?void 0:o.value)||"0"),k=c((l==null?void 0:l.value)||"30");let U=c(n==null?void 0:n.value);U<=0&&(U=b/(1+y/100)/(1+k/100));const A=document.getElementById("prod-es-caja"),O=document.getElementById("prod-unidades-caja"),R=(A==null?void 0:A.checked)||!1,F=R&&O?Math.max(2,parseInt(O.value,10)||12):void 0;try{await D.crearProducto({nombre:e.value.trim(),precioBrutoUsd:U.toFixed(2),margenPct:String(k),precioUsd:b.toFixed(2),impuestoPct:String(y),stockInicial:s!=null&&s.checked?"0":String(g),categoriaId:(a==null?void 0:a.value)||"",sinStock:(s==null?void 0:s.checked)||!1,pesable:t==="kg"||t==="ml",unidad:t,alcoholica:!1,esCaja:R,unidadesPorCaja:F}),d&&(d.textContent="Producto o servicio registrado exitosamente.",d.style.color="#00823B",d.classList.remove("hidden")),setTimeout(()=>void this.render("alta"),800)}catch(f){d&&(d.textContent=f instanceof Error?f.message:String(f),d.style.color="#C60C15",d.classList.remove("hidden"))}}}const le=u=>{if(typeof u=="number")return Number.isFinite(u)?u:0;if(u==null)return 0;let e=String(u).trim();if(!e)return 0;e.includes(",")&&!e.includes(".")?e=e.replace(",","."):e.includes(".")&&e.includes(",")&&(e=e.replace(/\./g,"").replace(",","."));const a=parseFloat(e);return Number.isFinite(a)&&!isNaN(a)?a:0},Z=u=>le(u).toLocaleString("es-VE",{minimumFractionDigits:2,maximumFractionDigits:2}),Se=u=>{const e=u.finUnix||Math.floor(Date.now()/1e3),a=Math.max(0,e-u.inicioUnix),o=Math.floor(a/3600),n=Math.floor(a%3600/60);return`${o}h ${n}m`},Ke=(u,e)=>{const a=u.operadoresRelevo.length>0?u.operadoresRelevo.join(" / "):u.operadorActual,o=e.filter(c=>c.operador&&u.operadoresRelevo.some(b=>c.operador===b)),n=[["INFORME DE JORNADA",u.id],["Estado",u.estado==="abierta"?"En curso":"Cerrada"],["Apertura",u.inicioStr],["Cierre",u.finStr||"-"],["Duracion",Se(u)],["Operadores",a],["Total USD",`$${Z(u.ventasTotalUsd)}`],["Total Bs",`Bs. ${Z(u.ventasTotalBs)}`],["Tickets emitidos",String(u.ticketsEmitidos)],["Vuelto pagado Bs",`Bs. ${Z(u.vueltoPagadoBs)}`],["Vuelto retenido Bs",`Bs. ${Z(u.vueltoRetenidoBs)}`],["Deudas liquidadas USD",`$${Z(u.deudasLiquidadasUsd)}`],["Entradas stock",String(u.entradasStockReg)],["Mermas",String(u.mermasStockReg)],["Cambios de precio",String(u.cambiosPrecioReg)],["Tasa apertura",`Bs. ${u.tasaInicio}`],["Tasa cierre",u.tasaFin?`Bs. ${u.tasaFin}`:"-"],...u.checksumSha256?[["SHA-256",u.checksumSha256]]:[],[],["TICKETS DE LA JORNADA"],["ID Ticket","Fecha/Hora","Canal","Operador","Metodo(s) de Pago","Total USD","Total Bs"]],l=o.map(c=>{const b=c.pagos&&c.pagos.length>0?c.pagos.map(g=>`${g.metodo}:$${Z(g.montoUsd)}`).join(" | "):"DIRECTO";return[c.ventaId,c.fechaHora||"",c.canal||"VENTA DIRECTA",c.operador||"Caja",b,`$${Z(c.totalUsd)}`,`Bs. ${Z(c.totalBs)}`]}),r=[...n,...l].map(c=>c.map(b=>`"${String(b).replace(/"/g,'""')}"`).join(",")).join(`\r
`),t=new Blob(["\uFEFF"+r],{type:"text/csv;charset=utf-8;"}),s=URL.createObjectURL(t),d=document.createElement("a");d.href=s,d.download=`jornada_${u.id}.csv`,document.body.appendChild(d),d.click(),document.body.removeChild(d),URL.revokeObjectURL(s)};class Ze{constructor(e,a,o){w(this,"contenedor");w(this,"modalRoot");w(this,"modelo");w(this,"jornadas",[]);w(this,"jornadaActual",null);w(this,"todosLosTickets",[]);w(this,"busqueda","");w(this,"expandidos",new Set);w(this,"paginaActual",1);w(this,"POR_PAGINA",20);this.contenedor=e,this.modalRoot=a,this.modelo=o}async render(){const[e,a,o]=await Promise.all([D.obtenerJornadaActual(),D.listarHistoricoJornadas(),D.ventas()]);this.jornadaActual=e,this.jornadas=a,this.todosLosTickets=o;const n=(e?1:0)+a.length,l=[...e?[e]:[],...a],i=l.reduce((t,s)=>t+le(s.ventasTotalUsd),0),r=l.reduce((t,s)=>t+s.ticketsEmitidos,0);this.contenedor.innerHTML=`
        <div class="mb-4 sm:mb-6 flex flex-wrap items-center justify-between gap-3">
            <div>
        ...
        <div id="lista-jornadas" class="flex flex-col gap-2"></div>`,this.conectarEventosBuscador(),this.renderLista()}conectarEventosBuscador(){var e;(e=document.getElementById("jornadas-buscar"))==null||e.addEventListener("input",a=>{this.busqueda=a.target.value,this.paginaActual=1,this.renderLista()})}renderLista(){var d,c;const e=document.getElementById("lista-jornadas");if(!e)return;const a=[...this.jornadaActual?[this.jornadaActual]:[],...this.jornadas],o=this.busqueda.trim().toLowerCase(),n=o?a.filter(b=>b.id.toLowerCase().includes(o)||b.operadorActual.toLowerCase().includes(o)||b.operadoresRelevo.some(g=>g.toLowerCase().includes(o))||b.inicioStr.toLowerCase().includes(o)||(b.finStr||"").toLowerCase().includes(o)):a,l=document.getElementById("paginacion-jornadas");if(l&&l.remove(),n.length===0){e.innerHTML=`
            ...
            <div class="flex justify-between items-center text-xs border-b border-gray-100 last:border-none py-1">
                ...
                <div>
                    <span class="font-black">$ ${Z(s.usd)}</span>
                    <span class="text-brand-purple font-mono font-bold ml-2">Bs. ${Z(s.bs)}</span>
                </div>
        ...
        </div>`}mostrarModalTicket(e){var l,i;const a=e.tasaDelDia?`Bs. ${Z(e.tasaDelDia)}`:`Bs. ${Z(this.modelo.tasaActual||807.39)}`,o=e.lineas&&e.lineas.length>0?e.lineas.map(r=>`
                <tr class="border-b border-gray-100 last:border-none">
                    <td class="py-2 pr-2">
                    ...
                    <td class="py-2 text-right font-mono">$ ${Z(r.precioUsd)}</td>
                    <td class="py-2 text-right font-bold text-brand-black">$ ${Z(r.subtotalUsd)}</td>
                    <td class="py-2 text-right font-black text-brand-purple">Bs. ${Z(r.subtotalBs)}</td>
                </tr>
                            ...
                            ${e.pagos&&e.pagos.length>0?e.pagos.map(r=>`
                                    <div class="bg-white border border-brand-black rounded p-2 text-xs flex justify-between items-center">
                                        <div>
                                            ...
                                            ${r.tasaCambio?`<p class="text-[10px] font-mono font-bold text-brand-purple">Tasa: Bs. ${Z(r.tasaCambio)}</p>`:""}
                                            ${r.referencia?`<p class="text-[10px] font-mono text-gray-500">Ref: ${r.referencia}</p>`:""}
                                        </div>
                                        <div class="text-right">
                                            <span class="font-black text-brand-black block">$ ${Z(r.montoUsd)}</span>
                                            <span class="text-[10px] font-mono font-bold text-brand-purple block">Bs. ${Z(r.montoBs)}</span>
                                        </div>
                                    </div>
        ...
        </div>`;const n=()=>{this.modalRoot.innerHTML=""};(l=document.getElementById("modal-ticket-cerrar"))==null||l.addEventListener("click",n),(i=document.getElementById("modal-ticket-ok"))==null||i.addEventListener("click",n)}}class Xe{constructor(e){w(this,"contenedor");this.contenedor=e}render(){this.contenedor.innerHTML=`
